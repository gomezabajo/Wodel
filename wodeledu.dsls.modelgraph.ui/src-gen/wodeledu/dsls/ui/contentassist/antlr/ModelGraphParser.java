...
public class ModelGraphParser extends AbstractContentAssistParser {
	...
	@Override
	protected wodeledu.dsls.ui.contentassist.antlr.internal.InternalModelGraphParser createParser() {
		wodeledu.dsls.ui.contentassist.antlr.internal.InternalModelGraphParser result = new wodeledu.dsls.ui.contentassist.antlr.internal.InternalModelGraphParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMutatorGraphAccess().getRelationsAssignment_8(), "rule__MutatorGraph__RelationsAssignment_8");
					put(grammarAccess.getMutatorGraphAccess().getContentsAssignment_9(), "rule__MutatorGraph__ContentsAssignment_9");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			wodeledu.dsls.ui.contentassist.antlr.internal.InternalModelGraphParser typedParser = (wodeledu.dsls.ui.contentassist.antlr.internal.InternalModelGraphParser) parser;
