...
public class xee extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation1
	...
	//
	//true
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "EventHandler");
	...
	//REFERENCE: 
	((ReferenceEvaluation) exp0.first).name = "events";
...
//SELECT OBJECT mutation2
	...
	SpecificReferenceSelection referenceSelection = null;
	//
	if (hmObjects.get("ev2") != null) {
		containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("ev2"));
		   			} else {
		   				if (hmList.get("ev2") != null) {
		   					containerSelection = new SpecificObjectSelection(packages, model, hmList.get("ev2"));
		   				}
		   				else {
			return mutations;
		}
	...
	if (hmObjects.get("ev2") != null) {
		referenceSelection = new SpecificReferenceSelection(packages, model, "events", hmObjects.get("ev2"));
			   			} else {
			   				return mutations;
	}
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "OnEvent", referenceSelection, containerSelection);
...
//METHOD NAME:mutation3
	...
	// REMOVE OBJECT mutation3
		...
		if (hmObjects.get("event") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("event"));
	   			} else {
			return mutations;
		}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/xee/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/xee/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/xee/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/xee/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/xee/data/out/xee.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lev2111 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lev2111 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lev2111) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("ev2", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> levent112 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (levent112 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : levent112) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("event", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> l113 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/xee/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/xee/data/out/", "C:/eclipse/runtime-EclipseApplication/xee/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/xee/data/model/", "xee", "C:/eclipse/runtime-EclipseApplication/xee", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/xee/data/out/", "C:/eclipse/runtime-EclipseApplication/xee/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/xee/data/model/", "xee", "C:/eclipse/runtime-EclipseApplication/xee", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
