...
public class wodeledufaDraw implements manager.IMutatorDraw {
	...
	public static void generateGraphs(File file, String folder, List<EPackage> packages, File exercise)
		...
		if (file.isFile()) {
			...
			if (pathfile.endsWith(".model") == true) {
				...
				String dotfile = "C:/eclipse/workspace/wodeledufa/src-gen/html/diagrams/" + "/" + path
						+ file.getName().replace(".model", ".dot");
				String pngfile = "C:/eclipse/workspace/wodeledufa/src-gen/html/diagrams/" + "/" + path
				...
				dotcode.add("}");
				File diagramsfolder = new File("C:/eclipse/workspace/wodeledufa/src-gen/html/diagrams/");
				if (diagramsfolder.exists() != true) {
					diagramsfolder.mkdir();
				}
				File exercisefolder = new File(
						"C:/eclipse/workspace/wodeledufa/src-gen/html/diagrams/" + exercise.getName() + "/");
				...
				if (folders.size() > 0) {
					for (String folderName : folders) {
						path += folderName + "/";
						exercisefolder = new File("C:/eclipse/workspace/wodeledufa/src-gen/html/diagrams/" + path);
						if (exercisefolder.exists() != true) {
							exercisefolder.mkdir();
						}
					}
	...
	public void generate() throws MetaModelNotFoundException, ModelNotFoundException, FileNotFoundException {
		String metamodel = "C:/eclipse/workspace/wodeledufa/data/model/DFAAutomaton.ecore";
		List<EPackage> packages = ModelManager.loadMetaModel(metamodel);
		File folder = new File("C:/eclipse/workspace/wodeledufa/data/model");
		for (File file : folder.listFiles()) {
			if (file.isFile()) {
				String pathfile = file.getPath();
				if (pathfile.endsWith(".model") == true) {
					Resource model = ModelManager.loadModel(packages, pathfile);
					String dotfile = "C:/eclipse/workspace/wodeledufa/src-gen/html/diagrams/"
							+ file.getName().replace(".model", "") + "/" + file.getName().replace(".model", ".dot");
					String pngfile = "C:/eclipse/workspace/wodeledufa/src-gen/html/diagrams/"
					...
					File dotfolder = new File("C:/eclipse/workspace/wodeledufa/src-gen/html/diagrams/"
		...
		folder = new File("C:/eclipse/workspace/wodeledufa/data/out");
