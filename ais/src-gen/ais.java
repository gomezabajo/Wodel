...
public class ais extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		((AttributeEvaluation) exp0.first).name = "isolated";
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/ais/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/ais/data/model/";
		String modelsURI = "C:/eclipse/workspace/ais/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/ais/data/out/ais.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/ais/data/out/",
					"C:/eclipse/workspace/ais/data/model/bpel.ecore", "C:/eclipse/workspace/ais/data/model/",
					"ais.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/ais/data/out/",
					"C:/eclipse/workspace/ais/data/model/bpel.ecore", "C:/eclipse/workspace/ais/data/model/",
					"ais.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
