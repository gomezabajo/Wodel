...
public class xmc extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/xmc/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/xmc/data/model/";
		String modelsURI = "C:/eclipse/workspace/xmc/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/xmc/data/out/xmc.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xmc/data/out/",
					"C:/eclipse/workspace/xmc/data/model/bpel.ecore", "C:/eclipse/workspace/xmc/data/model/",
					"xmc.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xmc/data/out/",
					"C:/eclipse/workspace/xmc/data/model/bpel.ecore", "C:/eclipse/workspace/xmc/data/model/",
					"xmc.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
