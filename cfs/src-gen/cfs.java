...
public class cfs extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
refSelection22 = new SpecificObjectSelection(packages, model, hmObjects.get("s"));
} else {
	if (hmList.get("s") != null) {
	refSelection22 = new SpecificObjectSelection(packages, model, hmList.get("s"));
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection22);
//NAME:symbol
  		//REFERENCES COMPILES	23
RandomTypeSelection refRts23 = new RandomTypeSelection(packages, model, "Symbol");
EObject refObject23 = refRts23.getObject();
ObSelectionStrategy refSelection23 = null;
if (refObject23 != null) {
refSelection23 = 
	new SpecificObjectSelection(packages, model, refObject23);
}
   		refs.put("symbol", refSelection23);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    //String resourcesURI = "C:/eclipse/workspace/cfs/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/cfs/data/out/cfs.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> ls57 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (ls57 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ls57) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l58 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/cfs/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/cfs/data/out/", "C:/eclipse/workspace/cfs/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/cfs/data/model/", "cfs", "C:/eclipse/workspace/cfs", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/cfs/data/out/", "C:/eclipse/workspace/cfs/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/cfs/data/model/", "cfs", "C:/eclipse/workspace/cfs", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
