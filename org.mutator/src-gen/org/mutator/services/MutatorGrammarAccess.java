...
@Singleton
public class MutatorGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MutatorEnvironmentElements extends AbstractParserRuleElementFinder {
		...
		//MutatorEnvironment:
		//	load+=Load* definition=Definition "with" "commands" "{" commands+=Mutator commands+=Mutator* "}";
	...
	public class SourceElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cMultipleAllKeyword_2_0 = (Keyword)cMultipleAssignment_2.eContents().get(0);
		...
		//"all"
		public Keyword getMultipleAllKeyword_2_0() { return cMultipleAllKeyword_2_0; }
	}
	...
	@Inject
	public MutatorGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.mutator.Mutator".equals(grammar.getName())) {
				return grammar;
			}
