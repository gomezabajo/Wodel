...
public class rst extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/workspace/rst/data/model/Asple.ecore";
	    
	    String modelURI = "C:/eclipse/workspace/rst/data/model/";
	    String modelsURI = "C:/eclipse/workspace/rst/data/out/";
	    //String resourcesURI = "C:/eclipse/workspace/rst/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/rst/data/out/rst.model").toFileString());
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/rst/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/rst/data/out/", "C:/eclipse/workspace/rst/data/model/Asple.ecore", "C:/eclipse/workspace/rst/data/model/", "rst", "C:/eclipse/workspace/rst", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/rst/data/out/", "C:/eclipse/workspace/rst/data/model/Asple.ecore", "C:/eclipse/workspace/rst/data/model/", "rst", "C:/eclipse/workspace/rst", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
