...
public class uas3 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection refRts35 = new RandomTypeSelection(packages, model, "Class");
		EObject refObject35 = refRts35.getObject();
		ObSelectionStrategy refSelection35 = null;
		if (refObject35 != null) {
			refSelection35 = new SpecificObjectSelection(packages, model, refObject35);
		}
		refs.put("src", refSelection35);
		RandomTypeSelection refRts36 = new RandomTypeSelection(packages, model, "Class");
		EObject refObject36 = refRts36.getObject();
		ObSelectionStrategy refSelection36 = null;
		if (refObject36 != null) {
			refSelection36 = new SpecificObjectSelection(packages, model, refObject36);
		}
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/uas3/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/uas3/data/model/";
		String modelsURI = "C:/eclipse/workspace/uas3/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/uas3/data/out/uas3.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l282 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l282 != null) {
							int k = 0;
							for (Mutator mut : l282) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uas3/data/out/",
					"C:/eclipse/workspace/uas3/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uas3/data/model/", "uas3.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uas3/data/out/",
					"C:/eclipse/workspace/uas3/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uas3/data/model/", "uas3.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
