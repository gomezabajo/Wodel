 ...
 * <ul>
 *   <li>{@link mutatorgraph.impl.ItemImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ItemImpl extends MinimalEObjectImpl.Container implements Item {
	...
	protected EClass eStaticClass() {
		return MutatorgraphPackage.Literals.ITEM;
	}
		...
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MutatorgraphPackage.ITEM__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(EClass newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorgraphPackage.ITEM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MutatorgraphPackage.ITEM__NAME:
