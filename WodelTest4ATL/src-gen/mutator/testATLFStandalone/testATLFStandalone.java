		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lp28 = mutation1(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lp28 != null) {
							for (Mutator mut : lp28) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lopce29 = mutation2(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lopce29 != null) {
							for (Mutator mut : lopce29) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lfeat30 = mutation3(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lfeat30 != null) {
							for (Mutator mut : lfeat30) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lsipe31 = mutation4(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lsipe31 != null) {
							for (Mutator mut : lsipe31) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lconj32 = mutation5(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lconj32 != null) {
							for (Mutator mut : lconj32) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lcall33 = mutation6(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lcall33 != null) {
							for (Mutator mut : lcall33) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lexp34 = mutation7(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lexp34 != null) {
							for (Mutator mut : lexp34) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l35 = mutation8(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l35 != null) {
							for (Mutator mut : l35) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l37 = mutation10(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l37 != null) {
							for (Mutator mut : l37) {
								if (mut != null) {
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l38 = mutation11(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l38 != null) {
							for (Mutator mut : l38) {
								if (mut != null) {
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lp39 = mutation12(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lp39 != null) {
							for (Mutator mut : lp39) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lopce40 = mutation13(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (lopce40 != null) {
							for (Mutator mut : lopce40) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lfeat41 = mutation14(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (lfeat41 != null) {
							for (Mutator mut : lfeat41) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
