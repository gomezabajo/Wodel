...
public class uco2 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection refRts44 = new RandomTypeSelection(packages, model, "Class");
		EObject refObject44 = refRts44.getObject();
		ObSelectionStrategy refSelection44 = null;
		if (refObject44 != null) {
			refSelection44 = new SpecificObjectSelection(packages, model, refObject44);
		}
		refs.put("type", refSelection44);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/uco2/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/uco2/data/model/";
		String modelsURI = "C:/eclipse/workspace/uco2/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/uco2/data/out/uco2.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l300 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l300 != null) {
							int k = 0;
							for (Mutator mut : l300) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uco2/data/out/",
					"C:/eclipse/workspace/uco2/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uco2/data/model/", "uco2.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uco2/data/out/",
					"C:/eclipse/workspace/uco2/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uco2/data/model/", "uco2.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
