...
public class was3 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null) {
			...
			atts.add(new ListStringConfigurationStrategy(
					(String) ModelManager.getAttribute("ntar",
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/was3/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/was3/data/model/";
		String modelsURI = "C:/eclipse/workspace/was3/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/was3/data/out/was3.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l352 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l352 != null) {
							int k = 0;
							for (Mutator mut : l352) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was3/data/out/",
					"C:/eclipse/workspace/was3/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was3/data/model/", "was3.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was3/data/out/",
					"C:/eclipse/workspace/was3/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was3/data/model/", "was3.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
