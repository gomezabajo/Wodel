...
public class ModifyTargetReferenceMutatorImpl extends MutatorImpl implements ModifyTargetReferenceMutator {
			...
			if (refType != oldRefType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.MODIFY_TARGET_REFERENCE_MUTATOR__REF_TYPE, oldRefType, refType));
			}
		}
		return refType;
	}
	...
	public NotificationChain basicSetSource(ObSelectionStrategy newSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_TARGET_REFERENCE_MUTATOR__SOURCE, oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.MODIFY_TARGET_REFERENCE_MUTATOR__SOURCE,
						null, msgs);
			if (newSource != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_TARGET_REFERENCE_MUTATOR__SOURCE, newSource, newSource));
	}
	...
	public NotificationChain basicSetNewTarget(ObSelectionStrategy newNewTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_TARGET_REFERENCE_MUTATOR__NEW_TARGET, oldNewTarget, newNewTarget);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setNewTarget(ObSelectionStrategy newNewTarget) {
		if (newNewTarget != newTarget) {
			NotificationChain msgs = null;
			if (newTarget != null)
				msgs = ((InternalEObject) newTarget).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.MODIFY_TARGET_REFERENCE_MUTATOR__NEW_TARGET,
						null, msgs);
			if (newNewTarget != null)
				msgs = ((InternalEObject) newNewTarget).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.MODIFY_TARGET_REFERENCE_MUTATOR__NEW_TARGET,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_TARGET_REFERENCE_MUTATOR__NEW_TARGET, newNewTarget, newNewTarget));
	}
