...
public class DebugMutatorMetrics {
	...
	public static WodelMetricItem dynamicMetricHelper(EObject object, ArrayList<EPackage> packages) {
	...
	public static WodelMetricClassifier[] createWodelDebugMetrics(String metricsmodel, ArrayList<EPackage> metricspackages, ArrayList<EPackage> packages) {
