...
public class mcl extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation2(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		((ReferenceEvaluation) exp0.first).value = new SpecificObjectSelection(packages, model, hmObjects.get("cl"))
				.getObject();
		...
		ev0_0.value = new SpecificObjectSelection(packages, model, hmObjects.get("cl")).getObject();
	...
	private ArrayList<Mutator> mutation6(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
			HashMap<String, List<EObject>> hmList) throws ReferenceNonExistingException {
		ArrayList<Mutator> mutations = new ArrayList<Mutator>();
		ObSelectionStrategy containerSelection = null;
		SpecificReferenceSelection referenceSelection = null;
	...
	private AppMutation registry6(Mutator mut, HashMap<String, EObject> hmMutator, Resource seed, List<String> mutPaths,
			List<EPackage> packages) {
		AppMutation appMut = null;
		ObjectRemoved rMut = AppliedMutationsFactory.eINSTANCE.createObjectRemoved();
		EObject foundObject = findEObjectForRegistry(seed, mut.getObject(), mut.getObjectByID(), mut.getObjectByURI(),
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/mcl/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/mcl/data/model/";
		String modelsURI = "C:/eclipse/workspace/mcl/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/mcl/data/out/mcl.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lcl261 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lcl261 != null) {
							int k = 0;
							for (Mutator mut : lcl261) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l262 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (l262 != null) {
							int k = 0;
							for (Mutator mut : l262) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l263 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (l263 != null) {
							int k = 0;
							for (Mutator mut : l263) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l264 = mutation4(packages, model, hashmapEObject, hashmapList);
						if (l264 != null) {
							int k = 0;
							for (Mutator mut : l264) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l265 = mutation5(packages, model, hashmapEObject, hashmapList);
						if (l265 != null) {
							int k = 0;
							for (Mutator mut : l265) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l266 = mutation6(packages, model, hashmapEObject, hashmapList);
						if (l266 != null) {
							int k = 0;
							for (Mutator mut : l266) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/mcl/data/out/",
					"C:/eclipse/workspace/mcl/data/model/UMLClassDiagram.ecore", "C:/eclipse/workspace/mcl/data/model/",
					"mcl.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/mcl/data/out/",
					"C:/eclipse/workspace/mcl/data/model/UMLClassDiagram.ecore", "C:/eclipse/workspace/mcl/data/model/",
					"mcl.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
