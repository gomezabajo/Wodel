...
if (hmObjects.get("op") != null) {
refSelection4 = new SpecificObjectSelection(packages, model, hmObjects.get("op"), "right");
} else {
	if (hmList.get("op") != null) {
	refSelection4 = new SpecificObjectSelection(packages, model, hmList.get("op"), "right");
	}
	else {
		return mutations;
	}
}
   		refs.put("left", refSelection4);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/model/Asple.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/out/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/out/ASPLEWodelSample5.model").toFileString());
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/out/", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/model/Asple.ecore", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/model/", "ASPLEWodelSample5", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/out/", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/model/Asple.ecore", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5/data/model/", "ASPLEWodelSample5", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample5", hashmapMutVersions);   			
   		}
   	}
}
