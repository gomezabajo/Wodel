...
import modeltag.IdentifyElements;
 ...
 * </p>
 * <ul>
 *   <li>{@link modeltag.impl.IdentifyElementsImpl#getMetamodel <em>Metamodel</em>}</li>
 *   <li>{@link modeltag.impl.IdentifyElementsImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifyElementsImpl extends MinimalEObjectImpl.Container implements IdentifyElements {
	...
	protected EClass eStaticClass() {
		return ModeltagPackage.Literals.IDENTIFY_ELEMENTS;
	}
	...
	public void setMetamodel(String newMetamodel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModeltagPackage.IDENTIFY_ELEMENTS__METAMODEL, oldMetamodel, metamodel));
	}
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this, ModeltagPackage.IDENTIFY_ELEMENTS__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModeltagPackage.IDENTIFY_ELEMENTS__ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModeltagPackage.IDENTIFY_ELEMENTS__METAMODEL:
				return getMetamodel();
			case ModeltagPackage.IDENTIFY_ELEMENTS__ELEMENTS:
				return getElements();
		}
