package mutator.testBotGenerator;
...
public class testBotGeneratorStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
		...
		String ecoreURI = "C:/eclipse/runtime-EclipseApplication35/WodelTest4Chatbots/data/model/Annotation.ecore";
		List<EPackage> packages = null;
		try {
			packages = ModelManager.loadMetaModel(ecoreURI, testBotGeneratorStandaloneAPI.class);
		} catch (Exception e) {
		}
		...
		muttestBotGenerator.execute(maxAttempts, numMutants, registry, metrics, debugMetrics, packages,
		...
		System.out.println("testBotGenerator Mutant generation process finished.");
	}
}
