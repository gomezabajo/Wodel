...
public class uat2 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection refRts42 = new RandomTypeSelection(packages, model, "Class");
		EObject refObject42 = refRts42.getObject();
		ObSelectionStrategy refSelection42 = null;
		if (refObject42 != null) {
			refSelection42 = new SpecificObjectSelection(packages, model, refObject42);
		}
		refs.put("type", refSelection42);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/uat2/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/uat2/data/model/";
		String modelsURI = "C:/eclipse/workspace/uat2/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/uat2/data/out/uat2.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l288 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l288 != null) {
							int k = 0;
							for (Mutator mut : l288) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uat2/data/out/",
					"C:/eclipse/workspace/uat2/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uat2/data/model/", "uat2.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uat2/data/out/",
					"C:/eclipse/workspace/uat2/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uat2/data/model/", "uat2.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
