...
public class wco2 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation2
	...
	SpecificReferenceSelection referenceSelection = null;
	//
	if (hmObjects.get("path") != null) {
		containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("path"));
		   			} else {
		   				if (hmList.get("path") != null) {
		   					containerSelection = new SpecificObjectSelection(packages, model, hmList.get("path"));
		   				}
		   				else {
			return mutations;
		}
	...
	if (hmObjects.get("path") != null) {
		referenceSelection = new SpecificReferenceSelection(packages, model, "pathName", hmObjects.get("path"));
			   			} else {
			   				return mutations;
	}
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Attribute", referenceSelection, containerSelection);
...
//METHOD NAME:mutation3
	...
	if (hmObjects.get("att") != null) {
		objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("att"));
	} else {
		if (hmList.get("att") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmList.get("att"));
		}
		else {
			return mutations;
		}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/wco2/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/wco2/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/wco2/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/wco2/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/wco2/data/out/wco2.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lpath2592 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lpath2592 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lpath2592) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("path", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> latt2593 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (latt2593 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : latt2593) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("att", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2594 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l2594 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2594) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/wco2/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wco2/data/out/", "C:/eclipse/runtime-EclipseApplication/wco2/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wco2/data/model/", "wco2", "C:/eclipse/runtime-EclipseApplication/wco2", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wco2/data/out/", "C:/eclipse/runtime-EclipseApplication/wco2/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wco2/data/model/", "wco2", "C:/eclipse/runtime-EclipseApplication/wco2", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
