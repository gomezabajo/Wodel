 ...
 * generated by Xtext
 */
package org.mutator.formatting;
...
public class MutatorFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private MutatorGrammarAccess _mutatorGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._mutatorGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._mutatorGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._mutatorGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._mutatorGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._mutatorGrammarAccess.getML_COMMENTRule();
