...
public class mpa extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/mpa/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/mpa/data/model/";
		String modelsURI = "C:/eclipse/workspace/mpa/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/mpa/data/out/mpa.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l275 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l275 != null) {
							int k = 0;
							for (Mutator mut : l275) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/mpa/data/out/",
					"C:/eclipse/workspace/mpa/data/model/UMLClassDiagram.ecore", "C:/eclipse/workspace/mpa/data/model/",
					"mpa.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/mpa/data/out/",
					"C:/eclipse/workspace/mpa/data/model/UMLClassDiagram.ecore", "C:/eclipse/workspace/mpa/data/model/",
					"mpa.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
