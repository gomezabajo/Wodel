	...
	public NotificationChain basicSetObject(ObSelectionStrategy newObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_INFORMATION_MUTATOR__OBJECT, oldObject, newObject);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject) object).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.MODIFY_INFORMATION_MUTATOR__OBJECT, null,
						msgs);
			if (newObject != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_INFORMATION_MUTATOR__OBJECT, newObject, newObject));
	}
	...
	public EList<AttributeSet> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<AttributeSet>(AttributeSet.class, this,
					MutatorenvironmentPackage.MODIFY_INFORMATION_MUTATOR__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public EList<ReferenceSet> getReferences() {
		if (references == null) {
			references = new EObjectContainmentEList<ReferenceSet>(ReferenceSet.class, this,
					MutatorenvironmentPackage.MODIFY_INFORMATION_MUTATOR__REFERENCES);
		}
		return references;
	}
