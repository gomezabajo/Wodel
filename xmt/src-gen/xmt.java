...
public class xmt extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/xmt/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/xmt/data/model/";
		String modelsURI = "C:/eclipse/workspace/xmt/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/xmt/data/out/xmt.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l179 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l179 != null) {
							int k = 0;
							for (Mutator mut : l179) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xmt/data/out/",
					"C:/eclipse/workspace/xmt/data/model/bpel.ecore", "C:/eclipse/workspace/xmt/data/model/",
					"xmt.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xmt/data/out/",
					"C:/eclipse/workspace/xmt/data/model/bpel.ecore", "C:/eclipse/workspace/xmt/data/model/",
					"xmt.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
