	...
	public NotificationChain basicSetTypeRef(PathNameCS newTypeRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniOCLPackage.PARAMETER_CS__TYPE_REF, oldTypeRef, newTypeRef);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTypeRef != typeRef) {
			...
			if (typeRef != null)
				msgs = ((InternalEObject) typeRef).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.PARAMETER_CS__TYPE_REF, null, msgs);
			if (newTypeRef != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.PARAMETER_CS__TYPE_REF, newTypeRef,
					newTypeRef));
	}
