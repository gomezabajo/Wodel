...
public class uge1 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/uge1/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/uge1/data/model/";
		String modelsURI = "C:/eclipse/workspace/uge1/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/uge1/data/out/uge1.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lcl305 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lcl305 != null) {
							int k = 0;
							for (Mutator mut : lcl305) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lsup1306 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (lsup1306 != null) {
							int k = 0;
							for (Mutator mut : lsup1306) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lsup2307 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (lsup2307 != null) {
							int k = 0;
							for (Mutator mut : lsup2307) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l308 = mutation4(packages, model, hashmapEObject, hashmapList);
						if (l308 != null) {
							int k = 0;
							for (Mutator mut : l308) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uge1/data/out/",
					"C:/eclipse/workspace/uge1/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uge1/data/model/", "uge1.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uge1/data/out/",
					"C:/eclipse/workspace/uge1/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uge1/data/model/", "uge1.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
