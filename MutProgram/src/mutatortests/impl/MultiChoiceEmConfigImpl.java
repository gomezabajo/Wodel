 ...
 * <ul>
 *   <li>{@link mutatortests.impl.MultiChoiceEmConfigImpl#isWeighted <em>Weighted</em>}</li>
 *   <li>{@link mutatortests.impl.MultiChoiceEmConfigImpl#getPenalty <em>Penalty</em>}</li>
 *   <li>{@link mutatortests.impl.MultiChoiceEmConfigImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link mutatortests.impl.MultiChoiceEmConfigImpl#getMode <em>Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MultiChoiceEmConfigImpl extends TestConfigurationImpl implements MultiChoiceEmConfig {
	...
	protected EClass eStaticClass() {
		return MutatortestsPackage.Literals.MULTI_CHOICE_EM_CONFIG;
	}
	...
	public void setWeighted(boolean newWeighted) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatortestsPackage.MULTI_CHOICE_EM_CONFIG__WEIGHTED, oldWeighted, weighted));
	}
	...
	public void setPenalty(double newPenalty) {
		...
		penalty = newPenalty;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatortestsPackage.MULTI_CHOICE_EM_CONFIG__PENALTY, oldPenalty, penalty));
	}
	...
	public void setOrder(Order newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatortestsPackage.MULTI_CHOICE_EM_CONFIG__ORDER, oldOrder, order));
	}
	...
	public void setMode(Mode newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatortestsPackage.MULTI_CHOICE_EM_CONFIG__MODE, oldMode, mode));
	}
