package mutator.testATLIPEDynamic;
...
public class testATLIPEDynamic extends MutatorUtils {
	...
	private List<Mutator> mutation1(List<EPackage> packages, Resource model,
		...
		String absoluteMetamodelPath = testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation()
		...
		String absoluteEcoreURI_0 = testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation()
		...
		String absoluteEcoreURI_1 = testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation()
		...
		String absoluteObjectMetamodelPath = testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation()
	...
	private List<Mutator> mutation5(List<EPackage> packages, Resource model,
		...
		SimpleEntry<EObject, SimpleEntry<Resource, List<EPackage>>> entry_ipe_2 = hmObjects.get("ipe");
		if (entry_ipe_2 != null) {
			refSelection2 = new SpecificObjectSelection(packages, model, entry_ipe_2.getKey());
		} else {
			List<SimpleEntry<EObject, SimpleEntry<Resource, List<EPackage>>>> listEntry_ipe_2 = hmList.get("ipe");
			if (listEntry_ipe_2 != null) {
				List<EObject> objs = new ArrayList<EObject>();
				for (SimpleEntry<EObject, SimpleEntry<Resource, List<EPackage>>> ent : listEntry_ipe_2) {
	...
	public int block_cipe(int maxAttempts, int numMutants, boolean registry, List<EPackage> packages,
		...
		String modelURI = testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation().getPath()
				.replace("/bin/", "/") + "data/model/";
		String modelsURI = testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation().getPath()
		...
		for (String modelFilename : modelFilenames) {
			...
			numMutants = 2;
			String xmiFilename = testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation().getPath()
					.replace("/bin/", "/") + "data/out/testATLIPE.model";
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lcl46 = mutation1(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lcl46 != null) {
							for (Mutator mut : lcl46) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lp47 = mutation2(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lp47 != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lmod48 = mutation3(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lmod48 != null) {
							for (Mutator mut : lmod48) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lipe49 = mutation4(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lipe49 != null) {
							for (Mutator mut : lipe49) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lelem50 = mutation5(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lelem50 != null) {
							for (Mutator mut : lelem50) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l51 = mutation6(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l51 != null) {
							for (Mutator mut : l51) {
								if (mut != null) {
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l52 = mutation7(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l52 != null) {
							for (Mutator mut : l52) {
								if (mut != null) {
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lsipe53 = mutation8(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lsipe53 != null) {
							for (Mutator mut : lsipe53) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> ltype54 = mutation9(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (ltype54 != null) {
							for (Mutator mut : ltype54) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lcl55 = mutation10(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lcl55 != null) {
							for (Mutator mut : lcl55) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l56 = mutation11(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l56 != null) {
							for (Mutator mut : l56) {
								if (mut != null) {
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l57 = mutation12(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l57 != null) {
							for (Mutator mut : l57) {
								if (mut != null) {
	...
	public MutationResults execute(int maxAttempts, int numMutants, boolean registry, boolean metrics,
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, testATLIPEDynamic.class
					.getProtectionDomain().getCodeSource().getLocation().getPath().replace("/bin/", "/") + "data/out/",
					"/WodelTest4ATL/data/model/ATL.ecore",
					testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation().getPath()
							.replace("/bin/", "/") + "WodelTest4ATL/data/model/",
					"testATLIPEDynamic.java", hashmapMutVersions, this.getClass());
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, testATLIPEDynamic.class
					.getProtectionDomain().getCodeSource().getLocation().getPath().replace("/bin/", "/") + "data/out/",
					"/WodelTest4ATL/data/model/ATL.ecore",
					testATLIPEDynamic.class.getProtectionDomain().getCodeSource().getLocation().getPath()
							.replace("/bin/", "/") + "WodelTest4ATL/data/model/",
