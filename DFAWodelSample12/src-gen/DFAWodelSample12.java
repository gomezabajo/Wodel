...
public class DFAWodelSample12 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry) throws ReferenceNonExistingException, WrongAttributeTypeException, 
		...
		if (maxAttempts <= 0) {
		    ...
		    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample12/model/DFAAutomaton.ecore";
		    
		    String modelURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample12/model/";
		    String modelsURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample12/out/";
		    ...
		    //2
		   	...
		   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/DFAWodelSample12/out/DFAWodelSample12.model").toFileString());
		   	...
		   	HashMap<String, EObject> hmMutator = getMutators(ModelManager.getObjects(mutatormodel));
		   			...
		   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
		   	   				...
		   	   				//RESET COUNTER: 0
		   	   	   			...
		   	   	   			ArrayList<Mutator> l31 = mutation1(packages, model, hashmapEObject, hashmapList);
		   	   	   			//COUNTER: 1
