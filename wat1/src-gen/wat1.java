...
public class wat1 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//METHOD NAME:mutation1
	...
	List<EObject> objects = rts.getObjects();
			   	...
			   	//INDEX EXPRESSION: 
			   	  		...
			   	  		//ATTRIBUTE: 
			   	   		((AttributeEvaluation) exp0.first).name = "derived";
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/wat1/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/wat1/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/wat1/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/wat1/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/wat1/data/out/wat1.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l3321 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (l3321 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l3321) {
	   	   	   					if (mut != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/wat1/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wat1/data/out/", "C:/eclipse/runtime-EclipseApplication/wat1/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wat1/data/model/", "wat1", "C:/eclipse/runtime-EclipseApplication/wat1", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wat1/data/out/", "C:/eclipse/runtime-EclipseApplication/wat1/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wat1/data/model/", "wat1", "C:/eclipse/runtime-EclipseApplication/wat1", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
