...
public class ctr_mis extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:src
  		//REFERENCES COMPILES	52
ObSelectionStrategy refSelection52 = null;
if (hmObjects.get("s1") != null) {
refSelection52 = new SpecificObjectSelection(packages, model, hmObjects.get("s1"));
} else {
	if (hmList.get("s1") != null) {
	refSelection52 = new SpecificObjectSelection(packages, model, hmList.get("s1"));
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection52);
//NAME:tar
  		//REFERENCES COMPILES	53
ObSelectionStrategy refSelection53 = null;
if (hmObjects.get("s0") != null) {
refSelection53 = new SpecificObjectSelection(packages, model, hmObjects.get("s0"));
} else {
	if (hmList.get("s0") != null) {
	refSelection53 = new SpecificObjectSelection(packages, model, hmList.get("s0"));
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection53);
//NAME:symbol
  		//REFERENCES COMPILES	54
RandomTypeSelection refRts54 = new RandomTypeSelection(packages, model, "Symbol");
...
refSelection54 = 
	new SpecificObjectSelection(packages, model, refObject54);
   		...
   		refs.put("symbol", refSelection54);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    //String resourcesURI = "C:/eclipse/workspace/ctr_mis/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/ctr_mis/data/out/ctr_mis.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> ls0122 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (ls0122 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ls0122) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> ls1123 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (ls1123 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ls1123) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l124 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l124 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l124) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/ctr_mis/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/ctr_mis/data/out/", "C:/eclipse/workspace/ctr_mis/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/ctr_mis/data/model/", "ctr_mis", "C:/eclipse/workspace/ctr_mis", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/ctr_mis/data/out/", "C:/eclipse/workspace/ctr_mis/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/ctr_mis/data/model/", "ctr_mis", "C:/eclipse/workspace/ctr_mis", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
