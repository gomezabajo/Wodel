...
public class testATLBStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
		...
		muttestATLB.execute(maxAttempts, numMutants, registry, metrics, debugMetrics, packages, registeredPackages,
		...
		System.out.println("testATLB Mutant generation process finished.");
	}
}
