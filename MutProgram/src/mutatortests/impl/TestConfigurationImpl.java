 ...
 * <ul>
 *   <li>{@link mutatortests.impl.TestConfigurationImpl#isRetry <em>Retry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestConfigurationImpl extends ConfigurationImpl implements TestConfiguration {
	...
	protected EClass eStaticClass() {
		return MutatortestsPackage.Literals.TEST_CONFIGURATION;
	}
	...
	public void setRetry(boolean newRetry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatortestsPackage.TEST_CONFIGURATION__RETRY, oldRetry, retry));
	}
