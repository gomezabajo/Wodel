...
public class awr1 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null && objectSelection.getObject() != null) {
			mut = new RetypeObjectMutator(model, packages, objectSelection.getObject(), referenceSelection,
					containerSelection, atts, refs, "RepeatUntil");
		}
		if (mut != null) {
			mut.setId("m1");
			mutations.add(mut);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/awr1/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/awr1/data/model/";
		String modelsURI = "C:/eclipse/workspace/awr1/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/awr1/data/out/awr1.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/awr1/data/out/",
					"C:/eclipse/workspace/awr1/data/model/bpel.ecore", "C:/eclipse/workspace/awr1/data/model/",
					"awr1.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/awr1/data/out/",
					"C:/eclipse/workspace/awr1/data/model/bpel.ecore", "C:/eclipse/workspace/awr1/data/model/",
					"awr1.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
