...
G4: OR_gate at (A3+grid_(24,BUF_ht*24),A3)
...
H1: AND_gate at (G1+grid_(24,BUF_ht*24),G1+grid_(0,BUF_ht*15/13))

H2: OR_gate at (H1+grid_(40,BUF_ht*40),H1+grid_(0,BUF_ht*15/13))

line right 3*del from G1.Out to H1.In2
line right 3*del from G2.Out to H1.In1

line right 3*del from H1.Out to H2.In2
line right 3*del from G4.Out to H2.In1

LOUT: line right del from H2.Out; dot at (LOUT,Here); move right 0.2; "f" rjust
