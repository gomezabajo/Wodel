...
public class was2l extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null && objectSelection.getObject() != null) {
			mut = new RetypeObjectMutator(model, packages, objectSelection.getObject(), referenceSelection,
					containerSelection, atts, refs, "Composition");
		}
		if (mut != null) {
			mut.setId("m1");
			mutations.add(mut);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/was2l/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/was2l/data/model/";
		String modelsURI = "C:/eclipse/workspace/was2l/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/was2l/data/out/was2l.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l350 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l350 != null) {
							int k = 0;
							for (Mutator mut : l350) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2l/data/out/",
					"C:/eclipse/workspace/was2l/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2l/data/model/", "was2l.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2l/data/out/",
					"C:/eclipse/workspace/was2l/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2l/data/model/", "was2l.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
