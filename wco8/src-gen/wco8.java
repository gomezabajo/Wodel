...
public class wco8 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation3
	...
	//
	((AttributeEvaluation) exp0.first).values.add("lt");
	((AttributeEvaluation) exp0.first).values.add("lte");
	((AttributeEvaluation) exp0.first).values.add("gt");
	((AttributeEvaluation) exp0.first).values.add("gte");
	((AttributeEvaluation) exp0.first).values.add("equals");
	((AttributeEvaluation) exp0.first).values.add("distinct");
...
//METHOD NAME:mutation4
	...
	if (hmObjects.get("op") != null) {
		...
		if (hmList.get("op") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmList.get("op"));
		}
		else {
			return mutations;
		}
	...
	if (objectSelection != null) {
		...
		//NAME:operator
		atts.add((ModelManager.getAttribute("operator", (objectSelection != null) ? objectSelection.getObject() : null) instanceof EObject) ? new ListConfigurationStrategy((EObject) ModelManager.getAttribute("operator", (objectSelection != null) ? objectSelection.getObject() : null), "[lt, lte, gt, gte, equals, distinct]", "operator") : null
		);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/wco8/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/wco8/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/wco8/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/wco8/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/wco8/data/out/wco8.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lc45 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lc45 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lc45) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> loper46 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (loper46 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : loper46) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lop47 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (lop47 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lop47) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/wco8/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wco8/data/out/", "C:/eclipse/runtime-EclipseApplication/wco8/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wco8/data/model/", "wco8", "C:/eclipse/runtime-EclipseApplication/wco8", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wco8/data/out/", "C:/eclipse/runtime-EclipseApplication/wco8/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wco8/data/model/", "wco8", "C:/eclipse/runtime-EclipseApplication/wco8", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
