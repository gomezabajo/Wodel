	...
	public NotificationChain basicSetContainer(ObSelectionStrategy newContainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.CREATE_OBJECT_MUTATOR__CONTAINER, oldContainer, newContainer);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContainer != container) {
			...
			if (container != null)
				msgs = ((InternalEObject) container).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.CREATE_OBJECT_MUTATOR__CONTAINER, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.CREATE_OBJECT_MUTATOR__CONTAINER, newContainer, newContainer));
	}
	...
	public EList<AttributeSet> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<AttributeSet>(AttributeSet.class, this,
					MutatorenvironmentPackage.CREATE_OBJECT_MUTATOR__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public EList<ReferenceSet> getReferences() {
		if (references == null) {
			references = new EObjectContainmentEList<ReferenceSet>(ReferenceSet.class, this,
					MutatorenvironmentPackage.CREATE_OBJECT_MUTATOR__REFERENCES);
		}
		return references;
	}
