...
public class RemoveObjectMutatorImpl extends MutatorImpl implements RemoveObjectMutator {
	...
	public NotificationChain basicSetObject(ObSelectionStrategy newObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.REMOVE_OBJECT_MUTATOR__OBJECT, oldObject, newObject);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject) object).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.REMOVE_OBJECT_MUTATOR__OBJECT, null, msgs);
			if (newObject != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.REMOVE_OBJECT_MUTATOR__OBJECT, newObject, newObject));
	}
	...
	public NotificationChain basicSetContainer(ObSelectionStrategy newContainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.REMOVE_OBJECT_MUTATOR__CONTAINER, oldContainer, newContainer);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newContainer != container) {
			...
			if (container != null)
				msgs = ((InternalEObject) container).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.REMOVE_OBJECT_MUTATOR__CONTAINER, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.REMOVE_OBJECT_MUTATOR__CONTAINER, newContainer, newContainer));
	}
