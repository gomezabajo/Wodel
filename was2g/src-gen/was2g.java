...
public class was2g extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/was2g/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/was2g/data/model/";
		String modelsURI = "C:/eclipse/workspace/was2g/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/was2g/data/out/was2g.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l340 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l340 != null) {
							int k = 0;
							for (Mutator mut : l340) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2g/data/out/",
					"C:/eclipse/workspace/was2g/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2g/data/model/", "was2g.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2g/data/out/",
					"C:/eclipse/workspace/was2g/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2g/data/model/", "was2g.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
