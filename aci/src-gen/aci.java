...
public class aci extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		((AttributeEvaluation) exp0.first).name = "createInstance";
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/aci/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/aci/data/model/";
		String modelsURI = "C:/eclipse/workspace/aci/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/aci/data/out/aci.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/aci/data/out/",
					"C:/eclipse/workspace/aci/data/model/bpel.ecore", "C:/eclipse/workspace/aci/data/model/",
					"aci.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/aci/data/out/",
					"C:/eclipse/workspace/aci/data/model/bpel.ecore", "C:/eclipse/workspace/aci/data/model/",
					"aci.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
