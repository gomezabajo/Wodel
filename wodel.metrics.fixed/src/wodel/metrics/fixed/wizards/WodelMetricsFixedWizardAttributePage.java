...
public class WodelMetricsFixedWizardAttributePage extends WizardPage {
	...
	public WodelMetricsFixedWizardAttributePage(ISelection selection, ArrayList<EPackage> mutatorPackages, Resource model, ArrayList<EPackage> packages, String className, String attributeName) {
