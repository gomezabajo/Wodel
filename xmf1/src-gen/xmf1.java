...
public class xmf1 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation1
	...
	//
	//true
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "FaultHandler");
	...
	//REFERENCE: 
	((ReferenceEvaluation) exp0.first).name = "catchAll";
...
//SELECT OBJECT mutation2
	...
	SpecificReferenceSelection referenceSelection = null;
	//
	if (hmObjects.get("fh1") != null) {
		containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("fh1"));
		   			} else {
		   				if (hmList.get("fh1") != null) {
		   					containerSelection = new SpecificObjectSelection(packages, model, hmList.get("fh1"));
		   				}
		   				else {
			return mutations;
		}
	...
	if (hmObjects.get("fh1") != null) {
		referenceSelection = new SpecificReferenceSelection(packages, model, "catchAll", hmObjects.get("fh1"));
			   			} else {
			   				return mutations;
	}
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "CatchAll", referenceSelection, containerSelection);
...
//METHOD NAME:mutation3
	...
	// REMOVE OBJECT mutation3
		...
		//
		ObSelectionStrategy objectSelection = null;
		if (hmObjects.get("c1") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("c1"));
	   			} else {
			return mutations;
		}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/xmf1/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/xmf1/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/xmf1/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/xmf1/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/xmf1/data/out/xmf1.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lfh181 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lfh181 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lfh181) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("fh1", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> lc182 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lc182 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lc182) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("c1", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> l83 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/xmf1/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/xmf1/data/out/", "C:/eclipse/runtime-EclipseApplication/xmf1/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/xmf1/data/model/", "xmf1", "C:/eclipse/runtime-EclipseApplication/xmf1", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/xmf1/data/out/", "C:/eclipse/runtime-EclipseApplication/xmf1/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/xmf1/data/model/", "xmf1", "C:/eclipse/runtime-EclipseApplication/xmf1", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
