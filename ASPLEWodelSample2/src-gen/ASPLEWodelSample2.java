...
public class ASPLEWodelSample2 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation1(ArrayList<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects, HashMap<String, List<EObject>> hmList) throws ReferenceNonExistingException {
		...
		//SELECT OBJECT mutation1
			RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Loop");
			...
			ArrayList<EObject> containers = ModelManager.getParentObjects(model, "Loop");
	...
	private ArrayList<Mutator> mutation2(ArrayList<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects, HashMap<String, List<EObject>> hmList) throws ReferenceNonExistingException {
		...
		ObSelectionStrategy containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("loop"));
		SpecificReferenceSelection referenceSelection = new SpecificReferenceSelection(packages, model, "expression",
		 hmObjects.get("loop")
		);
		HashMap<String, AttributeConfigurationStrategy> atts = new HashMap<String, AttributeConfigurationStrategy>();
		//NAME:value
		atts.put("value", new SpecificBooleanConfigurationStrategy(true)
		);
		HashMap<String, ObSelectionStrategy> refs = new HashMap<String, ObSelectionStrategy>();
		CreateObjectMutator mut = new CreateObjectMutator(model, packages, referenceSelection, containerSelection, atts, refs, "Boolean");
				   	//INC COUNTER: 1
				   	mut.setId("m2");
		mutations.add(mut);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry) throws ReferenceNonExistingException, WrongAttributeTypeException, 
		...
		if (maxAttempts <= 0) {
		    ...
		    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample2/model/Asple.ecore";
		    
		    String modelURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample2/model/";
		    String modelsURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample2/out/";
		    String resourcesURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample2/resources/";
		    ...
		    //2
		   	...
		   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample2/out/ASPLEWodelSample2.model").toFileString());
		   	...
		   	HashMap<String, EObject> hmMutator = getMutators(ModelManager.getObjects(mutatormodel));
		   			...
		   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
		   	   				...
		   	   				//RESET COUNTER: 0
		   	   	   			...
		   	   	   			ArrayList<Mutator> lloop53 = mutation1(packages, model, hashmapEObject, hashmapList);
		   	   	   			//COUNTER: 1
		   	   	   			//REGISTRY METHOD NAME:registry1
		   	   	   			
		   	   	   			if (lloop53 != null) {
		   	   	   				for (Mutator mut : lloop53) {
		   	   	   					if (mut != null) {
		   	   	   						EObject mutated = (EObject) mut.mutate();
		   	   	   						if (mutated != null) {
		   	   	   						hashmapEObject.put("loop", mut.getObject());
		   	   	   			...
		   	   	   			ArrayList<Mutator> l54 = mutation2(packages, model, hashmapEObject, hashmapList);
		   	   	   			//COUNTER: 2
