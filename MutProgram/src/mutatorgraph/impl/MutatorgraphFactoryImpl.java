 ...
 * @generated
 */
public class MutatorgraphFactoryImpl extends EFactoryImpl implements MutatorgraphFactory {
	/**
	 ...
	 * @generated
	 */
	public static MutatorgraphFactory init() {
		try {
			MutatorgraphFactory theMutatorgraphFactory = (MutatorgraphFactory)EPackage.Registry.INSTANCE.getEFactory(MutatorgraphPackage.eNS_URI);
			if (theMutatorgraphFactory != null) {
				return theMutatorgraphFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new MutatorgraphFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public MutatorgraphFactoryImpl() {
		super();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MutatorgraphPackage.MUTATOR_GRAPH: return createMutatorGraph();
			case MutatorgraphPackage.NODE: return createNode();
			case MutatorgraphPackage.EDGE: return createEdge();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case MutatorgraphPackage.NODE_SHAPE:
	 ...
	 * @generated
	 */
	public MutatorgraphPackage getMutatorgraphPackage() {
		return (MutatorgraphPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static MutatorgraphPackage getPackage() {
		return MutatorgraphPackage.eINSTANCE;
	}

} //MutatorgraphFactoryImpl
