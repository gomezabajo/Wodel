...
public class was2j extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:src
  		//REFERENCES COMPILES	667
ObSelectionStrategy refSelection667 = null;
if (hmObjects.get("dep") != null) {
refSelection667 = new SpecificObjectSelection(packages, model, hmObjects.get("dep"), "src");
} else {
	if (hmList.get("dep") != null) {
	refSelection667 = new SpecificObjectSelection(packages, model, hmList.get("dep"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection667);
//NAME:tar
  		//REFERENCES COMPILES	668
ObSelectionStrategy refSelection668 = null;
if (hmObjects.get("dep") != null) {
refSelection668 = new SpecificObjectSelection(packages, model, hmObjects.get("dep"), "tar");
} else {
	if (hmList.get("dep") != null) {
	refSelection668 = new SpecificObjectSelection(packages, model, hmList.get("dep"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection668);
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@424c02da (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/was2j/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/was2j/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/was2j/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/was2j/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/was2j/data/out/was2j.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> ldep2133 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (ldep2133 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ldep2133) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel2134 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel2134 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel2134) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2135 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l2135 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2135) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2136 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l2136 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2136) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/was2j/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2j/data/out/", "C:/eclipse/runtime-EclipseApplication/was2j/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2j/data/model/", "was2j", "C:/eclipse/runtime-EclipseApplication/was2j", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2j/data/out/", "C:/eclipse/runtime-EclipseApplication/was2j/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2j/data/model/", "was2j", "C:/eclipse/runtime-EclipseApplication/was2j", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
