...
public class apm extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation2(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "OnMessage", referenceSelection,
				containerSelection);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/apm/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/apm/data/model/";
		String modelsURI = "C:/eclipse/workspace/apm/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/apm/data/out/apm.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lp1674 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lp1674 != null) {
							int k = 0;
							for (Mutator mut : lp1674) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lm1675 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (lm1675 != null) {
							int k = 0;
							for (Mutator mut : lm1675) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l676 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (l676 != null) {
							int k = 0;
							for (Mutator mut : l676) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/apm/data/out/",
					"C:/eclipse/workspace/apm/data/model/bpel.ecore", "C:/eclipse/workspace/apm/data/model/",
					"apm.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/apm/data/out/",
					"C:/eclipse/workspace/apm/data/model/bpel.ecore", "C:/eclipse/workspace/apm/data/model/",
					"apm.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
