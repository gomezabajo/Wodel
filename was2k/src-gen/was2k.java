...
public class was2k extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/was2k/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/was2k/data/model/";
		String modelsURI = "C:/eclipse/workspace/was2k/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/was2k/data/out/was2k.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l348 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l348 != null) {
							int k = 0;
							for (Mutator mut : l348) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2k/data/out/",
					"C:/eclipse/workspace/was2k/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2k/data/model/", "was2k.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2k/data/out/",
					"C:/eclipse/workspace/was2k/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2k/data/model/", "was2k.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
