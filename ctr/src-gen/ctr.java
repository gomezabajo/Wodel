...
public class ctr extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:symbol
  		//REFERENCES COMPILES	25
RandomTypeSelection refRts25 = new RandomTypeSelection(packages, model, "Symbol");
EObject refObject25 = refRts25.getObject();
ObSelectionStrategy refSelection25 = null;
if (refObject25 != null) {
refSelection25 = 
	new SpecificObjectSelection(packages, model, refObject25);
}
   		refs.put("symbol", refSelection25);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/workspace/ctr/data/model/DFAAutomaton.ecore";
	    
	    String modelURI = "C:/eclipse/workspace/ctr/data/model/";
	    String modelsURI = "C:/eclipse/workspace/ctr/data/out/";
	    //String resourcesURI = "C:/eclipse/workspace/ctr/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/ctr/data/out/ctr.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l60 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/ctr/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/ctr/data/out/", "C:/eclipse/workspace/ctr/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/ctr/data/model/", "ctr", "C:/eclipse/workspace/ctr", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/ctr/data/out/", "C:/eclipse/workspace/ctr/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/ctr/data/model/", "ctr", "C:/eclipse/workspace/ctr", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
