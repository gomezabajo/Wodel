 ...
 * generated by Xtext
 */
package org.configureoptions.formatting;
...
public class ConfigureOptionsFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private ConfigureOptionsGrammarAccess _configureOptionsGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._configureOptionsGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._configureOptionsGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._configureOptionsGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._configureOptionsGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._configureOptionsGrammarAccess.getML_COMMENTRule();
