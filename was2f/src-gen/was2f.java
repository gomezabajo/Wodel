...
public class was2f extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation1
	...
	//
	//true
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Dependency");
...
//NAME:src
  		//REFERENCES COMPILES	534
ObSelectionStrategy refSelection534 = null;
if (hmObjects.get("dep") != null) {
refSelection534 = new SpecificObjectSelection(packages, model, hmObjects.get("dep"), "src");
} else {
	if (hmList.get("dep") != null) {
	refSelection534 = new SpecificObjectSelection(packages, model, hmList.get("dep"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection534);
//NAME:tar
  		//REFERENCES COMPILES	535
ObSelectionStrategy refSelection535 = null;
if (hmObjects.get("dep") != null) {
refSelection535 = new SpecificObjectSelection(packages, model, hmObjects.get("dep"), "tar");
} else {
	if (hmList.get("dep") != null) {
	refSelection535 = new SpecificObjectSelection(packages, model, hmList.get("dep"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection535);
...
if (objectSelection != null && objectSelection.getObject() != null) {
	if (hmObjects.get("dep") != null) {
			   					...
			   					atts.add(new CopyAttributeConfigurationStrategy(objectSelection.getObject(), hmObjects.get("dep"), "name", "name"));
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@1d98e725 (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
//METHOD NAME:mutation4
	...
	// REMOVE OBJECT mutation4
		...
		ObSelectionStrategy objectSelection = null;
		if (hmObjects.get("dep") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("dep"));
	   			} else {
			return mutations;
		}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/was2f/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/was2f/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/was2f/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/was2f/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/was2f/data/out/was2f.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> ldep1720 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (ldep1720 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ldep1720) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("dep", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel1721 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel1721 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel1721) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1722 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l1722 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1722) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1723 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l1723 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1723) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/was2f/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2f/data/out/", "C:/eclipse/runtime-EclipseApplication/was2f/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2f/data/model/", "was2f", "C:/eclipse/runtime-EclipseApplication/was2f", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2f/data/out/", "C:/eclipse/runtime-EclipseApplication/was2f/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2f/data/model/", "was2f", "C:/eclipse/runtime-EclipseApplication/was2f", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
