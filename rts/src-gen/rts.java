...
public class rts extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:name
atts.put("name", new SpecificStringConfigurationStrategy("f")
);
//NAME:isFinal
...
//METHOD NAME:mutation2
	private ArrayList<Mutator> mutation2(ArrayList<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects, HashMap<String, List<EObject>> hmList) throws ReferenceNonExistingException {
		ArrayList<Mutator> mutations = new ArrayList<Mutator>();
	//MODIFY TARGET REFERENCE mutation2
		...
		if (hmObjects.get("s") != null) {
			newTargetSelection = new SpecificObjectSelection(packages, model, hmObjects.get("s"));
	   			} else {
			return mutations;
		}
	...
	//END MODIFY TARGET REFERENCE mutation2
		return mutations;	
	}
//COUNTER: 2
...
trcMut.setDef(hmMutator.get("m2"));
appMut = trcMut;
	return appMut;
}
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/workspace/rts/data/model/DFAAutomaton.ecore";
	    
	    String modelURI = "C:/eclipse/workspace/rts/data/model/";
	    String modelsURI = "C:/eclipse/workspace/rts/data/out/";
	    //String resourcesURI = "C:/eclipse/workspace/rts/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/rts/data/out/rts.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> ls116 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (ls116 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ls116) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l117 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (l117 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l117) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/rts/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/rts/data/out/", "C:/eclipse/workspace/rts/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/rts/data/model/", "rts", "C:/eclipse/workspace/rts", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/rts/data/out/", "C:/eclipse/workspace/rts/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/rts/data/model/", "rts", "C:/eclipse/workspace/rts", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
