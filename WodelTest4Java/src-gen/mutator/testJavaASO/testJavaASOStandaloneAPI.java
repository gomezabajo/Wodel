...
public class testJavaASOStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
		...
		try {
			packages = ModelManager.loadMetaModel(ecoreURI, testJavaASOStandaloneAPI.class);
		} catch (Exception e) {
		}
		...
		muttestJavaASO.execute(maxAttempts, numMutants, registry, metrics, debugMetrics, packages, registeredPackages,
		...
		System.out.println("testJavaASO Mutant generation process finished.");
	}
}
