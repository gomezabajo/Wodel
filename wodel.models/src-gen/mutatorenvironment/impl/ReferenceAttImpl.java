...
public class ReferenceAttImpl extends ReferenceSetImpl implements ReferenceAtt {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.REFERENCE_ATT__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(EAttribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.REFERENCE_ATT__ATTRIBUTE,
	...
	public NotificationChain basicSetValue(AttributeType newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.REFERENCE_ATT__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.REFERENCE_ATT__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.REFERENCE_ATT__VALUE,
					newValue, newValue));
	}
