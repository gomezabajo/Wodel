...
public class ModelDrawCircuitGenerator extends AbstractGenerator {
  ...
  public CharSequence compile(final MutatorDraw draw) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("private void generateGraphs(File file, String folder, List<EPackage> packages, File exercise, String projectName, IProgressMonitor monitor) throws ModelNotFoundException, FileNotFoundException, UnsupportedEncodingException {");
    _builder.newLine();
    _builder.append("\t\t\t");
