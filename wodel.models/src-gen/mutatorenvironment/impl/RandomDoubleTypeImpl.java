...
public class RandomDoubleTypeImpl extends DoubleTypeImpl implements RandomDoubleType {
	...
	public void setMin(double newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.RANDOM_DOUBLE_TYPE__MIN,
					oldMin, min));
	}
	...
	public void setMax(double newMax) {
		...
		max = newMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.RANDOM_DOUBLE_TYPE__MAX,
					oldMax, max));
	}
	...
	public void setAllowsNull(boolean newAllowsNull) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.RANDOM_DOUBLE_TYPE__ALLOWS_NULL, oldAllowsNull, allowsNull));
	}
