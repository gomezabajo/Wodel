...
public class was2d extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
ArrayList<EObject> containers = ModelManager.getParentObjects(packages, model, "Association");
...
//NAME:src
  		//REFERENCES COMPILES	405
ObSelectionStrategy refSelection405 = null;
if (hmObjects.get("comp") != null) {
refSelection405 = new SpecificObjectSelection(packages, model, hmObjects.get("comp"), "src");
} else {
	if (hmList.get("comp") != null) {
	refSelection405 = new SpecificObjectSelection(packages, model, hmList.get("comp"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection405);
//NAME:tar
  		//REFERENCES COMPILES	406
ObSelectionStrategy refSelection406 = null;
if (hmObjects.get("comp") != null) {
refSelection406 = new SpecificObjectSelection(packages, model, hmObjects.get("comp"), "tar");
} else {
	if (hmList.get("comp") != null) {
	refSelection406 = new SpecificObjectSelection(packages, model, hmList.get("comp"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection406);
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@32a4c883 (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/was2d/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/was2d/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/was2d/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/was2d/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/was2d/data/out/was2d.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lcomp1315 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lcomp1315 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lcomp1315) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel1316 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel1316 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel1316) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1317 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l1317 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1317) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1318 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l1318 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1318) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/was2d/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2d/data/out/", "C:/eclipse/runtime-EclipseApplication/was2d/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2d/data/model/", "was2d", "C:/eclipse/runtime-EclipseApplication/was2d", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2d/data/out/", "C:/eclipse/runtime-EclipseApplication/was2d/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2d/data/model/", "was2d", "C:/eclipse/runtime-EclipseApplication/was2d", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
