...
public class WodelFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  ...
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._wodelGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._wodelGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._wodelGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._wodelGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._wodelGrammarAccess.getML_COMMENTRule();
