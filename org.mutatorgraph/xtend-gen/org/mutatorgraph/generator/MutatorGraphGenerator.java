...
public class MutatorGraphGenerator implements IGenerator {
  ...
  public CharSequence compile(final MutatorGraph graph) {
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      for(final Node node : _nodes) {
        ...
        _builder.newLine();
        {
          Negation _negation = node.getNegation();
          boolean _equals = Objects.equal(_negation, Negation.NOT);
          if (_equals) {
            _builder.append("\t\t\t\t\t");
            _builder.append("\t\t\t");
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      for(final Node node_1 : _nodes_1) {
        ...
        _builder.newLine();
        {
          Negation _negation_1 = node_1.getNegation();
          boolean _equals_13 = Objects.equal(_negation_1, Negation.NOT);
          if (_equals_13) {
            _builder.append("\t\t\t\t\t\t");
            _builder.append("\t\t\t");
            _builder.append("if (value == false) {");
    ...
    _builder.append("File dotfolder = new File(\"");
    _builder.append(folder, "\t\t\t\t\t\t");
    _builder.append("/src-gen/html/diagrams/\" + exercise + \"/\");");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("if (dotfolder.exists() != true) {");
    _builder.newLine();
