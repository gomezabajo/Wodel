...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="x"/>
		<constant value="X"/>
		<constant value="16:7-18:3"/>
		<constant value="__applyA"/>
		<constant value="17:11-17:14"/>
	...
	<operation name="61">
		...
		<linenumbertable>
			...
			<lne id="69" begin="9" end="13"/>
			<lne id="70" begin="16" end="16"/>
			<lne id="71" begin="16" end="17"/>
			<lne id="72" begin="14" end="19"/>
			<lne id="60" begin="8" end="20"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="56" begin="7" end="20"/>
			<lve slot="2" name="54" begin="3" end="20"/>
			<lve slot="0" name="17" begin="0" end="20"/>
			<lve slot="1" name="73" begin="0" end="20"/>
		</localvariabletable>
	</operation>
	<operation name="74">
		<context type="6"/>
	...
	<operation name="80">
		...
		<linenumbertable>
			...
			<lne id="79" begin="8" end="14"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="77" begin="7" end="14"/>
			<lve slot="2" name="76" begin="3" end="14"/>
			<lve slot="0" name="17" begin="0" end="14"/>
			<lve slot="1" name="73" begin="0" end="14"/>
		</localvariabletable>
	</operation>
</asm>
