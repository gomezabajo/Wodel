...
public class xmf2 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation2(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Catch", referenceSelection,
				containerSelection);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/xmf2/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/xmf2/data/model/";
		String modelsURI = "C:/eclipse/workspace/xmf2/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/xmf2/data/out/xmf2.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lfh2760 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lfh2760 != null) {
							int k = 0;
							for (Mutator mut : lfh2760) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lc2761 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (lc2761 != null) {
							int k = 0;
							for (Mutator mut : lc2761) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l762 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (l762 != null) {
							int k = 0;
							for (Mutator mut : l762) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xmf2/data/out/",
					"C:/eclipse/workspace/xmf2/data/model/bpel.ecore", "C:/eclipse/workspace/xmf2/data/model/",
					"xmf2.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xmf2/data/out/",
					"C:/eclipse/workspace/xmf2/data/model/bpel.ecore", "C:/eclipse/workspace/xmf2/data/model/",
					"xmf2.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
