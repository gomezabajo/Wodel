	...
	public NotificationChain basicSetValue(AttributeType newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.ATTRIBUTE_SCALAR__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.ATTRIBUTE_SCALAR__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.ATTRIBUTE_SCALAR__VALUE,
					newValue, newValue));
	}
