...
public class ASPLEWodelSample1 extends manager.MutatorUtils implements manager.IMutatorExecutor {
...
//METHOD NAME:mutation1
	...
	List<EObject> objects = rts.getObjects();
			   	...
			   	//
			   	((AttributeEvaluation) exp0.first).values.add("less");
			   	((AttributeEvaluation) exp0.first).values.add("equals");
			   	((AttributeEvaluation) exp0.first).values.add("greater");
	...
	if (objectSelection != null) {
		//NAME:operator
		atts.put("operator", (ModelManager.getAttribute("operator", (objectSelection != null) ? objectSelection.getObject() : null) instanceof String) ? new ListStringConfigurationStrategy((String) ModelManager.getAttribute("operator", (objectSelection != null) ? objectSelection.getObject() : null), "[less, equals, greater, distinct]", "operator") : null
		);
	}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/model/Asple.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/resources/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/out/ASPLEWodelSample1.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l56 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/out/", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/model/Asple.ecore", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/model/", "ASPLEWodelSample1", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/out/", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/model/Asple.ecore", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/data/model/", "ASPLEWodelSample1", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1", hashmapMutVersions);   			
   		}
   	}
}
