...
public class CallExpCSImpl extends LogicExpCSImpl implements CallExpCS {
	...
	public NotificationChain basicSetSource(CallExpCS newSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniOCLPackage.CALL_EXP_CS__SOURCE, oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.CALL_EXP_CS__SOURCE, null, msgs);
			if (newSource != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.CALL_EXP_CS__SOURCE, newSource,
					newSource));
	}
	...
	public NotificationChain basicSetNavExp(NavigationExpCS newNavExp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniOCLPackage.CALL_EXP_CS__NAV_EXP, oldNavExp, newNavExp);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setNavExp(NavigationExpCS newNavExp) {
		if (newNavExp != navExp) {
			NotificationChain msgs = null;
			if (navExp != null)
				msgs = ((InternalEObject) navExp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.CALL_EXP_CS__NAV_EXP, null, msgs);
			if (newNavExp != null)
				msgs = ((InternalEObject) newNavExp).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.CALL_EXP_CS__NAV_EXP, null, msgs);
			msgs = basicSetNavExp(newNavExp, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.CALL_EXP_CS__NAV_EXP, newNavExp,
					newNavExp));
	}
