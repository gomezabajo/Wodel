			...
			for (EObject ob : objects) {
				...
				if (mutator != null) {
					...
					boolean isRepeated = registryMutantWithBlocksStandalone(ecoreURI, packages, registeredPackages,
							...
							fromNames, k, mutPaths, hashmapMutVersions, "testConga", serialize, test, classes,
		...
		if (objects != null) {
			...
			if (mutator != null) {
				...
				boolean isRepeated = registryMutantWithBlocksStandalone(ecoreURI, packages, registeredPackages,
						...
						mutPaths, hashmapMutVersions, "testConga", serialize, test, classes,
						testBotGeneratorStandalone.class, true, false);
				if (isRepeated == false) {
					numMutantsGenerated++;
					monitor.worked(1);
		...
		if (objects != null) {
			...
			if (mutator != null) {
				...
				boolean isRepeated = registryMutantWithBlocksStandalone(ecoreURI, packages, registeredPackages,
						...
						k, mutPaths, hashmapMutVersions, "testConga", serialize, test, classes,
						testBotGeneratorStandalone.class, true, false);
				if (isRepeated == false) {
					numMutantsGenerated++;
					monitor.worked(1);
