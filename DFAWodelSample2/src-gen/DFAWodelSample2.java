...
refSelection9 = new SpecificObjectSelection(packages, model, hmObjects.get("s"));
} else {
	if (hmList.get("s") != null) {
	refSelection9 = new SpecificObjectSelection(packages, model, hmList.get("s"));
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection9);
//NAME:symbol
  		//REFERENCES COMPILES	10
RandomTypeSelection refRts10 = new RandomTypeSelection(packages, model, "AlphabetSymbol");
EObject refObject10 = refRts10.getObject();
ObSelectionStrategy refSelection10 = null;
if (refObject10 != null) {
refSelection10 = 
	new SpecificObjectSelection(packages, model, refObject10);
}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/model/DFAAutomaton.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/out/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/out/DFAWodelSample2.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> ls8 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt9 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/out/", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/model/DFAAutomaton.ecore", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/model/", "DFAWodelSample2", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/out/", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/model/DFAAutomaton.ecore", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2/data/model/", "DFAWodelSample2", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample2", hashmapMutVersions);   			
   		}
   	}
}
