...
public class ael extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/ael/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/ael/data/model/";
		String modelsURI = "C:/eclipse/workspace/ael/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/ael/data/out/ael.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l289 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l289 != null) {
							int k = 0;
							for (Mutator mut : l289) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/ael/data/out/",
					"C:/eclipse/workspace/ael/data/model/bpel.ecore", "C:/eclipse/workspace/ael/data/model/",
					"ael.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/ael/data/out/",
					"C:/eclipse/workspace/ael/data/model/bpel.ecore", "C:/eclipse/workspace/ael/data/model/",
					"ael.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
