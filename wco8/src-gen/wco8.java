...
//METHOD NAME:mutation1
	...
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "BooleanExpCS");
	...
	if (objectSelection != null) {
		...
		if (attsList.get("op") != null) {
			atts = attsList.get("op");
		}
		else {
			atts = new ArrayList<AttributeConfigurationStrategy>();
		}
		//NAME:op
		atts.add((ModelManager.getAttribute("op", (objectSelection != null) ? objectSelection.getObject() : null) instanceof String) ? new ListStringConfigurationStrategy((String) ModelManager.getAttribute("op", (objectSelection != null) ? objectSelection.getObject() : null), "[lt, lte, gt, gte, equals, distinct]", "op") : null
		);
		   		attsList.put("op", atts);
	}
...
attMut0.setAttName("op");
oldAttVal = ((ModifyInformationMutator) mut).getOldAttValue("op");
newAttVal = ((ModifyInformationMutator) mut).getNewAttValue("op");
if (oldAttVal != null) {
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l516 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (l516 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l516) {
	   	   	   					if (mut != null) {
