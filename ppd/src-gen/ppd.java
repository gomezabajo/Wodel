...
public class ppd extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/ppd/data/out/ppd.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lr162 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lr162 != null) {
							int k = 0;
							for (Mutator mut : lr162) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lp163 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (lp163 != null) {
							int k = 0;
							for (Mutator mut : lp163) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lc164 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (lc164 != null) {
							int k = 0;
							for (Mutator mut : lc164) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l165 = mutation4(packages, model, hashmapEObject, hashmapList);
						if (l165 != null) {
							int k = 0;
							for (Mutator mut : l165) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/ppd/data/out/",
					"C:/eclipse/workspace/ppd/data/model/SecurityPolicy.ecore", "C:/eclipse/workspace/ppd/data/model/",
					"ppd.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/ppd/data/out/",
					"C:/eclipse/workspace/ppd/data/model/SecurityPolicy.ecore", "C:/eclipse/workspace/ppd/data/model/",
					"ppd.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
