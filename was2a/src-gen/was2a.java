...
//NAME:src
  		//REFERENCES COMPILES	276
ObSelectionStrategy refSelection276 = null;
if (hmObjects.get("as") != null) {
refSelection276 = new SpecificObjectSelection(packages, model, hmObjects.get("as"), "src");
} else {
	if (hmList.get("as") != null) {
	refSelection276 = new SpecificObjectSelection(packages, model, hmList.get("as"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection276);
//NAME:tar
  		//REFERENCES COMPILES	277
ObSelectionStrategy refSelection277 = null;
if (hmObjects.get("as") != null) {
refSelection277 = new SpecificObjectSelection(packages, model, hmObjects.get("as"), "tar");
} else {
	if (hmList.get("as") != null) {
	refSelection277 = new SpecificObjectSelection(packages, model, hmList.get("as"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection277);
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@51b9db (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> las910 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (las910 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : las910) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel911 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel911 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel911) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l912 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l912 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l912) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l913 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l913 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l913) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
