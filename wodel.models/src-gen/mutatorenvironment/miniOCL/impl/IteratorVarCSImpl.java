...
public class IteratorVarCSImpl extends MinimalEObjectImpl.Container implements IteratorVarCS {
	...
	public void setItName(String newItName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.ITERATOR_VAR_CS__IT_NAME, oldItName,
					itName));
	}
	...
	public NotificationChain basicSetItType(PathNameCS newItType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniOCLPackage.ITERATOR_VAR_CS__IT_TYPE, oldItType, newItType);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setItType(PathNameCS newItType) {
		if (newItType != itType) {
			...
			if (itType != null)
				msgs = ((InternalEObject) itType).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.ITERATOR_VAR_CS__IT_TYPE, null, msgs);
			if (newItType != null)
				msgs = ((InternalEObject) newItType).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.ITERATOR_VAR_CS__IT_TYPE, null, msgs);
			msgs = basicSetItType(newItType, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.ITERATOR_VAR_CS__IT_TYPE, newItType,
					newItType));
	}
