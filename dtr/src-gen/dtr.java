...
public class dtr extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/workspace/dtr/data/model/DFAAutomaton.ecore";
	    
	    String modelURI = "C:/eclipse/workspace/dtr/data/model/";
	    String modelsURI = "C:/eclipse/workspace/dtr/data/out/";
	    //String resourcesURI = "C:/eclipse/workspace/dtr/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/dtr/data/out/dtr.model").toFileString());
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/dtr/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/dtr/data/out/", "C:/eclipse/workspace/dtr/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/dtr/data/model/", "dtr", "C:/eclipse/workspace/dtr", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/dtr/data/out/", "C:/eclipse/workspace/dtr/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/dtr/data/model/", "dtr", "C:/eclipse/workspace/dtr", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
