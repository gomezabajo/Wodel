...
public class apa1 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/apa1/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/apa1/data/model/";
		String modelsURI = "C:/eclipse/workspace/apa1/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/apa1/data/out/apa1.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lp2850 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lp2850 != null) {
							int k = 0;
							for (Mutator mut : lp2850) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> la2851 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (la2851 != null) {
							int k = 0;
							for (Mutator mut : la2851) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l852 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (l852 != null) {
							int k = 0;
							for (Mutator mut : l852) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/apa1/data/out/",
					"C:/eclipse/workspace/apa1/data/model/bpel.ecore", "C:/eclipse/workspace/apa1/data/model/",
					"apa1.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/apa1/data/out/",
					"C:/eclipse/workspace/apa1/data/model/bpel.ecore", "C:/eclipse/workspace/apa1/data/model/",
					"apa1.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
