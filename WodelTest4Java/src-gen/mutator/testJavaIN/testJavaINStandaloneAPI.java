...
public class testJavaINStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
		...
		muttestJavaIN.execute(maxAttempts, numMutants, registry, metrics, debugMetrics, packages, registeredPackages,
		...
		System.out.println("testJavaIN Mutant generation process finished.");
	}
}
