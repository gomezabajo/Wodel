...
public class MultiChoiceTextImpl extends MutatorTestsImpl implements MultiChoiceText {
	...
	public void setConfig(TextConfiguration newConfig) {
		if (newConfig != config) {
			...
			if (config != null)
				msgs = ((InternalEObject)config).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EdutestPackage.MULTI_CHOICE_TEXT__CONFIG, null, msgs);
			if (newConfig != null)
				msgs = ((InternalEObject)newConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EdutestPackage.MULTI_CHOICE_TEXT__CONFIG, null, msgs);
			msgs = basicSetConfig(newConfig, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdutestPackage.MULTI_CHOICE_TEXT__CONFIG, newConfig, newConfig));
	}
