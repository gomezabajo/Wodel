...
public class WodelMutatorGenerator implements IGenerator {
  ...
  public boolean isRequired(final HashMap<String, List<Integer>> classes, final String name) {
    boolean _containsKey = classes.containsKey(name);
    if (_containsKey) {
      boolean _and = false;
      List<Integer> _get = classes.get(name);
      Integer _get_1 = _get.get(0);
      boolean _greaterThan = ((_get_1).intValue() > 0);
      if (!_greaterThan) {
        _and = false;
      } else {
        List<Integer> _get_2 = classes.get(name);
        Integer _get_3 = _get_2.get(1);
        boolean _greaterThan_1 = ((_get_3).intValue() > 0);
        _and = _greaterThan_1;
      }
      if (_and) {
        return true;
  ...
  public void incContainers(final EClass eclass, final HashMap<String, List<Integer>> classes, final ArrayList<EPackage> packages, final EClass root) {
    ...
    for (final EClassifier container : containers) {
      ...
      if (_and) {
        ...
        List<Integer> cardinality = classes.get(_name_5);
        Integer _get = cardinality.get(0);
        int min = ((_get).intValue() + 1);
        Integer _get_1 = cardinality.get(1);
        int max = ((_get_1).intValue() + 1);
        ArrayList<Integer> _arrayList = new ArrayList<Integer>();
        cardinality = _arrayList;
        cardinality.add(Integer.valueOf(min));
        cardinality.add(Integer.valueOf(max));
        String _name_6 = container.getName();
        classes.put(_name_6, cardinality);
        this.incContainers(((EClass) container), classes, packages, root);
      }
    }
  }
  
  public String increase(final HashMap<String, List<Integer>> classes, final String name, final ArrayList<EPackage> packages, final EClass root) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("# ");
    List<Integer> cardinality = classes.get(name);
    _builder.newLineIfNotEmpty();
    _builder.append("# ");
    Integer _get = cardinality.get(0);
    int min = ((_get).intValue() + 1);
    ...
    _builder.append("# ");
    ArrayList<Integer> _arrayList = new ArrayList<Integer>();
    _builder.append(cardinality = _arrayList, "");
    _builder.newLineIfNotEmpty();
    _builder.append("# ");
    boolean _add = cardinality.add(Integer.valueOf(min));
    _builder.append(_add, "");
    _builder.newLineIfNotEmpty();
    _builder.append("# ");
    boolean _add_1 = cardinality.add(Integer.valueOf(max));
    _builder.append(_add_1, "");
    _builder.newLineIfNotEmpty();
    _builder.append("# ");
    List<Integer> _put = classes.put(name, cardinality);
    _builder.append(_put, "");
    _builder.newLineIfNotEmpty();
    _builder.append("# ");
    EClass eclass = ModelManager.getEClassByName(packages, name);
    _builder.newLineIfNotEmpty();
    this.incContainers(eclass, classes, packages, root);
    _builder.newLineIfNotEmpty();
    {
      ...
      for(final EReference ref : _eReferences) {
        {
          ...
          if (_greaterThan) {
            ...
            int[] l = new int[_lowerBound_1];
            _builder.newLineIfNotEmpty();
            {
              for(final int i : l) {
                EClassifier _eType = ref.getEType();
                String _name = _eType.getName();
                String _increase = this.increase(classes, _name, packages, root);
                _builder.append(_increase, "");
                _builder.newLineIfNotEmpty();
              }
            }
          }
  ...
  public CharSequence properties(final MutatorEnvironment e) {
    try {
      ...
      _builder.append("# ");
      boolean _remove = eclasses.remove(root);
      ...
      _builder.newLineIfNotEmpty();
      {
        for(final EClass eclass_1 : eclasses) {
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("# ");
          boolean _add = cardinality.add(Integer.valueOf(0));
          _builder.append(_add, "");
          _builder.newLineIfNotEmpty();
          _builder.append("# ");
          boolean _add_1 = cardinality.add(Integer.valueOf(0));
          _builder.append(_add_1, "");
          _builder.newLineIfNotEmpty();
          _builder.append("# ");
          String _name_1 = eclass_1.getName();
          List<Integer> _put = classes.put(_name_1, cardinality);
          _builder.append(_put, "");
          _builder.newLineIfNotEmpty();
        }
      }
      _builder.newLine();
      {
        ...
        if (_greaterThan) {
          {
            EList<Mutator> _commands_1 = e.getCommands();
            for(final Mutator mut : _commands_1) {
              {
                if ((mut instanceof CreateObjectMutator)) {
                  {
                        ...
                        for(final EClassifier container : containers) {
                          {
                            ...
                            boolean _containsKey = classes.containsKey(_name_2);
                            if (_containsKey) {
                              String _name_3 = container.getName();
                              String _increase = this.increase(classes, _name_3, packages, root);
                              _builder.append(_increase, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                ...
                if ((mut instanceof RemoveObjectMutator)) {
                  {
                    ...
                    if (_notEquals_1) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_1 = classes.containsKey(name_1);
                        if (_containsKey_1) {
                          String _increase_1 = this.increase(classes, name_1, packages, root);
                          _builder.append(_increase_1, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                ...
                if ((mut instanceof CreateReferenceMutator)) {
                  {
                    ...
                    if (_notEquals_2) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_2 = classes.containsKey(name_2);
                        if (_containsKey_2) {
                          String _increase_2 = this.increase(classes, name_2, packages, root);
                          _builder.append(_increase_2, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                  }
                  {
                    ...
                    if (_notEquals_3) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_3 = classes.containsKey(name_3);
                        if (_containsKey_3) {
                          String _increase_3 = this.increase(classes, name_3, packages, root);
                          _builder.append(_increase_3, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                ...
                if ((mut instanceof ModifySourceReferenceMutator)) {
                  {
                    ...
                    if (_notEquals_4) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_4 = classes.containsKey(name_4);
                        if (_containsKey_4) {
                          String _increase_4 = this.increase(classes, name_4, packages, root);
                          _builder.append(_increase_4, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                  }
                  {
                    ...
                    if (_notEquals_5) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_5 = classes.containsKey(name_5);
                        if (_containsKey_5) {
                          String _increase_5 = this.increase(classes, name_5, packages, root);
                          _builder.append(_increase_5, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                ...
                if ((mut instanceof ModifyTargetReferenceMutator)) {
                  {
                    ...
                    if (_notEquals_6) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_6 = classes.containsKey(name_6);
                        if (_containsKey_6) {
                          String _increase_6 = this.increase(classes, name_6, packages, root);
                          _builder.append(_increase_6, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                  }
                  {
                    ...
                    if (_notEquals_7) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_7 = classes.containsKey(name_7);
                        if (_containsKey_7) {
                          String _increase_7 = this.increase(classes, name_7, packages, root);
                          _builder.append(_increase_7, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                ...
                if ((mut instanceof RemoveCompleteReferenceMutator)) {
                  {
                    ...
                    if (_notEquals_8) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_8 = classes.containsKey(name_8);
                        if (_containsKey_8) {
                          String _increase_8 = this.increase(classes, name_8, packages, root);
                          _builder.append(_increase_8, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                ...
                if ((mut instanceof SelectObjectMutator)) {
                  {
                    ...
                    if (_notEquals_9) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_9 = classes.containsKey(name_9);
                        if (_containsKey_9) {
                          String _increase_9 = this.increase(classes, name_9, packages, root);
                          _builder.append(_increase_9, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                ...
                if ((mut instanceof SelectSampleMutator)) {
                  {
                    ...
                    if (_notEquals_10) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_10 = classes.containsKey(name_10);
                        if (_containsKey_10) {
                          String _increase_10 = this.increase(classes, name_10, packages, root);
                          _builder.append(_increase_10, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                ...
                if ((mut instanceof CloneObjectMutator)) {
                  {
                    ...
                    if (_notEquals_11) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_11 = classes.containsKey(name_11);
                        if (_containsKey_11) {
                          String _increase_11 = this.increase(classes, name_11, packages, root);
                          _builder.append(_increase_11, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
                ...
                if ((mut instanceof ModifyInformationMutator)) {
                  {
                    ...
                    if (_notEquals_12) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        boolean _containsKey_12 = classes.containsKey(name_12);
                        if (_containsKey_12) {
                          String _increase_12 = this.increase(classes, name_12, packages, root);
                          _builder.append(_increase_12, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
                    }
            ...
            for(final Block b : _blocks_1) {
              {
                ...
                for(final Mutator mut_1 : _commands_2) {
                  {
                    if ((mut_1 instanceof CreateObjectMutator)) {
                      {
                        EClass _type_4 = ((CreateObjectMutator)mut_1).getType();
                        boolean _notEquals_13 = (!Objects.equal(_type_4, null));
                        if (_notEquals_13) {
                          _builder.append("# ");
                          EClass _type_5 = ((CreateObjectMutator)mut_1).getType();
                          String name_13 = _type_5.getName();
                          _builder.newLineIfNotEmpty();
                          _builder.append("# ");
                          List<EClassifier> containers_1 = ModelManager.getContainerTypes(packages, name_13);
                          _builder.newLineIfNotEmpty();
                          {
                            for(final EClassifier container_1 : containers_1) {
                              {
                                String _name_4 = container_1.getName();
                                boolean _containsKey_13 = classes.containsKey(_name_4);
                                if (_containsKey_13) {
                                  String _name_5 = container_1.getName();
                                  String _increase_13 = this.increase(classes, _name_5, packages, root);
                                  _builder.append(_increase_13, "");
                                  _builder.newLineIfNotEmpty();
                                }
                              }
                            }
                  ...
                  {
                    if ((mut_1 instanceof RemoveObjectMutator)) {
                      {
                        ObSelectionStrategy _object_10 = ((RemoveObjectMutator)mut_1).getObject();
                        boolean _notEquals_14 = (!Objects.equal(_object_10, null));
                        if (_notEquals_14) {
                          _builder.append("# ");
                          ObSelectionStrategy _object_11 = ((RemoveObjectMutator)mut_1).getObject();
                          String name_14 = MutatorUtils.getTypeName(_object_11);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_14 = classes.containsKey(name_14);
                            if (_containsKey_14) {
                              String _increase_14 = this.increase(classes, name_14, packages, root);
                              _builder.append(_increase_14, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                  ...
                  {
                    if ((mut_1 instanceof CreateReferenceMutator)) {
                      {
                        ObSelectionStrategy _target_2 = ((CreateReferenceMutator)mut_1).getTarget();
                        boolean _notEquals_15 = (!Objects.equal(_target_2, null));
                        if (_notEquals_15) {
                          _builder.append("# ");
                          ObSelectionStrategy _target_3 = ((CreateReferenceMutator)mut_1).getTarget();
                          String name_15 = MutatorUtils.getTypeName(_target_3);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_15 = classes.containsKey(name_15);
                            if (_containsKey_15) {
                              String _increase_15 = this.increase(classes, name_15, packages, root);
                              _builder.append(_increase_15, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                      ...
                      {
                        ObSelectionStrategy _source_6 = ((CreateReferenceMutator)mut_1).getSource();
                        boolean _notEquals_16 = (!Objects.equal(_source_6, null));
                        if (_notEquals_16) {
                          _builder.append("#");
                          ObSelectionStrategy _source_7 = ((CreateReferenceMutator)mut_1).getSource();
                          String name_16 = MutatorUtils.getTypeName(_source_7);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_16 = classes.containsKey(name_16);
                            if (_containsKey_16) {
                              String _increase_16 = this.increase(classes, name_16, packages, root);
                              _builder.append(_increase_16, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                  ...
                  {
                    if ((mut_1 instanceof ModifySourceReferenceMutator)) {
                      {
                        ObSelectionStrategy _source_8 = ((ModifySourceReferenceMutator)mut_1).getSource();
                        boolean _notEquals_17 = (!Objects.equal(_source_8, null));
                        if (_notEquals_17) {
                          _builder.append("#");
                          ObSelectionStrategy _source_9 = ((ModifySourceReferenceMutator)mut_1).getSource();
                          String name_17 = MutatorUtils.getTypeName(_source_9);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_17 = classes.containsKey(name_17);
                            if (_containsKey_17) {
                              String _increase_17 = this.increase(classes, name_17, packages, root);
                              _builder.append(_increase_17, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                      ...
                      {
                        ObSelectionStrategy _newSource_2 = ((ModifySourceReferenceMutator)mut_1).getNewSource();
                        boolean _notEquals_18 = (!Objects.equal(_newSource_2, null));
                        if (_notEquals_18) {
                          _builder.append("#");
                          ObSelectionStrategy _newSource_3 = ((ModifySourceReferenceMutator)mut_1).getNewSource();
                          String name_18 = MutatorUtils.getTypeName(_newSource_3);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_18 = classes.containsKey(name_18);
                            if (_containsKey_18) {
                              String _increase_18 = this.increase(classes, name_18, packages, root);
                              _builder.append(_increase_18, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                  ...
                  {
                    if ((mut_1 instanceof ModifyTargetReferenceMutator)) {
                      {
                        ObSelectionStrategy _source_10 = ((ModifyTargetReferenceMutator)mut_1).getSource();
                        boolean _notEquals_19 = (!Objects.equal(_source_10, null));
                        if (_notEquals_19) {
                          _builder.append("#");
                          ObSelectionStrategy _source_11 = ((ModifyTargetReferenceMutator)mut_1).getSource();
                          String name_19 = MutatorUtils.getTypeName(_source_11);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_19 = classes.containsKey(name_19);
                            if (_containsKey_19) {
                              String _increase_19 = this.increase(classes, name_19, packages, root);
                              _builder.append(_increase_19, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                      ...
                      {
                        ObSelectionStrategy _newTarget_2 = ((ModifyTargetReferenceMutator)mut_1).getNewTarget();
                        boolean _notEquals_20 = (!Objects.equal(_newTarget_2, null));
                        if (_notEquals_20) {
                          _builder.append("#");
                          ObSelectionStrategy _newTarget_3 = ((ModifyTargetReferenceMutator)mut_1).getNewTarget();
                          String name_20 = MutatorUtils.getTypeName(_newTarget_3);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_20 = classes.containsKey(name_20);
                            if (_containsKey_20) {
                              String _increase_20 = this.increase(classes, name_20, packages, root);
                              _builder.append(_increase_20, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                  ...
                  {
                    if ((mut_1 instanceof RemoveCompleteReferenceMutator)) {
                      {
                        EClass _type_6 = ((RemoveCompleteReferenceMutator)mut_1).getType();
                        boolean _notEquals_21 = (!Objects.equal(_type_6, null));
                        if (_notEquals_21) {
                          _builder.append("#");
                          EClass _type_7 = ((RemoveCompleteReferenceMutator)mut_1).getType();
                          String name_21 = _type_7.getName();
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_21 = classes.containsKey(name_21);
                            if (_containsKey_21) {
                              String _increase_21 = this.increase(classes, name_21, packages, root);
                              _builder.append(_increase_21, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                  ...
                  {
                    if ((mut_1 instanceof SelectObjectMutator)) {
                      {
                        ObSelectionStrategy _object_12 = ((SelectObjectMutator)mut_1).getObject();
                        boolean _notEquals_22 = (!Objects.equal(_object_12, null));
                        if (_notEquals_22) {
                          _builder.append("#");
                          ObSelectionStrategy _object_13 = ((SelectObjectMutator)mut_1).getObject();
                          String name_22 = MutatorUtils.getTypeName(_object_13);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_22 = classes.containsKey(name_22);
                            if (_containsKey_22) {
                              String _increase_22 = this.increase(classes, name_22, packages, root);
                              _builder.append(_increase_22, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                  ...
                  {
                    if ((mut_1 instanceof SelectSampleMutator)) {
                      {
                        ObSelectionStrategy _object_14 = ((SelectSampleMutator)mut_1).getObject();
                        boolean _notEquals_23 = (!Objects.equal(_object_14, null));
                        if (_notEquals_23) {
                          _builder.append("#");
                          ObSelectionStrategy _object_15 = ((SelectSampleMutator)mut_1).getObject();
                          String name_23 = MutatorUtils.getTypeName(_object_15);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_23 = classes.containsKey(name_23);
                            if (_containsKey_23) {
                              String _increase_23 = this.increase(classes, name_23, packages, root);
                              _builder.append(_increase_23, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                  ...
                  {
                    if ((mut_1 instanceof CloneObjectMutator)) {
                      {
                        ObSelectionStrategy _object_16 = ((CloneObjectMutator)mut_1).getObject();
                        boolean _notEquals_24 = (!Objects.equal(_object_16, null));
                        if (_notEquals_24) {
                          _builder.append("#");
                          ObSelectionStrategy _object_17 = ((CloneObjectMutator)mut_1).getObject();
                          String name_24 = MutatorUtils.getTypeName(_object_17);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_24 = classes.containsKey(name_24);
                            if (_containsKey_24) {
                              String _increase_24 = this.increase(classes, name_24, packages, root);
                              _builder.append(_increase_24, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
                  ...
                  {
                    if ((mut_1 instanceof ModifyInformationMutator)) {
                      {
                        ObSelectionStrategy _object_18 = ((ModifyInformationMutator)mut_1).getObject();
                        boolean _notEquals_25 = (!Objects.equal(_object_18, null));
                        if (_notEquals_25) {
                          _builder.append("#");
                          ObSelectionStrategy _object_19 = ((ModifyInformationMutator)mut_1).getObject();
                          String name_25 = MutatorUtils.getTypeName(_object_19);
                          _builder.newLineIfNotEmpty();
                          {
                            boolean _containsKey_25 = classes.containsKey(name_25);
                            if (_containsKey_25) {
                              String _increase_25 = this.increase(classes, name_25, packages, root);
                              _builder.append(_increase_25, "");
                              _builder.newLineIfNotEmpty();
                            }
                          }
                        }
      ...
      _builder.newLineIfNotEmpty();
      {
        EList<EAttribute> _eAttributes = root.getEAttributes();
        for(final EAttribute att : _eAttributes) {
          {
            EClassifier _eType = att.getEType();
            String _name_8 = _eType.getName();
            boolean _equals_1 = _name_8.equals("EString");
            if (_equals_1) {
              _builder.append("# ");
              int size = 1;
              _builder.newLineIfNotEmpty();
              ...
              _builder.newLineIfNotEmpty();
              {
                if ((size > 0)) {
                  ...
                  String id = _name_9.substring(0, 1);
                  _builder.newLineIfNotEmpty();
                  _builder.append("# ");
                  boolean _add_2 = set.add((id + "1"));
                  _builder.append(_add_2, "");
                  _builder.newLineIfNotEmpty();
                  _builder.append("# ");
                  String _get = set.get(0);
                  String _plus = ("\'" + _get);
                  String _plus_1 = (_plus + "\'");
                  _builder.append(setText = _plus_1, "");
                  _builder.newLineIfNotEmpty();
                  {
                    if ((size > 1)) {
                      _builder.append("# ");
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        for(final int l : list) {
                          ...
                          _builder.newLineIfNotEmpty();
                          _builder.append("# ");
                          boolean _add_3 = set.add((id + Integer.valueOf(i)));
                          _builder.append(_add_3, "");
                          _builder.newLineIfNotEmpty();
                          _builder.append("# ");
                          String _setText = setText;
                          String _get_1 = set.get((i - 1));
                          String _plus_2 = (", \'" + _get_1);
                          String _plus_3 = (_plus_2 + "\'");
                          String _plus_4 = setText = (_setText + _plus_3);
                          _builder.append(_plus_4, "");
                          _builder.newLineIfNotEmpty();
                        }
                      }
      ...
      _builder.newLine();
      {
        for(final EClass eclass_2 : eclasses) {
          {
            String _name_12 = eclass_2.getName();
            boolean _isRequired = this.isRequired(classes, _name_12);
            if (_isRequired) {
              String _name_13 = eclass_2.getName();
              _builder.append(_name_13, "");
              _builder.append("_min = ");
              String _name_14 = eclass_2.getName();
              List<Integer> _get_2 = classes.get(_name_14);
              ...
              List<Integer> _get_4 = classes.get(_name_16);
              Integer _get_5 = _get_4.get(1);
              _builder.append(_get_5, "");
              _builder.newLineIfNotEmpty();
              {
                EList<EAttribute> _eAttributes_1 = eclass_2.getEAttributes();
                for(final EAttribute att_1 : _eAttributes_1) {
                  {
                    EClassifier _eType_1 = att_1.getEType();
                    String _name_17 = _eType_1.getName();
                    boolean _equals_2 = _name_17.equals("EString");
                    if (_equals_2) {
                      _builder.append("# ");
                      String _name_18 = eclass_2.getName();
                      List<Integer> _get_6 = classes.get(_name_18);
                      Integer size_1 = _get_6.get(1);
                      _builder.newLineIfNotEmpty();
                      _builder.append("# ");
                      String setText_1 = "";
                      _builder.newLineIfNotEmpty();
                      {
                        if (((size_1).intValue() > 0)) {
                          _builder.append("# ");
                          ArrayList<String> set_1 = new ArrayList<String>();
                          _builder.newLineIfNotEmpty();
                          _builder.append("# ");
                          String _name_19 = eclass_2.getName();
                          String id_1 = _name_19.substring(0, 1);
                          _builder.newLineIfNotEmpty();
                          _builder.append("# ");
                          boolean _add_4 = set_1.add((id_1 + "1"));
                          _builder.append(_add_4, "");
                          _builder.newLineIfNotEmpty();
                          _builder.append("# ");
                          String _get_7 = set_1.get(0);
                          String _plus_5 = ("\'" + _get_7);
                          String _plus_6 = (_plus_5 + "\'");
                          _builder.append(setText_1 = _plus_6, "");
                          _builder.newLineIfNotEmpty();
                          {
                            if (((size_1).intValue() > 1)) {
                              _builder.append("# ");
                              int[] list_1 = new int[((size_1).intValue() - 1)];
                              _builder.newLineIfNotEmpty();
                              _builder.append("# ");
                              int i_1 = 1;
                              _builder.newLineIfNotEmpty();
                              {
                                for(final int l_1 : list_1) {
                                  _builder.append("# ");
                                  int _plusPlus_1 = i_1++;
                                  _builder.append(_plusPlus_1, "");
                                  _builder.newLineIfNotEmpty();
                                  _builder.append("# ");
                                  boolean _add_5 = set_1.add((id_1 + Integer.valueOf(i_1)));
                                  _builder.append(_add_5, "");
                                  _builder.newLineIfNotEmpty();
                                  _builder.append("# ");
                                  String _setText_1 = setText_1;
                                  String _get_8 = set_1.get((i_1 - 1));
                                  String _plus_7 = (", \'" + _get_8);
                                  String _plus_8 = (_plus_7 + "\'");
                                  String _plus_9 = setText_1 = (_setText_1 + _plus_8);
                      ...
                      String _name_20 = eclass_2.getName();
                      _builder.append(_name_20, "");
                      _builder.append("_");
                      String _name_21 = att_1.getName();
                      _builder.append(_name_21, "");
                      _builder.append(" = Set{");
                      _builder.append(setText_1, "");
                      _builder.append("}");
                      _builder.newLineIfNotEmpty();
                    }
                  }
      ...
      _builder.newLineIfNotEmpty();
      _builder.append("# ");
      List<EReference> rootRefs = root.getEReferences();
      _builder.newLineIfNotEmpty();
      {
        int _size_3 = rootRefs.size();
        boolean _greaterThan_2 = (_size_3 > 0);
        if (_greaterThan_2) {
          {
            for(final EReference ref : rootRefs) {
              _builder.append("# ");
              String _name_22 = root.getName();
              EClassifier _eType_2 = ref.getEType();
              String _name_23 = _eType_2.getName();
              String associationName = (_name_22 + _name_23);
              _builder.newLineIfNotEmpty();
              {
                Integer _get_9 = associationNames.get(associationName);
                boolean _notEquals_26 = (!Objects.equal(_get_9, null));
                if (_notEquals_26) {
                  _builder.append("# ");
                  Integer _get_10 = associationNames.get(associationName);
                  int _plus_10 = ((_get_10).intValue() + 1);
                  Integer _put_1 = associationNames.put(associationName, Integer.valueOf(_plus_10));
                  _builder.append(_put_1, "");
                  _builder.newLineIfNotEmpty();
                  _builder.append("# ");
                  String _associationName = associationName;
                  Integer _get_11 = associationNames.get(associationName);
                  String _plus_11 = associationName = (_associationName + _get_11);
                  _builder.append(_plus_11, "");
                  _builder.newLineIfNotEmpty();
                } else {
                  _builder.append("# ");
              ...
              String _name_24 = _eType_3.getName();
              List<Integer> _get_12 = classes.get(_name_24);
              Integer _get_13 = _get_12.get(0);
              _builder.append(_get_13, "");
              _builder.newLineIfNotEmpty();
              _builder.append(associationName, "");
              _builder.append("_max = ");
              EClassifier _eType_4 = ref.getEType();
              String _name_25 = _eType_4.getName();
              List<Integer> _get_14 = classes.get(_name_25);
              Integer _get_15 = _get_14.get(1);
              _builder.append(_get_15, "");
              _builder.newLineIfNotEmpty();
            }
          }
      ...
      }
      {
        for(final EClass eclass_3 : eclasses) {
          ...
          _builder.newLineIfNotEmpty();
          {
            int _size_4 = refs.size();
            boolean _greaterThan_3 = (_size_4 > 0);
            if (_greaterThan_3) {
              {
                for(final EReference ref_1 : refs) {
                  _builder.append("# ");
                  String _name_26 = eclass_3.getName();
                  EClassifier _eType_5 = ref_1.getEType();
                  String _name_27 = _eType_5.getName();
                  String associationName_1 = (_name_26 + _name_27);
                  _builder.newLineIfNotEmpty();
                  {
                    Integer _get_16 = associationNames.get(associationName_1);
                    boolean _notEquals_27 = (!Objects.equal(_get_16, null));
                    if (_notEquals_27) {
                      _builder.append("# ");
                      Integer _get_17 = associationNames.get(associationName_1);
                      int _plus_12 = ((_get_17).intValue() + 1);
                      Integer _put_3 = associationNames.put(associationName_1, Integer.valueOf(_plus_12));
                      _builder.append(_put_3, "");
                      _builder.newLineIfNotEmpty();
                      _builder.append("# ");
                      String _associationName_1 = associationName_1;
                      Integer _get_18 = associationNames.get(associationName_1);
                      String _plus_13 = associationName_1 = (_associationName_1 + _get_18);
                      _builder.append(_plus_13, "");
                      _builder.newLineIfNotEmpty();
                    } else {
                      _builder.append("# ");
                      Integer _put_4 = associationNames.put(associationName_1, Integer.valueOf(0));
                      _builder.append(_put_4, "");
                      _builder.newLineIfNotEmpty();
                    }
                  }
                  _builder.append(associationName_1, "");
                  _builder.append("_min = ");
                  String _name_28 = eclass_3.getName();
                  List<Integer> _get_19 = classes.get(_name_28);
                  Integer _get_20 = _get_19.get(0);
                  _builder.append(_get_20, "");
                  _builder.newLineIfNotEmpty();
                  _builder.append(associationName_1, "");
                  _builder.append("_max = ");
                  String _name_29 = eclass_3.getName();
                  List<Integer> _get_21 = classes.get(_name_29);
                  Integer _get_22 = _get_21.get(1);
                  _builder.append(_get_22, "");
                  _builder.newLineIfNotEmpty();
                }
              }
  ...
  public CharSequence use(final MutatorEnvironment e) {
    try {
        ...
        for(final EClass eclass : eclasses) {
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            for(final EClass superclass : _eSuperTypes) {
              ...
              boolean _add = superclasses.add(_name);
              _builder.append(_add, "");
              _builder.newLineIfNotEmpty();
            }
          }
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            if (_greaterThan) {
              ...
              _builder.append(_name_1, "");
              _builder.append(" < ");
              _builder.append(superclassestext, "");
              _builder.newLineIfNotEmpty();
            } else {
              _builder.append("class ");
                ...
                for(final EAttribute att : atts) {
                  {
                    ...
                    boolean _equals = _name_3.equals("EString");
                    if (_equals) {
                      _builder.append("\t");
                      _builder.append("\t");
                  ...
                  }
                  {
                    ...
                    boolean _equals_1 = _name_5.equals("EBoolean");
                    if (_equals_1) {
                      _builder.append("\t");
                      _builder.append("\t");
                  ...
                  }
                  {
                    ...
                    String _name_7 = _eType_2.getName();
                    boolean _equals_2 = _name_7.equals("EInt");
                    if (_equals_2) {
                      _builder.append("\t");
                      _builder.append("\t");
                ...
                for(final EAnnotation a : annotations) {
                  {
                    ...
                    boolean _equals_4 = _source.equals("http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot");
                    if (_equals_4) {
                      _builder.append("-- ");
                      EMap<String, String> constraints = a.getDetails();
                      _builder.newLineIfNotEmpty();
                      _builder.append("-- ");
                      Set<String> keys = constraints.keySet();
                      _builder.newLineIfNotEmpty();
                      {
                        int _size_5 = keys.size();
                        ...
                        if (_greaterThan_4) {
                          ...
                          _builder.newLine();
                          {
                            for(final String key : keys) {
                              ...
                              _builder.append(key, "\t");
                              _builder.append(" : ");
                              String _get_1 = constraints.get(key);
                              _builder.append(_get_1, "\t");
                              _builder.newLineIfNotEmpty();
                            }
                          }
      ...
      _builder.newLineIfNotEmpty();
      {
        for(final EClass eclass_1 : eclasses) {
          _builder.append("-- ");
          List<EReference> refs = eclass_1.getEReferences();
          _builder.newLineIfNotEmpty();
          {
            int _size_6 = refs.size();
            boolean _greaterThan_5 = (_size_6 > 0);
            if (_greaterThan_5) {
              {
                for(final EReference ref : refs) {
                  _builder.append("-- ");
                  String _name_11 = eclass_1.getName();
                  EClassifier _eType_4 = ref.getEType();
                  String _name_12 = _eType_4.getName();
                  String associationName = (_name_11 + _name_12);
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_notEquals) {
                      ...
                      Integer _put = associationNames.put(associationName, Integer.valueOf(_plus));
                      _builder.append(_put, "");
                      _builder.newLineIfNotEmpty();
                      _builder.append("-- ");
                      String _associationName = associationName;
                      ...
                      _builder.append("-- ");
                      Integer _put_1 = associationNames.put(associationName, Integer.valueOf(0));
                      _builder.append(_put_1, "");
                      _builder.newLineIfNotEmpty();
                    }
                  }
                  ...
                  String _name_14 = _eType_5.getName();
                  String _lowerCase_1 = _name_14.toLowerCase();
                  String srcRoleName = (_lowerCase + _lowerCase_1);
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    if (_notEquals_1) {
                      ...
                      int _plus_2 = ((_get_6).intValue() + 1);
                      Integer _put_2 = roleNames.put(srcRoleName, Integer.valueOf(_plus_2));
                      _builder.append(_put_2, "");
                      _builder.newLineIfNotEmpty();
                      _builder.append("-- ");
                      String _srcRoleName = srcRoleName;
                      Integer _get_7 = roleNames.get(srcRoleName);
                      String _plus_3 = srcRoleName = (_srcRoleName + _get_7);
                      _builder.append(_plus_3, "");
                      _builder.newLineIfNotEmpty();
                    } else {
                      _builder.append("-- ");
                      Integer _put_3 = roleNames.put(srcRoleName, Integer.valueOf(0));
                      _builder.append(_put_3, "");
                      _builder.newLineIfNotEmpty();
                    }
                  }
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    ...
                    boolean _notEquals_2 = (!Objects.equal(_get_8, null));
                    if (_notEquals_2) {
                      _builder.append("-- ");
                      Integer _get_9 = roleNames.get(tarRoleName);
                      int _plus_4 = ((_get_9).intValue() + 1);
                      Integer _put_4 = roleNames.put(tarRoleName, Integer.valueOf(_plus_4));
                      _builder.append(_put_4, "");
                      _builder.newLineIfNotEmpty();
                      _builder.append("-- ");
                      String _tarRoleName = tarRoleName;
                      Integer _get_10 = roleNames.get(tarRoleName);
                      String _plus_5 = tarRoleName = (_tarRoleName + _get_10);
                      _builder.append(_plus_5, "");
                      _builder.newLineIfNotEmpty();
                    } else {
                      _builder.append("-- ");
                      Integer _put_5 = roleNames.put(tarRoleName, Integer.valueOf(0));
                  ...
                  }
                  {
                    ...
                    boolean _equals_5 = (_isContainer == false);
                    if (_equals_5) {
                  ...
                  {
                    boolean _and = false;
                    boolean _isContainer_1 = ref.isContainer();
                    boolean _equals_6 = (_isContainer_1 == true);
                    if (!_equals_6) {
                      _and = false;
                    } else {
                      EClassifier _eType_6 = ref.getEType();
                      String _name_15 = _eType_6.getName();
                      String _name_16 = eclass_1.getName();
                      boolean _equals_7 = _name_15.equals(_name_16);
                      boolean _not = (!_equals_7);
                      _and = _not;
                    }
                    if (_and) {
                  ...
                  _builder.append(srcRoleName, "\t");
                  _builder.newLineIfNotEmpty();
                  {
                    boolean _and_1 = false;
                    int _lowerBound = ref.getLowerBound();
                    boolean _equals_8 = (_lowerBound == 0);
                    if (!_equals_8) {
                      _and_1 = false;
                    } else {
                    ...
                    if (_and_1) {
                      ...
                      String _name_18 = _eType_7.getName();
                      _builder.append(_name_18, "");
                      _builder.append("[*] role ");
                      _builder.append(tarRoleName, "");
                      _builder.newLineIfNotEmpty();
                    } else {
                      ...
                      if (_equals_10) {
                        ...
                        String _name_19 = _eType_8.getName();
                        _builder.append(_name_19, "");
                        _builder.append("[");
                        int _lowerBound_1 = ref.getLowerBound();
                        ...
                        boolean _notEquals_3 = (_lowerBound_2 != _upperBound_2);
                        if (_notEquals_3) {
                          EClassifier _eType_9 = ref.getEType();
                          String _name_20 = _eType_9.getName();
                          _builder.append(_name_20, "");
                          _builder.append("[");
                          ...
                          boolean _equals_11 = (_lowerBound_4 == _upperBound_4);
                          if (_equals_11) {
                            EClassifier _eType_10 = ref.getEType();
