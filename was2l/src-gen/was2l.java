...
public class was2l extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:src
  		//REFERENCES COMPILES	753
ObSelectionStrategy refSelection753 = null;
if (hmObjects.get("dep") != null) {
refSelection753 = new SpecificObjectSelection(packages, model, hmObjects.get("dep"), "src");
} else {
	if (hmList.get("dep") != null) {
	refSelection753 = new SpecificObjectSelection(packages, model, hmList.get("dep"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection753);
//NAME:tar
  		//REFERENCES COMPILES	754
ObSelectionStrategy refSelection754 = null;
if (hmObjects.get("dep") != null) {
refSelection754 = new SpecificObjectSelection(packages, model, hmObjects.get("dep"), "tar");
} else {
	if (hmList.get("dep") != null) {
	refSelection754 = new SpecificObjectSelection(packages, model, hmList.get("dep"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection754);
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@3fca02e9 (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/was2l/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/was2l/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/was2l/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/was2l/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/was2l/data/out/was2l.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> ldep2403 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (ldep2403 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ldep2403) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel2404 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel2404 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel2404) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2405 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l2405 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2405) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2406 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l2406 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2406) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/was2l/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2l/data/out/", "C:/eclipse/runtime-EclipseApplication/was2l/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2l/data/model/", "was2l", "C:/eclipse/runtime-EclipseApplication/was2l", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2l/data/out/", "C:/eclipse/runtime-EclipseApplication/was2l/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2l/data/model/", "was2l", "C:/eclipse/runtime-EclipseApplication/was2l", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
