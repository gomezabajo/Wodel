...
public class was2i extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:src
  		//REFERENCES COMPILES	624
ObSelectionStrategy refSelection624 = null;
if (hmObjects.get("ag") != null) {
refSelection624 = new SpecificObjectSelection(packages, model, hmObjects.get("ag"), "src");
} else {
	if (hmList.get("ag") != null) {
	refSelection624 = new SpecificObjectSelection(packages, model, hmList.get("ag"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection624);
//NAME:tar
  		//REFERENCES COMPILES	625
ObSelectionStrategy refSelection625 = null;
if (hmObjects.get("ag") != null) {
refSelection625 = new SpecificObjectSelection(packages, model, hmObjects.get("ag"), "tar");
} else {
	if (hmList.get("ag") != null) {
	refSelection625 = new SpecificObjectSelection(packages, model, hmList.get("ag"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection625);
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@43116127 (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/was2i/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/was2i/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/was2i/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/was2i/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/was2i/data/out/was2i.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lag1998 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lag1998 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lag1998) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel1999 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel1999 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel1999) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2000 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l2000 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2000) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2001 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l2001 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2001) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/was2i/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2i/data/out/", "C:/eclipse/runtime-EclipseApplication/was2i/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2i/data/model/", "was2i", "C:/eclipse/runtime-EclipseApplication/was2i", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2i/data/out/", "C:/eclipse/runtime-EclipseApplication/was2i/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2i/data/model/", "was2i", "C:/eclipse/runtime-EclipseApplication/was2i", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
