 ...
 * <ul>
 *   <li>{@link modelgraph.impl.BooleanAttributeImpl#isNegation <em>Negation</em>}</li>
 *   <li>{@link modelgraph.impl.BooleanAttributeImpl#getAtt <em>Att</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanAttributeImpl extends ItemImpl implements BooleanAttribute {
	...
	protected EClass eStaticClass() {
		return ModelgraphPackage.Literals.BOOLEAN_ATTRIBUTE;
	}
	...
	public void setNegation(boolean newNegation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgraphPackage.BOOLEAN_ATTRIBUTE__NEGATION, oldNegation, negation));
	}
	...
	public EAttribute getAtt() {
		if (att != null && att.eIsProxy()) {
			...
			if (att != oldAtt) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelgraphPackage.BOOLEAN_ATTRIBUTE__ATT, oldAtt, att));
			}
		}
		return att;
	}
	...
	public void setAtt(EAttribute newAtt) {
		...
		att = newAtt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgraphPackage.BOOLEAN_ATTRIBUTE__ATT, oldAtt, att));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelgraphPackage.BOOLEAN_ATTRIBUTE__NEGATION:
				return isNegation();
			case ModelgraphPackage.BOOLEAN_ATTRIBUTE__ATT:
