...
public class CloneObjectMutatorImpl extends MutatorImpl implements CloneObjectMutator {
	...
	public void setContents(boolean newContents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__CONTENTS, oldContents, contents));
	}
	...
	public NotificationChain basicSetObject(ObSelectionStrategy newObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__OBJECT, oldObject, newObject);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject) object).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__OBJECT, null, msgs);
			if (newObject != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__OBJECT, newObject, newObject));
	}
	...
	public NotificationChain basicSetContainer(ObSelectionStrategy newContainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__CONTAINER, oldContainer, newContainer);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newContainer != container) {
			...
			if (container != null)
				msgs = ((InternalEObject) container).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__CONTAINER, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__CONTAINER, newContainer, newContainer));
	}
			...
			if (refType != oldRefType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__REF_TYPE, oldRefType, refType));
			}
		}
		return refType;
	}
	...
	public EList<AttributeSet> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<AttributeSet>(AttributeSet.class, this,
					MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public EList<ReferenceSet> getReferences() {
		if (references == null) {
			references = new EObjectContainmentEList<ReferenceSet>(ReferenceSet.class, this,
					MutatorenvironmentPackage.CLONE_OBJECT_MUTATOR__REFERENCES);
		}
		return references;
	}
