...
public class rsv extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//METHOD NAME:mutation1
	...
	if (objectSelection != null) {
		...
		//NAME:value
		atts.add(new RandomConfigurationStrategy(ModelManager.getAttribute("value", objectSelection.getObject()), "value")
		);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/workspace/rsv/data/model/Asple.ecore";
	    
	    String modelURI = "C:/eclipse/workspace/rsv/data/model/";
	    String modelsURI = "C:/eclipse/workspace/rsv/data/out/";
	    //String resourcesURI = "C:/eclipse/workspace/rsv/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/rsv/data/out/rsv.model").toFileString());
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/rsv/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/rsv/data/out/", "C:/eclipse/workspace/rsv/data/model/Asple.ecore", "C:/eclipse/workspace/rsv/data/model/", "rsv", "C:/eclipse/workspace/rsv", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/rsv/data/out/", "C:/eclipse/workspace/rsv/data/model/Asple.ecore", "C:/eclipse/workspace/rsv/data/model/", "rsv", "C:/eclipse/workspace/rsv", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
