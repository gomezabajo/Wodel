 ...
 * generated by Xtext
 */
grammar InternalConfigureOptions;
...
{ before(grammarAccess.getConfigurationAccess().getMetamodelEStringParserRuleCall_2_0()); }
	ruleEString{ after(grammarAccess.getConfigurationAccess().getMetamodelEStringParserRuleCall_2_0()); }
)
...
{ before(grammarAccess.getConfigurationAccess().getOptionsOptionParserRuleCall_3_0_0()); }
	ruleOption{ after(grammarAccess.getConfigurationAccess().getOptionsOptionParserRuleCall_3_0_0()); }
)
...
{ before(grammarAccess.getConfigurationAccess().getOptionsOptionParserRuleCall_3_1_0()); }
	ruleOption{ after(grammarAccess.getConfigurationAccess().getOptionsOptionParserRuleCall_3_1_0()); }
)
...
{ before(grammarAccess.getOptionAccess().getTypeEClassEStringParserRuleCall_2_0_1()); }
	ruleEString{ after(grammarAccess.getOptionAccess().getTypeEClassEStringParserRuleCall_2_0_1()); }
)
...
{ before(grammarAccess.getOptionAccess().getObjectEObjectEStringParserRuleCall_3_1_0_1()); }
	ruleEString{ after(grammarAccess.getOptionAccess().getObjectEObjectEStringParserRuleCall_3_1_0_1()); }
)
...
{ before(grammarAccess.getOptionAccess().getValidTextParserRuleCall_5_0()); }
	ruleText{ after(grammarAccess.getOptionAccess().getValidTextParserRuleCall_5_0()); }
)
...
{ before(grammarAccess.getOptionAccess().getInvalidTextParserRuleCall_7_0()); }
	ruleText{ after(grammarAccess.getOptionAccess().getInvalidTextParserRuleCall_7_0()); }
)
...
{ before(grammarAccess.getTextAccess().getWordsWordParserRuleCall_1_0_0()); }
	ruleWord{ after(grammarAccess.getTextAccess().getWordsWordParserRuleCall_1_0_0()); }
)
...
{ before(grammarAccess.getTextAccess().getWordsWordParserRuleCall_1_1_0()); }
	ruleWord{ after(grammarAccess.getTextAccess().getWordsWordParserRuleCall_1_1_0()); }
)
...
{ before(grammarAccess.getVariableAccess().getTypeVariableTypeEnumRuleCall_1_0()); }
	ruleVariableType{ after(grammarAccess.getVariableAccess().getTypeVariableTypeEnumRuleCall_1_0()); }
)
