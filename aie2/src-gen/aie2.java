...
public class aie2 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation1
	...
	//
	//true
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "If");
	...
	//REFERENCE: 
	((ReferenceEvaluation) exp0.first).name = "else";
...
//METHOD NAME:mutation2
	...
	// REMOVE OBJECT mutation2
		...
		SpecificReferenceSelection referenceSelection = null;
		//
		if (hmObjects.get("if2") != null) {
			containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("if2"));
			   			} else {
			return mutations;
		}
		if (hmObjects.get("if2") != null) {
			referenceSelection = new SpecificReferenceSelection(packages, model, "else", hmObjects.get("if2"));
				   			} else {
			return mutations;
		}
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Else", referenceSelection, containerSelection);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/aie2/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/aie2/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/aie2/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/aie2/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/aie2/data/out/aie2.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lif242 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lif242 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lif242) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("if2", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> l43 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/aie2/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/aie2/data/out/", "C:/eclipse/runtime-EclipseApplication/aie2/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/aie2/data/model/", "aie2", "C:/eclipse/runtime-EclipseApplication/aie2", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/aie2/data/out/", "C:/eclipse/runtime-EclipseApplication/aie2/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/aie2/data/model/", "aie2", "C:/eclipse/runtime-EclipseApplication/aie2", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
