...
public class mat extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/mat/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/mat/data/model/";
		String modelsURI = "C:/eclipse/workspace/mat/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/mat/data/out/mat.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l260 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l260 != null) {
							int k = 0;
							for (Mutator mut : l260) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/mat/data/out/",
					"C:/eclipse/workspace/mat/data/model/UMLClassDiagram.ecore", "C:/eclipse/workspace/mat/data/model/",
					"mat.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/mat/data/out/",
					"C:/eclipse/workspace/mat/data/model/UMLClassDiagram.ecore", "C:/eclipse/workspace/mat/data/model/",
					"mat.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
