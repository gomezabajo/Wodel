...
public class ConstraintImpl extends MinimalEObjectImpl.Container implements Constraint {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.CONSTRAINT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EClass newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.CONSTRAINT__TYPE, oldType,
					type));
	}
	...
	public EList<InvariantCS> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<InvariantCS>(InvariantCS.class, this,
					MutatorenvironmentPackage.CONSTRAINT__EXPRESSIONS);
		}
		return expressions;
	}
