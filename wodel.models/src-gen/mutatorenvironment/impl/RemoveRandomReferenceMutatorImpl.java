 ...
 * @generated
 */
public class RemoveRandomReferenceMutatorImpl extends RemoveReferenceMutatorImpl
		implements RemoveRandomReferenceMutator {
	/**
			...
			if (refType != oldRefType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.REMOVE_RANDOM_REFERENCE_MUTATOR__REF_TYPE, oldRefType, refType));
			}
		}
		return refType;
	}
