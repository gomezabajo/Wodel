...
@Singleton
public class AspleGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DeclarationElements extends AbstractParserRuleElementFinder {
		...
		//Declaration:
		//	{Declaration} ref?="ref"? mode=Mode? identifiers+=Identifier ("," identifiers+=Identifier)*;
		@Override public ParserRule getRule() { return rule; }
	...
	public class AssignmentElements extends AbstractParserRuleElementFinder {
		...
		//Assignment:
		//	var=[Identifier] "=" value=Expression ";";
		@Override public ParserRule getRule() { return rule; }
	...
	public class ConditionalElements extends AbstractParserRuleElementFinder {
		...
		//Conditional:
		//	{Conditional} "if" "(" expression=Expression ")" "{" if+=Statement* "}" ("else" "{" else+=Statement* "}")?;
		@Override public ParserRule getRule() { return rule; }
	...
	public class LoopElements extends AbstractParserRuleElementFinder {
		...
		//Loop:
		//	{Loop} "while" "(" expression=Expression ")" "{" statements+=Statement* "}" | "repeat" "{" statements+=Statement* "}"
		...
		//{Loop} "while" "(" expression=Expression ")" "{" statements+=Statement* "}"
	...
	public class TransputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Transput");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Transput:
		//	{Transput} "input" var=[Identifier] "output" expression=Expression;
		@Override public ParserRule getRule() { return rule; }
	...
	public class BinaryOperatorElements extends AbstractParserRuleElementFinder {
		...
		//BinaryOperator:
		//	{BinaryOperator} left=Primary operator=("+" | "-" | "*" | "/" | "%" | "==" | "!=" | ">" | "<") right=Expression;
		@Override public ParserRule getRule() { return rule; }
