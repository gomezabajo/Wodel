...
import mutator.designerStandalone.designerStandalone;
import org.eclipse.core.runtime.NullProgressMonitor;
import wodel.utils.manager.MutatorStandaloneAPI;
import wodel.utils.manager.MutatorUtils;

public class designerStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
		...
		String ecoreURI = "C:/eclipse/runtime-New_configuration55/designer/data/model/LogicCircuit.ecore";
		...
		MutatorUtils mutdesigner = new designerStandalone();
		mutdesigner.execute(maxAttempts, numMutants, registry, metrics, debugMetrics, packages, registeredPackages,
		...
		System.out.println("designer Mutant generation process finished.");
	}
}
