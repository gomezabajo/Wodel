 ...
 * <ul>
 *   <li>{@link modelgraph.impl.ItemImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ItemImpl extends MinimalEObjectImpl.Container implements Item {
	...
	protected EClass eStaticClass() {
		return ModelgraphPackage.Literals.ITEM;
	}
		...
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelgraphPackage.ITEM__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(EClass newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgraphPackage.ITEM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelgraphPackage.ITEM__NAME:
