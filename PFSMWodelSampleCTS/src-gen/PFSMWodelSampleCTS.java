...
public class PFSMWodelSampleCTS extends manager.MutatorUtils implements manager.IMutatorExecutor {
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/model/PFSM.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/resources/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/out/PFSMWodelSampleCTS.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l18 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/out/", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/model/PFSM.ecore", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/model/", "PFSMWodelSampleCTS", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/out/", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/model/PFSM.ecore", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS/data/model/", "PFSMWodelSampleCTS", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCTS", hashmapMutVersions);   			
   		}
   	}
}
