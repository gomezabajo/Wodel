...
public class AccVarCSImpl extends MinimalEObjectImpl.Container implements AccVarCS {
	...
	public void setAccVarName(String newAccVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.ACC_VAR_CS__ACC_VAR_NAME,
					oldAccVarName, accVarName));
	}
	...
	public NotificationChain basicSetAccType(PathNameCS newAccType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniOCLPackage.ACC_VAR_CS__ACC_TYPE, oldAccType, newAccType);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAccType(PathNameCS newAccType) {
		if (newAccType != accType) {
			...
			if (accType != null)
				msgs = ((InternalEObject) accType).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.ACC_VAR_CS__ACC_TYPE, null, msgs);
			if (newAccType != null)
				msgs = ((InternalEObject) newAccType).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.ACC_VAR_CS__ACC_TYPE, null, msgs);
			msgs = basicSetAccType(newAccType, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.ACC_VAR_CS__ACC_TYPE, newAccType,
					newAccType));
	}
	...
	public NotificationChain basicSetAccInitExp(ExpCS newAccInitExp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniOCLPackage.ACC_VAR_CS__ACC_INIT_EXP, oldAccInitExp, newAccInitExp);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setAccInitExp(ExpCS newAccInitExp) {
		if (newAccInitExp != accInitExp) {
			NotificationChain msgs = null;
			if (accInitExp != null)
				msgs = ((InternalEObject) accInitExp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.ACC_VAR_CS__ACC_INIT_EXP, null, msgs);
			if (newAccInitExp != null)
				msgs = ((InternalEObject) newAccInitExp).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - MiniOCLPackage.ACC_VAR_CS__ACC_INIT_EXP, null, msgs);
			msgs = basicSetAccInitExp(newAccInitExp, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.ACC_VAR_CS__ACC_INIT_EXP,
					newAccInitExp, newAccInitExp));
	}
