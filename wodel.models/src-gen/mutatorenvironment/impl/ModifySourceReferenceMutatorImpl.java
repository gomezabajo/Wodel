...
public class ModifySourceReferenceMutatorImpl extends MutatorImpl implements ModifySourceReferenceMutator {
			...
			if (refType != oldRefType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.MODIFY_SOURCE_REFERENCE_MUTATOR__REF_TYPE, oldRefType, refType));
			}
		}
		return refType;
	}
	...
	public NotificationChain basicSetSource(ObSelectionStrategy newSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_SOURCE_REFERENCE_MUTATOR__SOURCE, oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.MODIFY_SOURCE_REFERENCE_MUTATOR__SOURCE,
						null, msgs);
			if (newSource != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_SOURCE_REFERENCE_MUTATOR__SOURCE, newSource, newSource));
	}
	...
	public NotificationChain basicSetNewSource(ObSelectionStrategy newNewSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_SOURCE_REFERENCE_MUTATOR__NEW_SOURCE, oldNewSource, newNewSource);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setNewSource(ObSelectionStrategy newNewSource) {
		if (newNewSource != newSource) {
			NotificationChain msgs = null;
			if (newSource != null)
				msgs = ((InternalEObject) newSource).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.MODIFY_SOURCE_REFERENCE_MUTATOR__NEW_SOURCE,
						null, msgs);
			if (newNewSource != null)
				msgs = ((InternalEObject) newNewSource).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.MODIFY_SOURCE_REFERENCE_MUTATOR__NEW_SOURCE,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MODIFY_SOURCE_REFERENCE_MUTATOR__NEW_SOURCE, newNewSource, newNewSource));
	}
