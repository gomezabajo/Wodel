  ...
  public CharSequence apply(final Mutator mt, final MutatorEnvironment e, final Block b, final String methodName, final int[] nMutation, final int[] nMethodCall, final int[] nRegistryMutation, final int[] nRegistryMethodCall, final boolean executeMutation, final boolean last, final String className, final URI fileURI, final Program program, final IProject project, final boolean standalone) {
    ...
    _builder.newLine();
    {
      if ((mt instanceof ModifyTargetReferenceMutator)) {
        ...
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("String sourceFragment =");
        _builder.newLine();
        _builder.append("\t\t\t    ");
        _builder.append("EcoreUtil.getURI(");
        _builder.newLine();
        _builder.append("\t\t\t        ");
        _builder.append("sourceObject)");
        _builder.newLine();
        _builder.append("\t\t\t        ");
        ...
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("EObject source =");
        _builder.newLine();
        _builder.append("\t\t\t    ");
        _builder.append("sourceModel.getEObject(");
        _builder.newLine();
        _builder.append("\t\t\t        ");
        _builder.append("sourceFragment);");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.newLine();
        _builder.append("\t\t\t");
        ...
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("String targetFragment =");
        _builder.newLine();
        _builder.append("\t\t\t    ");
        _builder.append("EcoreUtil.getURI(");
        _builder.newLine();
        ...
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("EObject target =");
        _builder.newLine();
        _builder.append("\t\t\t    ");
        _builder.append("sourceModel.getEObject(");
        _builder.newLine();
        _builder.append("\t\t\t        ");
        _builder.append("targetFragment);");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.newLine();
        _builder.append("\t\t\t");
        ...
        _builder.append("}");
        _builder.newLine();
        _builder.append("if (source.eResource() != sourceModel) {");
        _builder.newLine();
        _builder.append("    ");
        _builder.append("throw new IllegalStateException(");
        _builder.newLine();
        _builder.append("        ");
        _builder.append("\"mst source does not belong to sourceModel\");");
        _builder.newLine();
        _builder.append("}");
        _builder.newLine();
        _builder.newLine();
        _builder.append("if (target.eResource() != sourceModel) {");
        _builder.newLine();
        _builder.append("    ");
        _builder.append("throw new IllegalStateException(");
        _builder.newLine();
        _builder.append("        ");
        _builder.append("\"mst target does not belong to sourceModel\");");
        _builder.newLine();
        _builder.append("}");
        _builder.newLine();
        ...
        _builder.newLine();
        {
          if ((executeMutation == true)) {
            ...
            _builder.append("\t");
            _builder.append("\t            ");
            _builder.append("EReference sourceReference =");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t    \t\t    ");
            _builder.append("(EReference) source");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t    \t\t        ");
            ...
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t    \t\t");
            _builder.append("EObject oldActualTarget =");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t    \t\t    ");
            _builder.append("sourceReference == null");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t    \t\t        ");
            _builder.append("? null");
            ...
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t    \t\t        ");
            _builder.append(": (EObject) source.eGet(");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t    \t\t            ");
            _builder.append("sourceReference);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t\t");
            ...
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t        ");
            _builder.append("EObject newActualTarget =");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t        \t    ");
            _builder.append("sourceReference == null");
            ...
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t        \t");
            _builder.append("boolean actualChanged =");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t        \t    ");
            _builder.append("oldActualTarget");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t            \t\t\t\t\t\t        \t        ");
            _builder.append("!= newActualTarget;");
            _builder.newLine();
            _builder.append("if (mutated == null");
            _builder.newLine();
            _builder.append("        ");
            _builder.append("|| !actualChanged) {");
            _builder.newLine();
            _builder.newLine();
            _builder.append("    ");
            _builder.append("continue;");
            ...
            _builder.append("(mut, hmMutator, seed, srcSelection2.getModel(), clue, mutPaths, packages);");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("\t\t\t");
