...
/**
 * This is the item provider adapter for a {@link configureoptions.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider extends WordItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigureoptionsPackage.Literals.VARIABLE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		VariableType labelValue = ((Variable)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Variable.class)) {
			case ConfigureoptionsPackage.VARIABLE__TYPE:
