...
public class wco6a extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//METHOD NAME:mutation4
	...
	if (objectSelection != null) {
		...
		//NAME:operator
		atts.add((ModelManager.getAttribute("operator", (objectSelection != null) ? objectSelection.getObject() : null) instanceof EObject) ? new ListConfigurationStrategy((EObject) ModelManager.getAttribute("operator", (objectSelection != null) ? objectSelection.getObject() : null), "[or]", "operator") : null
		);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/wco6a/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/wco6a/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/wco6a/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/wco6a/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/wco6a/data/out/wco6a.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lc21 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lc21 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lc21) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> loper22 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (loper22 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : loper22) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lop23 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/wco6a/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wco6a/data/out/", "C:/eclipse/runtime-EclipseApplication/wco6a/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wco6a/data/model/", "wco6a", "C:/eclipse/runtime-EclipseApplication/wco6a", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wco6a/data/out/", "C:/eclipse/runtime-EclipseApplication/wco6a/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wco6a/data/model/", "wco6a", "C:/eclipse/runtime-EclipseApplication/wco6a", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
