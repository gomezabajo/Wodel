 ...
 * @generated
 */
public class RemoveSpecificReferenceMutatorImpl extends RemoveReferenceMutatorImpl
		implements RemoveSpecificReferenceMutator {
	/**
			...
			if (refType != oldRefType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.REMOVE_SPECIFIC_REFERENCE_MUTATOR__REF_TYPE, oldRefType,
							refType));
			}
		}
		return refType;
	...
	public void setRefType(EReference newRefType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.REMOVE_SPECIFIC_REFERENCE_MUTATOR__REF_TYPE, oldRefType, refType));
	}
	...
	public NotificationChain basicSetContainer(ObSelectionStrategy newContainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.REMOVE_SPECIFIC_REFERENCE_MUTATOR__CONTAINER, oldContainer, newContainer);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContainer != container) {
			...
			if (container != null)
				msgs = ((InternalEObject) container).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.REMOVE_SPECIFIC_REFERENCE_MUTATOR__CONTAINER,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.REMOVE_SPECIFIC_REFERENCE_MUTATOR__CONTAINER, newContainer,
					newContainer));
	}
