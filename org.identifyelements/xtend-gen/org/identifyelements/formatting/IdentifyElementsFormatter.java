 ...
 * generated by Xtext
 */
package org.identifyelements.formatting;
...
public class IdentifyElementsFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private IdentifyElementsGrammarAccess _identifyElementsGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._identifyElementsGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._identifyElementsGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._identifyElementsGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._identifyElementsGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._identifyElementsGrammarAccess.getML_COMMENTRule();
