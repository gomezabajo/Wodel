...
public class testATLMRStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
		...
		try {
			packages = ModelManager.loadMetaModel(ecoreURI, testATLMRStandaloneAPI.class);
		} catch (Exception e) {
		}
		...
		System.out.println("testATLMR Mutant generation process finished.");
	}
}
