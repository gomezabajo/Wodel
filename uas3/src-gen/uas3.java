...
public class uas3 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:src
  		//REFERENCES COMPILES	199
RandomTypeSelection refRts199 = new RandomTypeSelection(packages, model, "Class");
EObject refObject199 = refRts199.getObject();
ObSelectionStrategy refSelection199 = null;
if (refObject199 != null) {
refSelection199 = 
	new SpecificObjectSelection(packages, model, refObject199);
}
   		refs.put("src", refSelection199);
//NAME:tar
  		//REFERENCES COMPILES	200
RandomTypeSelection refRts200 = new RandomTypeSelection(packages, model, "Class");
EObject refObject200 = refRts200.getObject();
ObSelectionStrategy refSelection200 = null;
if (refObject200 != null) {
refSelection200 = 
	new SpecificObjectSelection(packages, model, refObject200);
}
   		refs.put("tar", refSelection200);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/uas3/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/uas3/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/uas3/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/uas3/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/uas3/data/out/uas3.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l643 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (l643 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l643) {
	   	   	   					if (mut != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/uas3/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/uas3/data/out/", "C:/eclipse/runtime-EclipseApplication/uas3/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/uas3/data/model/", "uas3", "C:/eclipse/runtime-EclipseApplication/uas3", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/uas3/data/out/", "C:/eclipse/runtime-EclipseApplication/uas3/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/uas3/data/model/", "uas3", "C:/eclipse/runtime-EclipseApplication/uas3", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
