...
/**
 * This is the item provider adapter for a {@link mutatorenvironment.Load} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoadItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Load_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Load_file_feature", "_UI_Load_type"),
				 MutatorenvironmentPackage.Literals.LOAD__FILE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Load)object).getFile();
