...
/**
 * This is the item provider adapter for a {@link mutatorenvironment.ReferenceSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceSetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceSet_reference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceSet_reference_feature", "_UI_ReferenceSet_type"),
				 MutatorenvironmentPackage.Literals.REFERENCE_SET__REFERENCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRefTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceSet_refType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceSet_refType_feature", "_UI_ReferenceSet_type"),
				 MutatorenvironmentPackage.Literals.REFERENCE_SET__REF_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MutatorenvironmentPackage.Literals.REFERENCE_SET__OBJECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MutatorenvironmentPackage.Literals.REFERENCE_SET__OBJECT,
