...
public class MutatorenvironmentFactoryImpl extends EFactoryImpl implements MutatorenvironmentFactory {
	...
	public static MutatorenvironmentFactory init() {
		try {
			MutatorenvironmentFactory theMutatorenvironmentFactory = (MutatorenvironmentFactory) EPackage.Registry.INSTANCE
					.getEFactory(MutatorenvironmentPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case MutatorenvironmentPackage.MUTATOR_ENVIRONMENT:
			return createMutatorEnvironment();
