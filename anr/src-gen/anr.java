...
public class anr extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
refSelection3 = new SpecificObjectSelection(packages, model, hmObjects.get("t"));
} else {
	if (hmList.get("t") != null) {
	refSelection3 = new SpecificObjectSelection(packages, model, hmList.get("t"));
	}
	else {
		return mutations;
	}
}
   		refs.put("type", refSelection3);
//NAME:parameters
  		//REFERENCES COMPILES	4
ObSelectionStrategy refSelection4 = null;
if (hmObjects.get("p") != null) {
refSelection4 = new SpecificObjectSelection(packages, model, hmObjects.get("p"));
} else {
	if (hmList.get("p") != null) {
	refSelection4 = new SpecificObjectSelection(packages, model, hmList.get("p"));
	}
	else {
		return mutations;
	}
}
   		refs.put("parameters", refSelection4);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    //String resourcesURI = "C:/eclipse/workspace/anr/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/anr/data/out/anr.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt40 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			...
	   	   	   			ArrayList<Mutator> lsetp41 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lsetp41 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lsetp41) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lp42 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/anr/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/anr/data/out/", "C:/eclipse/workspace/anr/data/model/SecurityPolicy.ecore", "C:/eclipse/workspace/anr/data/model/", "anr", "C:/eclipse/workspace/anr", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/anr/data/out/", "C:/eclipse/workspace/anr/data/model/SecurityPolicy.ecore", "C:/eclipse/workspace/anr/data/model/", "anr", "C:/eclipse/workspace/anr", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
