...
public abstract class ObjectEmitterImpl extends MinimalEObjectImpl.Container implements ObjectEmitter {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.OBJECT_EMITTER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EClass newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.OBJECT_EMITTER__TYPE,
					oldType, type));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.OBJECT_EMITTER__NAME,
					oldName, name));
	}
	...
	public EList<EClass> getTypes() {
		if (types == null) {
			types = new EObjectResolvingEList<EClass>(EClass.class, this,
					MutatorenvironmentPackage.OBJECT_EMITTER__TYPES);
		}
		return types;
	}
