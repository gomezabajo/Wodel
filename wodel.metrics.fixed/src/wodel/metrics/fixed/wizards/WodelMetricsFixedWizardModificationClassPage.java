...
public class WodelMetricsFixedWizardModificationClassPage extends WizardPage {
	...
	public WodelMetricsFixedWizardModificationClassPage(ISelection selection, ArrayList<EPackage> mutatorPackages, Resource model, ArrayList<EPackage> packages, String className) {
