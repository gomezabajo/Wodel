...
public abstract class ObSelectionStrategyImpl extends ObjectEmitterImpl implements ObSelectionStrategy {
			...
			if (refType != oldRefType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.OB_SELECTION_STRATEGY__REF_TYPE, oldRefType, refType));
			}
		}
		return refType;
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.OB_SELECTION_STRATEGY__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.OB_SELECTION_STRATEGY__EXPRESSION, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.OB_SELECTION_STRATEGY__EXPRESSION, newExpression, newExpression));
	}
	...
	public void setResource(String newResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.OB_SELECTION_STRATEGY__RESOURCE, oldResource, resource));
	}
	...
	public EReference getRefRefType() {
		if (refRefType != null && refRefType.eIsProxy()) {
			...
			if (refRefType != oldRefRefType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.OB_SELECTION_STRATEGY__REF_REF_TYPE, oldRefRefType, refRefType));
			}
		}
		return refRefType;
	}
	...
	public EReference getRefRefRefType() {
		if (refRefRefType != null && refRefRefType.eIsProxy()) {
			...
			if (refRefRefType != oldRefRefRefType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.OB_SELECTION_STRATEGY__REF_REF_REF_TYPE, oldRefRefRefType,
							refRefRefType));
			}
		}
