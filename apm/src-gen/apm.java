...
public class apm extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation1
	...
	//REFERENCE: 
	((ReferenceEvaluation) exp0.first).name = "messages";
...
//SELECT OBJECT mutation2
	...
	if (hmObjects.get("p1") != null) {
		containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("p1"));
		   			} else {
		   				if (hmList.get("p1") != null) {
		   					containerSelection = new SpecificObjectSelection(packages, model, hmList.get("p1"));
		   				}
		   				else {
			return mutations;
		}
	...
	if (hmObjects.get("p1") != null) {
		referenceSelection = new SpecificReferenceSelection(packages, model, "messages", hmObjects.get("p1"));
			   			} else {
			   				return mutations;
	}
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "OnMessage", referenceSelection, containerSelection);
...
//METHOD NAME:mutation3
	...
	// REMOVE OBJECT mutation3
		...
		//
		ObSelectionStrategy objectSelection = null;
		if (hmObjects.get("m1") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("m1"));
	   			} else {
			return mutations;
		}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/apm/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/apm/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/apm/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/apm/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/apm/data/out/apm.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lp162 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lp162 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lp162) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lm163 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lm163 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lm163) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("m1", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> l64 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/apm/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/apm/data/out/", "C:/eclipse/runtime-EclipseApplication/apm/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/apm/data/model/", "apm", "C:/eclipse/runtime-EclipseApplication/apm", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/apm/data/out/", "C:/eclipse/runtime-EclipseApplication/apm/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/apm/data/model/", "apm", "C:/eclipse/runtime-EclipseApplication/apm", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
