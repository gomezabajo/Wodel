...
public class WodelTest4JavaStandaloneAPILauncher {
	public static void createMutants(String inputFolder, String outputFolder)
		...
		String inputWodelFolder = "C:/eclipse/runtime-New_configuration53/WodelTest4Java/data/model";
		...
		File projectFolder = new File(
				testJavaAPStandaloneAPI.class.getProtectionDomain().getCodeSource().getLocation().getPath());
		List<String> mutatorList = MutatorUtils.getMutators(projectFolder.listFiles());
		String outputWodelFolder = testJavaAPStandaloneAPI.class.getProtectionDomain().getCodeSource().getLocation()
				.getPath() + "data/out";
