...
public class was2c extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/was2c/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/was2c/data/model/";
		String modelsURI = "C:/eclipse/workspace/was2c/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/was2c/data/out/was2c.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l332 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l332 != null) {
							int k = 0;
							for (Mutator mut : l332) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2c/data/out/",
					"C:/eclipse/workspace/was2c/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2c/data/model/", "was2c.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2c/data/out/",
					"C:/eclipse/workspace/was2c/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2c/data/model/", "was2c.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
