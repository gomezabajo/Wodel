...
public class SecurityPoliciesWodelSamplePPR extends manager.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation2
	...
	EObject srcObjExp0_0 = hmObjects.get("p1");
...
//METHOD NAME:mutation4
	...
	// REMOVE OBJECT mutation4
		...
		if (hmObjects.get("p1") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("p1"), referenceSelection, containerSelection);
	   			} else {
			return mutations;
		}
	...
	//NAME:parameters
	   			if (objectSelection != null && objectSelection.getObject() != null) {
	   				if (hmObjects.get("p2") != null) {
		   					refs.put("parameters", new SpecificReferenceConfigurationStrategy(model, objectSelection.getObject(), hmObjects.get("p2"), "parameters"));
			   			} else {
							return mutations;
						}
	   			}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/model/SecurityPolicy.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/resources/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/out/SecurityPoliciesWodelSamplePPR.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lp113 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lp113 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lp113) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lp214 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lp214 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lp214) {
	   	   	   					if (mut != null) {
	   	   	   						EObject mutated = (EObject) mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lr15 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (lr15 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lr15) {
	   	   	   					if (mut != null) {
	   	   	   						EObject mutated = (EObject) mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l17 = mutation5(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 5
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/out/", "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/model/SecurityPolicy.ecore", "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/model/", "SecurityPoliciesWodelSamplePPR", "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/out/", "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/model/SecurityPolicy.ecore", "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR/data/model/", "SecurityPoliciesWodelSamplePPR", "C:/eclipse/runtime-EclipseApplication/SecurityPoliciesWodelSamplePPR", hashmapMutVersions);   			
   		}
   	}
}
