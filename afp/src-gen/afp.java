...
public class afp extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		((AttributeEvaluation) exp0.first).name = "parallel";
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/afp/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/afp/data/model/";
		String modelsURI = "C:/eclipse/workspace/afp/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/afp/data/out/afp.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l232 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l232 != null) {
							int k = 0;
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/afp/data/out/",
					"C:/eclipse/workspace/afp/data/model/bpel.ecore", "C:/eclipse/workspace/afp/data/model/",
					"afp.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/afp/data/out/",
					"C:/eclipse/workspace/afp/data/model/bpel.ecore", "C:/eclipse/workspace/afp/data/model/",
					"afp.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
