...
public class aie2 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation2(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Else", referenceSelection,
				containerSelection);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/aie2/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/aie2/data/model/";
		String modelsURI = "C:/eclipse/workspace/aie2/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/aie2/data/out/aie2.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lif29 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lif29 != null) {
							int k = 0;
							for (Mutator mut : lif29) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l10 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (l10 != null) {
							int k = 0;
							for (Mutator mut : l10) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/aie2/data/out/",
					"C:/eclipse/workspace/aie2/data/model/bpel.ecore", "C:/eclipse/workspace/aie2/data/model/",
					"aie2.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/aie2/data/out/",
					"C:/eclipse/workspace/aie2/data/model/bpel.ecore", "C:/eclipse/workspace/aie2/data/model/",
					"aie2.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
