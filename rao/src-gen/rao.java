...
public class rao extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null) {
			...
			atts.add(new ListStringConfigurationStrategy(
					...
					"[add, subtract, multiply, divide, module]", "operator"));
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/rao/data/out/rao.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/rao/data/out/",
					"C:/eclipse/workspace/rao/data/model/Asple.ecore", "C:/eclipse/workspace/rao/data/model/",
					"rao.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/rao/data/out/",
					"C:/eclipse/workspace/rao/data/model/Asple.ecore", "C:/eclipse/workspace/rao/data/model/",
					"rao.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
