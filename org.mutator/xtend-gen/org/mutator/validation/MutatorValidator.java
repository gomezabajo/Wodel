...
import org.mutator.validation.AbstractMutatorValidator;
...
public class MutatorValidator extends AbstractMutatorValidator {
    ...
    ArrayList<EPackage> _xblockexpression = null;
    {
      ...
      try {
        ...
        if (_t instanceof MetaModelNotFoundException) {
          ...
          this.error(_string, null, MutatorValidator.INVALID_METAMODEL);
        } else {
  ...
  public void checkCreateObjectMutatorMin(final CreateObjectMutator com) {
    ...
    if (_greaterThan) {
      this.error("The min value must me lower or equal than the max value.", null, MutatorValidator.INVALID_NAME);
    }
    ...
    for (final AttributeSet attset : attributes) {
      {
        if ((attset instanceof AttributeUnset)) {
          ...
          if (_and) {
            this.error("The attribute is not unsettable and the lower bound is not 0", null, MutatorValidator.INVALID_UNSET);
          }
          boolean _isUnsettable_1 = att.isUnsettable();
          boolean _equals_1 = (_isUnsettable_1 == false);
          if (_equals_1) {
            this.error("The attribute is not unsettable", null, MutatorValidator.INVALID_UNSET);
          }
          int _lowerBound_1 = att.getLowerBound();
          boolean _notEquals_1 = (_lowerBound_1 != 0);
          if (_notEquals_1) {
            this.error("The lower bound is not 0", null, MutatorValidator.INVALID_UNSET);
          }
        }
        if ((attset instanceof AttributeSwap)) {
          ...
          if (_notEquals_2) {
            this.error("The attributes are not of the same type", null, MutatorValidator.INVALID_SWAP);
          }
        }
        if ((attset instanceof AttributeCopy)) {
          ...
          if (_notEquals_3) {
            this.error("The attributes are not of the same type", null, MutatorValidator.INVALID_COPY);
          }
        }
        if ((attset instanceof AttributeInit)) {
          ...
          if ((att_type instanceof IntegerType)) {
            ...
            if (_not) {
              this.error("The attributes are not of the same type", null, MutatorValidator.INVALID_TYPE);
            }
          }
  ...
  public void checkModifySourceReference(final ModifySourceReferenceMutator com) {
    ...
    if (_notEquals) {
      ...
      if (_notEquals_1) {
        this.warning("The lower bound of the source reference is not 0", null, MutatorValidator.WARNING_MODIFY_SOURCE);
      }
    }
  }
  ...
  public void checkAttributeSet(final AttributeSet attset) {
    if ((attset instanceof AttributeReverse)) {
      ...
      if (_not) {
        ...
        this.error(_plus, null, MutatorValidator.INVALID_REVERSE);
      }
    }
  }
}
