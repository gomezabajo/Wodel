...
public class testATLFStandalone extends MutatorUtils {
	...
	private static AppMutation registry8(Mutator mut, Map<String, EObject> hmMutator, Resource seed, Resource mutant,
		...
		refMut0.setFrom(mutator.getPrevious("variableExp"));
		refMut0.setTo(mutator.getNext("variableExp"));
	...
	private static AppMutation registry9(Mutator mut, Map<String, EObject> hmMutator, Resource seed, Resource mutant,
		...
		refMut0.getObject().add(mutator.getObject());
		refMut0.getMutantObject().add(mutator.getObject());
		refMut0.setFrom(mutator.getPrevious("arguments"));
		refMut0.setTo(mutator.getNext("arguments"));
	...
	private static AppMutation registry10(Mutator mut, Map<String, EObject> hmMutator, Resource seed, Resource mutant,
		...
		refMut0.getObject().add(mutator.getObject());
		refMut0.getMutantObject().add(mutator.getObject());
		refMut0.setFrom(mutator.getPrevious("filter"));
		refMut0.setTo(mutator.getNext("filter"));
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lp97 = mutation1(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lp97 != null) {
							for (Mutator mut : lp97) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lopce98 = mutation2(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lopce98 != null) {
							for (Mutator mut : lopce98) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lfeat99 = mutation3(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lfeat99 != null) {
							for (Mutator mut : lfeat99) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lsipe100 = mutation4(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (lsipe100 != null) {
							for (Mutator mut : lsipe100) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lconj101 = mutation5(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (lconj101 != null) {
							for (Mutator mut : lconj101) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lcall102 = mutation6(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (lcall102 != null) {
							for (Mutator mut : lcall102) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lexp103 = mutation7(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lexp103 != null) {
							for (Mutator mut : lexp103) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l104 = mutation8(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l104 != null) {
							for (Mutator mut : l104) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										String mutatorPath = mutPath + "/Output" + i + "_" + j + "_" + k[0]
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l105 = mutation9(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l105 != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l106 = mutation10(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l106 != null) {
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l107 = mutation11(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l107 != null) {
							for (Mutator mut : l107) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										String mutatorPath = mutPath + "/Output" + i + "_" + j + "_" + k[0]
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lp108 = mutation12(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lp108 != null) {
							for (Mutator mut : lp108) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lopce109 = mutation13(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (lopce109 != null) {
							for (Mutator mut : lopce109) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lfeat110 = mutation14(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (lfeat110 != null) {
							for (Mutator mut : lfeat110) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l111 = mutation15(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l111 != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, testATLFStandalone.class
					...
					testATLFStandalone.class.getProtectionDomain().getCodeSource().getLocation().getPath()
							.replace("/bin/", "/") + "data/model/",
					"testATLF.mutator", hashmapMutVersions, testATLFStandalone.class);
