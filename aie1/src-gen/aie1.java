...
public class aie1 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation2(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "ElseIf", referenceSelection,
				containerSelection);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/aie1/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/aie1/data/model/";
		String modelsURI = "C:/eclipse/workspace/aie1/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/aie1/data/out/aie1.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lif13 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lif13 != null) {
							int k = 0;
							for (Mutator mut : lif13) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/aie1/data/out/",
					"C:/eclipse/workspace/aie1/data/model/bpel.ecore", "C:/eclipse/workspace/aie1/data/model/",
					"aie1.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/aie1/data/out/",
					"C:/eclipse/workspace/aie1/data/model/bpel.ecore", "C:/eclipse/workspace/aie1/data/model/",
					"aie1.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
