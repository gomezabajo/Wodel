...
public class PathElementCSImpl extends PathCSImpl implements PathElementCS {
		...
		if (pathName != null && pathName.eIsProxy()) {
			...
			if (pathName != oldPathName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MiniOCLPackage.PATH_ELEMENT_CS__PATH_NAME,
	...
	public void setPathName(EStructuralFeature newPathName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniOCLPackage.PATH_ELEMENT_CS__PATH_NAME,
					oldPathName, pathName));
	}
