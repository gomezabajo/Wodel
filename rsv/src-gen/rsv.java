...
public class rsv extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null) {
			...
			atts.add(new RandomConfigurationStrategy(ModelManager.getAttribute("value", objectSelection.getObject()),
					"value"));
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/rsv/data/out/rsv.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/rsv/data/out/",
					"C:/eclipse/workspace/rsv/data/model/Asple.ecore", "C:/eclipse/workspace/rsv/data/model/",
					"rsv.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/rsv/data/out/",
					"C:/eclipse/workspace/rsv/data/model/Asple.ecore", "C:/eclipse/workspace/rsv/data/model/",
					"rsv.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
