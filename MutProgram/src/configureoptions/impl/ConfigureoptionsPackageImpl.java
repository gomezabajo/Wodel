 ...
 * @generated
 */
public class ConfigureoptionsPackageImpl extends EPackageImpl implements ConfigureoptionsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see configureoptions.ConfigureoptionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ConfigureoptionsPackageImpl() {
		super(eNS_URI, ConfigureoptionsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ConfigureoptionsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ConfigureoptionsPackage init() {
		if (isInited) return (ConfigureoptionsPackage)EPackage.Registry.INSTANCE.getEPackage(ConfigureoptionsPackage.eNS_URI);

		// Obtain or create and register package
		ConfigureoptionsPackageImpl theConfigureoptionsPackage = (ConfigureoptionsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ConfigureoptionsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ConfigureoptionsPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theConfigureoptionsPackage.createPackageContents();

		// Initialize created meta-data
		theConfigureoptionsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theConfigureoptionsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ConfigureoptionsPackage.eNS_URI, theConfigureoptionsPackage);
		return theConfigureoptionsPackage;
	}
	 ...
	 * @generated
	 */
	public ConfigureoptionsFactory getConfigureoptionsFactory() {
		return (ConfigureoptionsFactory)getEFactoryInstance();
	}
