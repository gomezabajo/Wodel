	...
	public NotificationChain basicSetObject(ObSelectionStrategy newObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.ATTRIBUTE_COPY__OBJECT, oldObject, newObject);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject) object).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.ATTRIBUTE_COPY__OBJECT, null, msgs);
			if (newObject != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.ATTRIBUTE_COPY__OBJECT,
					newObject, newObject));
	}
