...
public class uop2 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
ArrayList<EObject> containers = ModelManager.getParentObjects(packages, model, "Operation");
...
//NAME:type
  		//REFERENCES COMPILES	638
RandomTypeSelection refRts638 = new RandomTypeSelection(packages, model, "Class");
EObject refObject638 = refRts638.getObject();
ObSelectionStrategy refSelection638 = null;
if (refObject638 != null) {
refSelection638 = 
	new SpecificObjectSelection(packages, model, refObject638);
}
   		refs.put("type", refSelection638);
CreateObjectMutator mut = new CreateObjectMutator(model, packages, referenceSelection, containerSelection, atts, refs, "Operation");
//INC COUNTER: 0
if (mut != null) {
	mut.setId("m1");
	mutations.add(mut);
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/uop2/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/uop2/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/uop2/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/uop2/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/uop2/data/out/uop2.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2062 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (l2062 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2062) {
	   	   	   					if (mut != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/uop2/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/uop2/data/out/", "C:/eclipse/runtime-EclipseApplication/uop2/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/uop2/data/model/", "uop2", "C:/eclipse/runtime-EclipseApplication/uop2", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/uop2/data/out/", "C:/eclipse/runtime-EclipseApplication/uop2/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/uop2/data/model/", "uop2", "C:/eclipse/runtime-EclipseApplication/uop2", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
