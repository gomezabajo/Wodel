...
public class WodelMetricsFixedWizardReferencePage extends WizardPage {
	...
	public WodelMetricsFixedWizardReferencePage(ISelection selection, ArrayList<EPackage> mutatorPackages, Resource model, ArrayList<EPackage> packages, String className, String referenceName) {
