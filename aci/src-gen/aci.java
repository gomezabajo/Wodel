...
public class aci extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//METHOD NAME:mutation1
	...
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Receive");
	...
	if (objectSelection != null) {
		...
		if (attsList.get("createInstance") != null) {
			atts = attsList.get("createInstance");
		}
		else {
		...
		atts.add(new SpecificBooleanConfigurationStrategy(false)
		   		...
		   		attsList.put("createInstance", atts);
	}
...
attMut0.setAttName("createInstance");
oldAttVal = ((ModifyInformationMutator) mut).getOldAttValue("createInstance");
newAttVal = ((ModifyInformationMutator) mut).getNewAttValue("createInstance");
if (oldAttVal != null) {
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/aci/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/aci/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/aci/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/aci/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/aci/data/out/aci.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l23 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/aci/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/aci/data/out/", "C:/eclipse/runtime-EclipseApplication/aci/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/aci/data/model/", "aci", "C:/eclipse/runtime-EclipseApplication/aci", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/aci/data/out/", "C:/eclipse/runtime-EclipseApplication/aci/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/aci/data/model/", "aci", "C:/eclipse/runtime-EclipseApplication/aci", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
