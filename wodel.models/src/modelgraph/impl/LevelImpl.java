 ...
 * <ul>
 *   <li>{@link modelgraph.impl.LevelImpl#getUpper <em>Upper</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LevelImpl extends RelationImpl implements Level {
	...
	protected EClass eStaticClass() {
		return ModelgraphPackage.Literals.LEVEL;
	}
		...
		if (upper != null && upper.eIsProxy()) {
			...
			if (upper != oldUpper) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelgraphPackage.LEVEL__UPPER, oldUpper, upper));
			}
		}
		return upper;
	}
	...
	public void setUpper(EReference newUpper) {
		...
		upper = newUpper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgraphPackage.LEVEL__UPPER, oldUpper, upper));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelgraphPackage.LEVEL__UPPER:
