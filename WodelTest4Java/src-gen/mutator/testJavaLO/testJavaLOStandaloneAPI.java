...
public class testJavaLOStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
		...
		muttestJavaLO.execute(maxAttempts, numMutants, registry, metrics, debugMetrics, packages, registeredPackages,
		...
		System.out.println("testJavaLO Mutant generation process finished.");
	}
}
