...
public class DFAWodelSample10 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation2(ArrayList<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects, HashMap<String, List<EObject>> hmList) throws ReferenceNonExistingException {
		...
		//MODIFY TARGET REFERENCE mutation2
			...
			ObSelectionStrategy newTargetSelection = new SpecificObjectSelection(packages, model, hmObjects.get("s"));
	...
	public void execute(int maxAttempts, int numMutants, boolean registry) throws ReferenceNonExistingException, WrongAttributeTypeException, 
		...
		if (maxAttempts <= 0) {
		    ...
		    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample10/model/DFAAutomaton.ecore";
		    
		    String modelURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample10/model/";
		    String modelsURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample10/out/";
		    String resourcesURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample10/resources/";
		    ...
		    //2
		   	...
		   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/DFAWodelSample10/out/DFAWodelSample10.model").toFileString());
		   	...
		   	HashMap<String, EObject> hmMutator = getMutators(ModelManager.getObjects(mutatormodel));
		   			...
		   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
		   	   				...
		   	   				//RESET COUNTER: 0
		   	   	   			...
		   	   	   			ArrayList<Mutator> ls23 = mutation1(packages, model, hashmapEObject, hashmapList);
		   	   	   			//COUNTER: 1
		   	   	   			//REGISTRY METHOD NAME:registry1
		   	   	   			
		   	   	   			if (ls23 != null) {
		   	   	   				for (Mutator mut : ls23) {
		   	   	   					if (mut != null) {
		   	   	   			...
		   	   	   			ArrayList<Mutator> l24 = mutation2(packages, model, hashmapEObject, hashmapList);
		   	   	   			//COUNTER: 2
