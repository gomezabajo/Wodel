...
public class WodelTest4FAStandaloneAPILauncher {
	public static void createMutants(String inputFolder, String outputFolder)
		...
		String ecoreURI = "C:/eclipse/runtime-New_configuration27/WodelTest4FA/data/model/DFAAutomaton.ecore";
		...
		String inputWodelFolder = "C:/eclipse/runtime-New_configuration27/WodelTest4FA/data/model";
