...
public class testJavaRestStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
			throws ReferenceNonExistingException, WrongAttributeTypeException, MaxSmallerThanMinException,
			AbstractCreationException, ObjectNoTargetableException, ObjectNotContainedException,
			MetaModelNotFoundException, ModelNotFoundException, IOException {
		System.out.println("Wodel mutator file: testJavaRest");
		String ecoreURI = "C:/eclipse/runtime-EclipseApplication36/WodelTest4Java/data/model/java.ecore";
		List<EPackage> packages = null;
		try {
			packages = ModelManager.loadMetaModel(ecoreURI, testJavaRestStandaloneAPI.class);
		} catch (Exception e) {
		}
		...
		muttestJavaRest.execute(maxAttempts, numMutants, registry, metrics, debugMetrics, packages, registeredPackages,
		...
		System.out.println("testJavaRest Mutant generation process finished.");
	}
}
