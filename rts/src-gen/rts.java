...
public class rts extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/rts/data/out/rts.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> ls193 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (ls193 != null) {
							int k = 0;
							for (Mutator mut : ls193) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l194 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (l194 != null) {
							int k = 0;
							for (Mutator mut : l194) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/rts/data/out/",
					"C:/eclipse/workspace/rts/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/rts/data/model/",
					"rts.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/rts/data/out/",
					"C:/eclipse/workspace/rts/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/rts/data/model/",
					"rts.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
