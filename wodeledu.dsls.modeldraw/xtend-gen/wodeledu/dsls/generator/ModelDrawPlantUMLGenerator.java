...
public class ModelDrawPlantUMLGenerator extends AbstractGenerator {
  ...
  public CharSequence compile(final MutatorDraw draw) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("private static void generateUMLNodes(List<EPackage> packages, Resource model, Map<Integer, Map<EObject, List<LabelStyle>>> umlnodes, Map<Integer, Map<EObject, Map<String, List<LabelStyle>>>> umlrels, Map<String, Integer> id) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private static void generateUMLEdges(List<EPackage> packages, Resource model, Map<Integer, Map<EObject, List<LabelStyle>>> umlnodes, Map<Integer, Map<EObject, Map<String, List<LabelStyle>>>> umlrels, Map<String, Integer> id) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("// COUNTER: ");
