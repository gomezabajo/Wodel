...
public class ucl4 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/ucl4/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/ucl4/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/ucl4/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/ucl4/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/ucl4/data/out/ucl4.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1545 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (l1545 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1545) {
	   	   	   					if (mut != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/ucl4/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ucl4/data/out/", "C:/eclipse/runtime-EclipseApplication/ucl4/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/ucl4/data/model/", "ucl4", "C:/eclipse/runtime-EclipseApplication/ucl4", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ucl4/data/out/", "C:/eclipse/runtime-EclipseApplication/ucl4/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/ucl4/data/model/", "ucl4", "C:/eclipse/runtime-EclipseApplication/ucl4", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
