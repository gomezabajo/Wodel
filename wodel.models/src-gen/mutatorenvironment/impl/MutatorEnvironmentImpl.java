...
public class MutatorEnvironmentImpl extends MinimalEObjectImpl.Container implements MutatorEnvironment {
	...
	public NotificationChain basicSetDefinition(Definition newDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MUTATOR_ENVIRONMENT__DEFINITION, oldDefinition, newDefinition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDefinition != definition) {
			...
			if (definition != null)
				msgs = ((InternalEObject) definition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.MUTATOR_ENVIRONMENT__DEFINITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.MUTATOR_ENVIRONMENT__DEFINITION, newDefinition, newDefinition));
	}
	...
	public EList<Mutator> getCommands() {
		if (commands == null) {
			commands = new EObjectContainmentEList<Mutator>(Mutator.class, this,
					MutatorenvironmentPackage.MUTATOR_ENVIRONMENT__COMMANDS);
		}
		return commands;
	}
	...
	public EList<Load> getLoad() {
		if (load == null) {
			load = new EObjectContainmentEList<Load>(Load.class, this,
					MutatorenvironmentPackage.MUTATOR_ENVIRONMENT__LOAD);
		}
		return load;
	}
	...
	public EList<Block> getBlocks() {
		if (blocks == null) {
			blocks = new EObjectContainmentEList<Block>(Block.class, this,
					MutatorenvironmentPackage.MUTATOR_ENVIRONMENT__BLOCKS);
		}
		return blocks;
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this,
					MutatorenvironmentPackage.MUTATOR_ENVIRONMENT__CONSTRAINTS);
		}
		return constraints;
	}
