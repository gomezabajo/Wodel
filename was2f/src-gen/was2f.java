...
public class was2f extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/was2f/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/was2f/data/model/";
		String modelsURI = "C:/eclipse/workspace/was2f/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/was2f/data/out/was2f.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l338 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l338 != null) {
							int k = 0;
							for (Mutator mut : l338) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2f/data/out/",
					"C:/eclipse/workspace/was2f/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2f/data/model/", "was2f.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2f/data/out/",
					"C:/eclipse/workspace/was2f/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2f/data/model/", "was2f.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
