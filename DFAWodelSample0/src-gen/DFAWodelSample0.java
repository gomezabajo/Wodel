...
public class DFAWodelSample0 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation1(ArrayList<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects, HashMap<String, List<EObject>> hmList) throws ReferenceNonExistingException {
		...
		RandomTypeSelection refRts2 = new RandomTypeSelection(packages, model, "AlphabetSymbol");
		EObject refObject2 = refRts2.getObject();
		ObSelectionStrategy refSelection2 = null;
		if (refObject2 != null) {
		refSelection2 = 
			new SpecificObjectSelection(packages, model, refObject2);
		}
	...
	public void execute(int maxAttempts, int numMutants, boolean registry) throws ReferenceNonExistingException, WrongAttributeTypeException, 
		...
		if (maxAttempts <= 0) {
		    ...
		    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample0/model/DFAAutomaton.ecore";
		    
		    String modelURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample0/model/";
		    String modelsURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample0/out/";
		    ...
		    //2
		   	...
		   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/DFAWodelSample0/out/DFAWodelSample0.model").toFileString());
