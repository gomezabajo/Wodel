...
public class was2h extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null && objectSelection.getObject() != null) {
			mut = new RetypeObjectMutator(model, packages, objectSelection.getObject(), referenceSelection,
					containerSelection, atts, refs, "Aggregation");
		}
		if (mut != null) {
			mut.setId("m1");
			mutations.add(mut);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/was2h/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/was2h/data/model/";
		String modelsURI = "C:/eclipse/workspace/was2h/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/was2h/data/out/was2h.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l342 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l342 != null) {
							int k = 0;
							for (Mutator mut : l342) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2h/data/out/",
					"C:/eclipse/workspace/was2h/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2h/data/model/", "was2h.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/was2h/data/out/",
					"C:/eclipse/workspace/was2h/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/was2h/data/model/", "was2h.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
