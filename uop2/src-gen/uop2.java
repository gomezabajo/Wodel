...
public class uop2 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection refRts46 = new RandomTypeSelection(packages, model, "Class");
		EObject refObject46 = refRts46.getObject();
		ObSelectionStrategy refSelection46 = null;
		if (refObject46 != null) {
			refSelection46 = new SpecificObjectSelection(packages, model, refObject46);
		}
		refs.put("type", refSelection46);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/uop2/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/uop2/data/model/";
		String modelsURI = "C:/eclipse/workspace/uop2/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/uop2/data/out/uop2.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l320 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l320 != null) {
							int k = 0;
							for (Mutator mut : l320) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uop2/data/out/",
					"C:/eclipse/workspace/uop2/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uop2/data/model/", "uop2.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uop2/data/out/",
					"C:/eclipse/workspace/uop2/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uop2/data/model/", "uop2.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
