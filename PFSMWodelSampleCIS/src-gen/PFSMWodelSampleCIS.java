...
public class PFSMWodelSampleCIS extends manager.MutatorUtils implements manager.IMutatorExecutor {
...
//METHOD NAME:mutation1
	...
	if (objectSelection != null) {
		//NAME:isInitial
		atts.put("isInitial", new SpecificBooleanConfigurationStrategy(false)
		);
	}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/model/PFSM.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/resources/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/out/PFSMWodelSampleCIS.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> ls017 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (ls017 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ls017) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> ls118 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (ls118 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : ls118) {
	   	   	   					if (mut != null) {
	   	   	   						EObject mutated = (EObject) mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/out/", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/model/PFSM.ecore", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/model/", "PFSMWodelSampleCIS", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/out/", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/model/PFSM.ecore", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS/data/model/", "PFSMWodelSampleCIS", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCIS", hashmapMutVersions);   			
   		}
   	}
}
