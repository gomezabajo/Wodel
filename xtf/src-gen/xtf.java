...
public class xtf extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation2
	...
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Variable", referenceSelection, containerSelection);
...
//SELECT OBJECT mutation3
	...
	((ReferenceEvaluation) exp0.first).refName = null;
	((ReferenceEvaluation) exp0.first).operator = "different";
	((ReferenceEvaluation) exp0.first).value = new SpecificObjectSelection(packages, model, hmObjects.get("fv1")).getObject();
	   		exp0.operator = new ArrayList<Operator>();
	   		//OPNAME: 
	   		exp0.second = new ArrayList<Evaluation>();
	   		//EVNAME: 
...
//METHOD NAME:mutation4
	...
	// REMOVE OBJECT mutation4
		...
		if (hmObjects.get("fv1") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("fv1"));
	   			} else {
			return mutations;
		}
	   			...
	   			if (objectSelection != null && objectSelection.getObject() != null) {
	   				if (hmObjects.get("fv2") != null) {
	   					...
	   					if (refsList.get("faultVariable") != null) {
		   					...
		   					refs.add(new SpecificReferenceConfigurationStrategy(model, objectSelection.getObject(), hmObjects.get("fv2"), "faultVariable"));
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/xtf/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/xtf/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/xtf/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/xtf/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/xtf/data/out/xtf.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt1103 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lt1103 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lt1103) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lfv1104 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lfv1104 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lfv1104) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lfv2105 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (lfv2105 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lfv2105) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l106 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			...
	   	   	   			ArrayList<Mutator> l107 = mutation5(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 5
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/xtf/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/xtf/data/out/", "C:/eclipse/runtime-EclipseApplication/xtf/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/xtf/data/model/", "xtf", "C:/eclipse/runtime-EclipseApplication/xtf", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/xtf/data/out/", "C:/eclipse/runtime-EclipseApplication/xtf/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/xtf/data/model/", "xtf", "C:/eclipse/runtime-EclipseApplication/xtf", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
