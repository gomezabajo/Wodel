...
public class EdutestFactoryImpl extends EFactoryImpl implements EdutestFactory {
	...
	public static EdutestFactory init() {
		try {
			EdutestFactory theEdutestFactory = (EdutestFactory)EPackage.Registry.INSTANCE.getEFactory(EdutestPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case EdutestPackage.PROGRAM: return createProgram();
