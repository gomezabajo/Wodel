...
public class ASPLEWodelSample0 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	//NAME:operator
	atts.put("operator", new ListStringConfigurationStrategy((String) ModelManager.getAttribute("operator", objectSelection.getObject()), "[add, subtract, multiply, divide, module]", "operator")
	);
	}
	...
	public void execute(int maxAttempts, int numMutants, boolean registry) throws ReferenceNonExistingException, WrongAttributeTypeException, 
		...
		if (maxAttempts <= 0) {
		    ...
		    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample0/model/Asple.ecore";
		    
		    String modelURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample0/model/";
		    String modelsURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample0/out/";
		    ...
		    //2
		   	...
		   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample0/out/ASPLEWodelSample0.model").toFileString());
