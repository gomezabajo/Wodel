...
public class xer extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/xer/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/xer/data/model/";
		String modelsURI = "C:/eclipse/workspace/xer/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/xer/data/out/xer.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l177 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l177 != null) {
							int k = 0;
							for (Mutator mut : l177) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xer/data/out/",
					"C:/eclipse/workspace/xer/data/model/bpel.ecore", "C:/eclipse/workspace/xer/data/model/",
					"xer.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xer/data/out/",
					"C:/eclipse/workspace/xer/data/model/bpel.ecore", "C:/eclipse/workspace/xer/data/model/",
					"xer.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
