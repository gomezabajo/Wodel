...
public class RandomStringTypeImpl extends StringTypeImpl implements RandomStringType {
	...
	public void setMin(int newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.RANDOM_STRING_TYPE__MIN,
					oldMin, min));
	}
	...
	public void setMax(int newMax) {
		...
		max = newMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.RANDOM_STRING_TYPE__MAX,
					oldMax, max));
	}
	...
	public void setAllowsNull(boolean newAllowsNull) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.RANDOM_STRING_TYPE__ALLOWS_NULL, oldAllowsNull, allowsNull));
	}
