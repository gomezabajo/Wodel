...
import wodeledu.dsls.generator.EduTestUtils.TestOption
import wodeledu.dsls.generator.EduTestUtils.Registry
 ...
 *  
 */
class EduTestGenerator extends EduTestUtils implements IGenerator {
	...
	def compile(Program program, Resource resource) '''
		<!--«buildOptions(program, resource, blocks)»-->
