...
(
    ...
    { 
        $current = $this_ListStringType_4.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
(
    ...
    { 
        $current = $this_AttributeInit_0.current; 
        afterParserOrEnumRuleCall();
    }
