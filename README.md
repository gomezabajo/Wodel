<p align="center">
  <a href="https://gomezabajo.github.io/Wodel-Test/dropdown/Wodel-Test%20plugins_Wodel-Test%20for%20Java/">
    <img src="https://gomezabajo.github.io/Wodel-Test/assets/img/wodeltest.png" width="224" height="120" alt="Wodel-Test logo" />
  </a>
</p>

<h1 align="center">Wodel-Test for Java</h1>

<p align="center"><i>A mutation testing (MT) tool for the Java programming language</i></p>
...
<p align="center">
  <a href="https://gomezabajo.github.io/Wodel-Test/dropdown/Wodel-Test%20plugins_Wodel-Test%20for%20Java/">Website</a> &middot;
...
**Wodel-Test for Java** is a mutation testing (MT) tool for the Java programming language, with support for **JUnit 3, JUnit 4 and JUnit 5** test suites, automatically generated with [Wodel-Test](https://gomezabajo.github.io/Wodel-Test/), a model-based framework for engineering language-specific mutation-testing tools.

<p align="center">
  <a href="https://youtu.be/-7NV2VnSC0Q">
    <img src="https://raw.githubusercontent.com/gomezabajo/Wodel/gh-pages/images/wodeltest-for-java-junit4.png" alt="Demonstration of the Wodel-Test MuT tool for Java with JUnit 4" width="640"/>
  </a>
  <br/>
  <em>The generated MuT tool for Java with JUnit 4 in operation (click to watch the video).</em>
</p>

<p align="center">
  <a href="https://youtu.be/chjVhp018IQ">
    <img src="https://raw.githubusercontent.com/gomezabajo/Wodel/gh-pages/images/wodeltest-for-java-junit5.png" alt="Demonstration of the Wodel-Test MuT tool for Java with JUnit 5" width="640"/>
  </a>
  <br/>
  <em>The generated MuT tool for Java with JUnit 5 in operation (click to watch the video).</em>
</p>
...
Once the mutation operators are defined, Wodel-Test generates a complete MT environment for the language as an Eclipse plug-in. This branch contains the MT tool generated for **Java**, which:

- Parses the Java programs, representing them as models conformant to the Java meta-model.
- Applies the mutation operators defined with Wodel to generate Java mutants.
- Evaluates the test suite — defined with **JUnit 3, JUnit 4 or JUnit 5** — on the generated mutants.
- Executes each mutant in an asynchronous thread with a timeout limit, avoiding non-terminating executions when a mutation introduces an endless loop.
...
1. **Meta-model** — the abstract syntax of Java is described by an Ecore meta-model ([java.ecore](https://gomezabajo.github.io/Wodel/Wodel-Test/ecore/java.ecore)).
2. **Mutation operators** — the Java mutation operators are defined at the model level with the Wodel DSL ([testJava.zip](https://gomezabajo.github.io/Wodel/Wodel-Test/plugins/testJava.zip)).
3. **Generation** — the Wodel-Test designer synthesises the complete MT environment for Java as an Eclipse plug-in, distributed through its own update site.
4. **Mutation testing** — the generated tool parses the Java programs as models, applies the mutation operators, and executes the test suites against the resulting mutants.
...
| Folder | Description |
| --- | --- |
| `WodelTest4Java` | The generated MT Eclipse plug-in for Java. |
| `WodelTest4Java.plugins` | The Eclipse feature that groups the plug-ins of the MT tool for Java. |
| `WodelTest4Java.updatesite` | The Eclipse update site to install the MT tool for Java, including the required Wodel plug-ins. |
...
2. Add the update site: <https://gomezabajo.github.io/Wodel/Wodel-Test/java/update-site>
3. Select the **Wodel-Test for Java** features, and complete the installation wizard.
4. Restart Eclipse when prompted.

### Option 2: Standalone Eclipse distribution

Download a ready-to-use Eclipse distribution with Wodel-Test for Java already installed:

- [Standalone Eclipse distribution with Wodel-Test for Java](https://www.dropbox.com/scl/fi/g7pn7enhd93axfhrdhafx/eclipse.zip?rlkey=q7uni28gxf26s3qrutr4nslfw&dl=0)

## Sample project

You can try the MT tool with a reduced version of an earlier release of the [Apache Commons CLI](https://github.com/rjust/defects4j/tree/master/framework/projects/Cli) project. It contains a known defect and forms part of [Defects4J](https://github.com/rjust/defects4j), a widely used collection of reproducible Java faults for evaluating software-testing tools:
...
This project also illustrates the timeout mechanism: some of its mutants enter endless loops, which the tool detects and discards through its timeout limits.

## Resources

- 🌐 [Wodel-Test website](https://gomezabajo.github.io/Wodel-Test/)
- 🌐 [Wodel-Test for Java page](https://gomezabajo.github.io/Wodel-Test/dropdown/Wodel-Test%20plugins_Wodel-Test%20for%20Java/)
- 📦 [Eclipse update site](https://gomezabajo.github.io/Wodel/Wodel-Test/java/update-site)
- 🧬 [Java Ecore meta-model](https://gomezabajo.github.io/Wodel/Wodel-Test/ecore/java.ecore)
- 🧪 [Wodel project with the Java mutation operators (ZIP)](https://gomezabajo.github.io/Wodel/Wodel-Test/plugins/testJava.zip)
- 🎬 [Video demo: the generated MuT tool for Java with JUnit 4](https://youtu.be/-7NV2VnSC0Q)
- 🎬 [Video demo: the generated MuT tool for Java with JUnit 5](https://youtu.be/chjVhp018IQ)
