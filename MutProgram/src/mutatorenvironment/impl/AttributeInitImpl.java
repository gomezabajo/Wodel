 ...
 * <ul>
 *   <li>{@link mutatorenvironment.impl.AttributeInitImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeInitImpl extends AttributeSetImpl implements AttributeInit {
	...
	public void setValue(AttributeType newValue) {
		if (newValue != value) {
			...
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.ATTRIBUTE_INIT__VALUE, null, msgs);
			msgs = basicSetValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.ATTRIBUTE_INIT__VALUE, newValue, newValue));
	}
