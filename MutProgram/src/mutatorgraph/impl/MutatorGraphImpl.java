 ...
 * <ul>
 *   <li>{@link mutatorgraph.impl.MutatorGraphImpl#getType <em>Type</em>}</li>
 *   <li>{@link mutatorgraph.impl.MutatorGraphImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link mutatorgraph.impl.MutatorGraphImpl#getEdges <em>Edges</em>}</li>
 *   <li>{@link mutatorgraph.impl.MutatorGraphImpl#getMetamodel <em>Metamodel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MutatorGraphImpl extends ItemImpl implements MutatorGraph {
	...
	protected EClass eStaticClass() {
		return MutatorgraphPackage.Literals.MUTATOR_GRAPH;
	}
	...
	public void setType(GraphType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorgraphPackage.MUTATOR_GRAPH__TYPE, oldType, type));
	}
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<Node>(Node.class, this, MutatorgraphPackage.MUTATOR_GRAPH__NODES);
		}
		return nodes;
	}
	...
	public EList<Edge> getEdges() {
		if (edges == null) {
			edges = new EObjectContainmentEList<Edge>(Edge.class, this, MutatorgraphPackage.MUTATOR_GRAPH__EDGES);
		}
		return edges;
	}
	...
	public void setMetamodel(String newMetamodel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorgraphPackage.MUTATOR_GRAPH__METAMODEL, oldMetamodel, metamodel));
	}
