...
public class mge extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//METHOD NAME:mutation3
	...
	// REMOVE OBJECT mutation3
		...
		ObSelectionStrategy objectSelection = null;
		if (hmObjects.get("sup") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("sup"), referenceSelection, containerSelection);
	   			} else {
			return mutations;
		}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/mge/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/mge/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/mge/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/mge/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/mge/data/out/mge.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lcl23 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lcl23 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lcl23) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lsup24 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lsup24 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lsup24) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("sup", mut.getObject());
	   	   	   							}
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/mge/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/mge/data/out/", "C:/eclipse/runtime-EclipseApplication/mge/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/mge/data/model/", "mge", "C:/eclipse/runtime-EclipseApplication/mge", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/mge/data/out/", "C:/eclipse/runtime-EclipseApplication/mge/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/mge/data/model/", "mge", "C:/eclipse/runtime-EclipseApplication/mge", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
