...
public class wco8 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null) {
			...
			atts.add(new ListStringConfigurationStrategy(
					(String) ModelManager.getAttribute("op",
							(objectSelection != null) ? objectSelection.getObject() : null),
					"[lt, lte, gt, gte, equals, distinct]", "op"));
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/wco8/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/wco8/data/model/";
		String modelsURI = "C:/eclipse/workspace/wco8/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/wco8/data/out/wco8.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l392 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l392 != null) {
							int k = 0;
							for (Mutator mut : l392) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/wco8/data/out/",
					"C:/eclipse/workspace/wco8/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/wco8/data/model/", "wco8.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/wco8/data/out/",
					"C:/eclipse/workspace/wco8/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/wco8/data/model/", "wco8.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
