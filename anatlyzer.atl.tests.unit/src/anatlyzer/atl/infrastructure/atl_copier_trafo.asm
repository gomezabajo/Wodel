...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="6:26-6:29"/>
		<constant value="6:42-6:52"/>
		<constant value="6:26-6:53"/>
	...
	<operation name="65">
		...
		<linenumbertable>
			...
			<lne id="72" begin="9" end="13"/>
			<lne id="64" begin="8" end="14"/>
		</linenumbertable>
		<localvariabletable>
