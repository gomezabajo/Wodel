...
public class IdentifyElementsGenerator implements IGenerator {
    ...
    for (final IdentifyElements e : _filter) {
      {
        ...
        String _replaceAll = this.fileName.replaceAll(".idelems", "_idelems.model");
        String _plus_12 = (_plus_11 + _replaceAll);
        this.xmiFileName = _plus_12;
        IdentifyElementsUtils.serialize(xTextFileName, this.xmiFileName);
      }
    }
  }
}
