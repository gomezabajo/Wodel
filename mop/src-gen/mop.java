...
public class mop extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/mop/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/mop/data/model/";
		String modelsURI = "C:/eclipse/workspace/mop/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/mop/data/out/mop.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l274 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l274 != null) {
							int k = 0;
							for (Mutator mut : l274) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/mop/data/out/",
					"C:/eclipse/workspace/mop/data/model/UMLClassDiagram.ecore", "C:/eclipse/workspace/mop/data/model/",
					"mop.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/mop/data/out/",
					"C:/eclipse/workspace/mop/data/model/UMLClassDiagram.ecore", "C:/eclipse/workspace/mop/data/model/",
					"mop.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
