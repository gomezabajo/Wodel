...
public class was2c extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:src
  		//REFERENCES COMPILES	362
ObSelectionStrategy refSelection362 = null;
if (hmObjects.get("as") != null) {
refSelection362 = new SpecificObjectSelection(packages, model, hmObjects.get("as"), "src");
} else {
	if (hmList.get("as") != null) {
	refSelection362 = new SpecificObjectSelection(packages, model, hmList.get("as"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection362);
//NAME:tar
  		//REFERENCES COMPILES	363
ObSelectionStrategy refSelection363 = null;
if (hmObjects.get("as") != null) {
refSelection363 = new SpecificObjectSelection(packages, model, hmObjects.get("as"), "tar");
} else {
	if (hmList.get("as") != null) {
	refSelection363 = new SpecificObjectSelection(packages, model, hmList.get("as"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection363);
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@b263c37 (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/was2c/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/was2c/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/was2c/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/was2c/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/was2c/data/out/was2c.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> las1180 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (las1180 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : las1180) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel1181 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel1181 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel1181) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1182 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l1182 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1182) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1183 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l1183 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1183) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/was2c/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2c/data/out/", "C:/eclipse/runtime-EclipseApplication/was2c/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2c/data/model/", "was2c", "C:/eclipse/runtime-EclipseApplication/was2c", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2c/data/out/", "C:/eclipse/runtime-EclipseApplication/was2c/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2c/data/model/", "was2c", "C:/eclipse/runtime-EclipseApplication/was2c", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
