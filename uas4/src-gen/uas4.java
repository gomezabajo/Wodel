...
public class uas4 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection refRts39 = new RandomTypeSelection(packages, model, "Class");
		EObject refObject39 = refRts39.getObject();
		ObSelectionStrategy refSelection39 = null;
		if (refObject39 != null) {
			refSelection39 = new SpecificObjectSelection(packages, model, refObject39);
		}
		refs.put("src", refSelection39);
		RandomTypeSelection refRts40 = new RandomTypeSelection(packages, model, "Class");
		EObject refObject40 = refRts40.getObject();
		ObSelectionStrategy refSelection40 = null;
		if (refObject40 != null) {
			refSelection40 = new SpecificObjectSelection(packages, model, refObject40);
		}
		refs.put("tar", refSelection40);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/uas4/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/uas4/data/model/";
		String modelsURI = "C:/eclipse/workspace/uas4/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/uas4/data/out/uas4.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l284 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (l284 != null) {
							int k = 0;
							for (Mutator mut : l284) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uas4/data/out/",
					"C:/eclipse/workspace/uas4/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uas4/data/model/", "uas4.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/uas4/data/out/",
					"C:/eclipse/workspace/uas4/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/uas4/data/model/", "uas4.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
