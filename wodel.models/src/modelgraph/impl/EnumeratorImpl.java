 ...
 * <ul>
 *   <li>{@link modelgraph.impl.EnumeratorImpl#getLiteral <em>Literal</em>}</li>
 *   <li>{@link modelgraph.impl.EnumeratorImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumeratorImpl extends MinimalEObjectImpl.Container implements Enumerator {
	...
	protected EClass eStaticClass() {
		return ModelgraphPackage.Literals.ENUMERATOR;
	}
		...
		if (literal != null && literal.eIsProxy()) {
			...
			if (literal != oldLiteral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelgraphPackage.ENUMERATOR__LITERAL, oldLiteral, literal));
			}
		}
		return literal;
	}
	...
	public void setLiteral(EEnumLiteral newLiteral) {
		...
		literal = newLiteral;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgraphPackage.ENUMERATOR__LITERAL, oldLiteral, literal));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgraphPackage.ENUMERATOR__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelgraphPackage.ENUMERATOR__LITERAL:
				if (resolve) return getLiteral();
				return basicGetLiteral();
			case ModelgraphPackage.ENUMERATOR__VALUE:
				return getValue();
		}
