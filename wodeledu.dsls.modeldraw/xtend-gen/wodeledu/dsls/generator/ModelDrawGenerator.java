              ...
              for(final Relation rel : _relations_1) {
                {
                  if ((rel instanceof Edge)) {
                    ...
                    _builder.append("\t");
                    _builder.append("\t\t\t\t\t\t");
                    _builder.append("if (value != null && value.length() > 0) { ");
                    _builder.newLine();
                    _builder.append("\t");
                    _builder.append("\t");
                    _builder.append("\t\t\t\t\t\t\t");
                    ...
                    _builder.append("\t");
                    _builder.append("\t\t\t\t\t\t");
                    _builder.append("String valueText = parameters.get(keyParameters);");
                    _builder.newLine();
                    _builder.append("\t");
                    _builder.append("\t");
                    _builder.append("\t\t\t\t\t\t");
                    _builder.append("if (valueText != null && valueText.length() > 1) {");
                    _builder.newLine();
                    _builder.append("\t");
                    _builder.append("\t");
                    _builder.append("\t\t\t\t\t\t\t");
