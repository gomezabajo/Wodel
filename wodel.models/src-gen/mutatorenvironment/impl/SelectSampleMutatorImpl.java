...
public class SelectSampleMutatorImpl extends MutatorImpl implements SelectSampleMutator {
	...
	public NotificationChain basicSetObject(ObSelectionStrategy newObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.SELECT_SAMPLE_MUTATOR__OBJECT, oldObject, newObject);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject) object).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.SELECT_SAMPLE_MUTATOR__OBJECT, null, msgs);
			if (newObject != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.SELECT_SAMPLE_MUTATOR__OBJECT, newObject, newObject));
	}
	...
	public void setClause(SampleClause newClause) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.SELECT_SAMPLE_MUTATOR__CLAUSE, oldClause, clause));
	}
	...
	public EList<EStructuralFeature> getFeatures() {
		if (features == null) {
			features = new EObjectResolvingEList<EStructuralFeature>(EStructuralFeature.class, this,
					MutatorenvironmentPackage.SELECT_SAMPLE_MUTATOR__FEATURES);
		}
		return features;
	}
