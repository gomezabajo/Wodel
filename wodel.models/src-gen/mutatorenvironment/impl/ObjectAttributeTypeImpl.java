...
public class ObjectAttributeTypeImpl extends AttributeEvaluationTypeImpl implements ObjectAttributeType {
			...
			if (objSel != oldObjSel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.OBJECT_ATTRIBUTE_TYPE__OBJ_SEL, oldObjSel, objSel));
			}
		}
		return objSel;
	}
	...
	public EAttribute getAttribute() {
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MutatorenvironmentPackage.OBJECT_ATTRIBUTE_TYPE__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setOperator(Operator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MutatorenvironmentPackage.OBJECT_ATTRIBUTE_TYPE__OPERATOR, oldOperator, operator));
	}
