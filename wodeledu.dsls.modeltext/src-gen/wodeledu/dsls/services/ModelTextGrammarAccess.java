...
@Singleton
public class ModelTextGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class IdentifyElementsElements extends AbstractParserRuleElementFinder {
		...
		//IdentifyElements:
		//	{IdentifyElements}
		//	'metamodel' metamodel=EString (elements+=Element elements+=Element*)?;
	...
	public class ElementElements extends AbstractParserRuleElementFinder {
		...
		//Element:
		//	{Element}
		//	'>' type=[ecore::EClass|EString] ('.' ref=[ecore::EReference])? ('(' att=Attribute ')')? ':' (words+=Word
		//	words+=Word*)?;
		@Override public ParserRule getRule() { return rule; }
