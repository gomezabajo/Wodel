...
public class alp extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
List<AttributeConfigurationStrategy> atts = null;
	...
	atts = new ArrayList<AttributeConfigurationStrategy>();
	   				...
	   				atts.add(new AddOperationConfigurationStrategy(packages, model, "Transition", "probability", objectSelection.getObject(), value));
...
List<AttributeConfigurationStrategy> atts = null;
	...
	atts = new ArrayList<AttributeConfigurationStrategy>();
	   				...
	   				atts.add(new SubtractOperationConfigurationStrategy(packages, model, "Transition", "probability", objectSelection.getObject(), value));
	   				attsList.put("probability", atts); 
}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    //String resourcesURI = "C:/eclipse/workspace/alp/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/alp/data/out/alp.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt055 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lt055 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lt055) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt156 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lt156 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lt156) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l57 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt258 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (lt258 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lt258) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l59 = mutation5(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 5
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/alp/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/alp/data/out/", "C:/eclipse/workspace/alp/data/model/PFSM.ecore", "C:/eclipse/workspace/alp/data/model/", "alp", "C:/eclipse/workspace/alp", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/alp/data/out/", "C:/eclipse/workspace/alp/data/model/PFSM.ecore", "C:/eclipse/workspace/alp/data/model/", "alp", "C:/eclipse/workspace/alp", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
