package mutator.testATLBStandalone;
...
public class testATLBStandalone extends MutatorUtils {
	...
	private static List<Mutator> mutation3(List<EPackage> packages, Resource model,
		...
		String absoluteMetamodelPath = testATLBStandalone.class.getProtectionDomain().getCodeSource().getLocation()
				.getPath().replace("/bin/", "/") + relativeMetamodelPath;
		resourcePackages = ModelManager.loadMetaModel(absoluteMetamodelPath, testATLBStandalone.class);
		resources = new ArrayList<Resource>();
		String relativeEcoreURI_0 = "data/model/out/Persons.ecore";
		String absoluteEcoreURI_0 = testATLBStandalone.class.getProtectionDomain().getCodeSource().getLocation()
		...
		String absoluteEcoreURI_1 = testATLBStandalone.class.getProtectionDomain().getCodeSource().getLocation()
		...
		String absoluteObjectMetamodelPath = testATLBStandalone.class.getProtectionDomain().getCodeSource()
				.getLocation().getPath().replace("/bin/", "/") + relativeObjectMetamodelPath;
		objectPackages = ModelManager.loadMetaModel(absoluteObjectMetamodelPath, testATLBStandalone.class);
	...
	public int block_cb(int maxAttempts, int numMutants, boolean registry, List<EPackage> packages,
		...
		String modelURI = testATLBStandalone.class.getProtectionDomain().getCodeSource().getLocation().getPath()
				.replace("/bin/", "/") + "data/model/";
		String modelsURI = testATLBStandalone.class.getProtectionDomain().getCodeSource().getLocation().getPath()
		...
		for (String modelFilename : modelFilenames) {
			...
			numMutants = 2;
			String xmiFilename = testATLBStandalone.class.getProtectionDomain().getCodeSource().getLocation().getPath()
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lsope76 = mutation1(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lsope76 != null) {
							for (Mutator mut : lsope76) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> ltype77 = mutation2(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (ltype77 != null) {
							for (Mutator mut : ltype77) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lcl78 = mutation3(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lcl78 != null) {
							for (Mutator mut : lcl78) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> latt79 = mutation4(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (latt79 != null) {
							for (Mutator mut : latt79) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lb80 = mutation5(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lb80 != null) {
							for (Mutator mut : lb80) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l81 = mutation6(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l81 != null) {
							for (Mutator mut : l81) {
								if (mut != null) {
					...
					isRepeated = registryMutantWithBlocksStandalone(ecoreURI, packages, registeredPackages,
							...
							testATLBStandalone.class, true, false);
					if (isRepeated == false) {
						numMutantsGenerated++;
						k[0] = k[0] + 1;
					}
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l82 = mutation7(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l82 != null) {
							for (Mutator mut : l82) {
								if (mut != null) {
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lb83 = mutation8(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lb83 != null) {
							for (Mutator mut : lb83) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l84 = mutation9(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l84 != null) {
							for (Mutator mut : l84) {
								if (mut != null) {
		...
		for (String modelFilename : modelFilenames) {
			...
			for (int i = 0; i < numMutantsToGenerate; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lsope85 = mutation10(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (lsope85 != null) {
							for (Mutator mut : lsope85) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> ltype86 = mutation11(packages, model, hashmapEObject, hashmapList, serialize,
								test, classes);
						if (ltype86 != null) {
							for (Mutator mut : ltype86) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lcl87 = mutation12(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lcl87 != null) {
							for (Mutator mut : lcl87) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> lb88 = mutation13(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (lb88 != null) {
							for (Mutator mut : lb88) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> latt89 = mutation14(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (latt89 != null) {
							for (Mutator mut : latt89) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						List<Mutator> l90 = mutation15(packages, model, hashmapEObject, hashmapList, serialize, test,
								classes);
						if (l90 != null) {
							for (Mutator mut : l90) {
								if (mut != null) {
	...
	public MutationResults execute(int maxAttempts, int numMutants, boolean registry, boolean metrics,
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, testATLBStandalone.class
					.getProtectionDomain().getCodeSource().getLocation().getPath().replace("/bin/", "/") + "data/out/",
					"/testATL/data/model/ATL.ecore",
					testATLBStandalone.class.getProtectionDomain().getCodeSource().getLocation().getPath()
							.replace("/bin/", "/") + "testATL/data/model/",
					"testATLBStandalone.java", hashmapMutVersions, testATLBStandalone.class);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, testATLBStandalone.class
					.getProtectionDomain().getCodeSource().getLocation().getPath().replace("/bin/", "/") + "data/out/",
					"/testATL/data/model/ATL.ecore",
					testATLBStandalone.class.getProtectionDomain().getCodeSource().getLocation().getPath()
							.replace("/bin/", "/") + "testATL/data/model/",
