...
public class wat3 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//METHOD NAME:mutation1
	...
	//NAME:type
	   			if (objectSelection != null && objectSelection.getObject() != null) {
	   				...
	   				refs.add(new RandomReferenceConfigurationStrategy(model, objectSelection.getObject(), "type", "NamedElement"));
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/wat3/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/wat3/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/wat3/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/wat3/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/wat3/data/out/wat3.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l3579 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (l3579 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l3579) {
	   	   	   					if (mut != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/wat3/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wat3/data/out/", "C:/eclipse/runtime-EclipseApplication/wat3/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wat3/data/model/", "wat3", "C:/eclipse/runtime-EclipseApplication/wat3", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/wat3/data/out/", "C:/eclipse/runtime-EclipseApplication/wat3/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/wat3/data/model/", "wat3", "C:/eclipse/runtime-EclipseApplication/wat3", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
