...
public class DFAWodelSample7 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry) throws ReferenceNonExistingException, WrongAttributeTypeException, 
		...
		if (maxAttempts <= 0) {
		    ...
		    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample7/model/DFAAutomaton.ecore";
		    
		    String modelURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample7/model/";
		    String modelsURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample7/out/";
		    ...
		    //2
		   	...
		   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/DFAWodelSample7/out/DFAWodelSample7.model").toFileString());
		   	...
		   	HashMap<String, EObject> hmMutator = getMutators(ModelManager.getObjects(mutatormodel));
		   			...
		   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
		   	   				...
		   	   				//RESET COUNTER: 0
		   	   	   			...
		   	   	   			ArrayList<Mutator> ls09 = mutation1(packages, model, hashmapEObject, hashmapList);
		   	   	   			//COUNTER: 1
		   	   	   			//REGISTRY METHOD NAME:registry1
		   	   	   			
		   	   	   			if (ls09 != null) {
		   	   	   				for (Mutator mut : ls09) {
		   	   	   					if (mut != null) {
		   	   	   			...
		   	   	   			ArrayList<Mutator> ls110 = mutation2(packages, model, hashmapEObject, hashmapList);
		   	   	   			//COUNTER: 2
		   	   	   			//REGISTRY METHOD NAME:registry2
		   	   	   			
		   	   	   			if (ls110 != null) {
		   	   	   				for (Mutator mut : ls110) {
		   	   	   					if (mut != null) {
		   	   	   						EObject mutated = (EObject) mut.mutate();
		   	   	   						if (mutated != null) {
