...
public class xtf extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Throw");
		List<EObject> objects = rts.getObjects();
		Expression exp0 = new Expression();
		exp0.first = new ReferenceEvaluation();
		((ReferenceEvaluation) exp0.first).name = "faultVariable";
	...
	private ArrayList<Mutator> mutation2(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (hmObjects.get("t1") != null) {
			containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("t1"));
		} else {
			if (hmList.get("t1") != null) {
				containerSelection = new SpecificObjectSelection(packages, model, hmList.get("t1"));
			} else {
				return mutations;
			}
		}
		if (hmObjects.get("t1") != null) {
			referenceSelection = new SpecificReferenceSelection(packages, model, "faultVariable", hmObjects.get("t1"));
		} else {
			return mutations;
		}
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Variable", referenceSelection,
				containerSelection);
	...
	private ArrayList<Mutator> mutation3(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		((ReferenceEvaluation) exp0.first).refName = null;
		((ReferenceEvaluation) exp0.first).operator = "different";
		((ReferenceEvaluation) exp0.first).value = new SpecificObjectSelection(packages, model, hmObjects.get("fv1"))
				.getObject();
		exp0.operator = new ArrayList<Operator>();
		exp0.second = new ArrayList<Evaluation>();
		List<EObject> selectedObjects = evaluate(objects, exp0);
	...
	private ArrayList<Mutator> mutation4(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null && objectSelection.getObject() != null) {
			if (hmObjects.get("fv1") != null) {
				List<ReferenceConfigurationStrategy> refs = null;
				if (refsList.get("faultVariable") != null) {
					refs = refsList.get("faultVariable");
				} else {
				...
				refs.add(new SpecificReferenceConfigurationStrategy(model, objectSelection.getObject(),
						hmObjects.get("fv1"), "faultVariable", true));
				refsList.put("faultVariable", refs);
			} else {
				return mutations;
			}
		}
		if (objectSelection != null && objectSelection.getObject() != null) {
			if (hmObjects.get("fv2") != null) {
				List<ReferenceConfigurationStrategy> refs = null;
				if (refsList.get("faultVariable") != null) {
					refs = refsList.get("faultVariable");
				} else {
				...
				refs.add(new SpecificReferenceConfigurationStrategy(model, objectSelection.getObject(),
						hmObjects.get("fv2"), "faultVariable", false));
				refsList.put("faultVariable", refs);
			} else {
				return mutations;
			}
	...
	private AppMutation registry4(Mutator mut, HashMap<String, EObject> hmMutator, Resource seed, List<String> mutPaths,
		...
		refMut0.setRefName("faultVariable");
		...
		refMut1.setRefName("faultVariable");
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/xtf/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/xtf/data/model/";
		String modelsURI = "C:/eclipse/workspace/xtf/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/xtf/data/out/xtf.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lt11179 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lt11179 != null) {
							int k = 0;
							for (Mutator mut : lt11179) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lfv11180 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (lfv11180 != null) {
							int k = 0;
							for (Mutator mut : lfv11180) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
											hashmapEObject.put("fv1", mut.getObject());
										}
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lfv21181 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (lfv21181 != null) {
							int k = 0;
							for (Mutator mut : lfv21181) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
											hashmapEObject.put("fv2", mut.getObject());
										}
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l1182 = mutation4(packages, model, hashmapEObject, hashmapList);
						if (l1182 != null) {
							int k = 0;
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xtf/data/out/",
					"C:/eclipse/workspace/xtf/data/model/bpel.ecore", "C:/eclipse/workspace/xtf/data/model/",
					"xtf.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xtf/data/out/",
					"C:/eclipse/workspace/xtf/data/model/bpel.ecore", "C:/eclipse/workspace/xtf/data/model/",
					"xtf.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
