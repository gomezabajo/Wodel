...
public class wco2 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation2(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Attribute", referenceSelection,
				containerSelection);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/wco2/data/model/UMLClassDiagram.ecore";
		String modelURI = "C:/eclipse/workspace/wco2/data/model/";
		String modelsURI = "C:/eclipse/workspace/wco2/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/wco2/data/out/wco2.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lpath374 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lpath374 != null) {
							int k = 0;
							for (Mutator mut : lpath374) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> latt375 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (latt375 != null) {
							int k = 0;
							for (Mutator mut : latt375) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l376 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (l376 != null) {
							int k = 0;
							for (Mutator mut : l376) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/wco2/data/out/",
					"C:/eclipse/workspace/wco2/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/wco2/data/model/", "wco2.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/wco2/data/out/",
					"C:/eclipse/workspace/wco2/data/model/UMLClassDiagram.ecore",
					"C:/eclipse/workspace/wco2/data/model/", "wco2.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
