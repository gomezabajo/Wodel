...
public class awr2 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation1
	...
	//
	//true
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "RepeatUntil");
...
ArrayList<EObject> containers = ModelManager.getParentObjects(packages, model, "While");
...
if (hmObjects.get("repeatUntil2") != null) {
refSelection10 = new SpecificObjectSelection(packages, model, hmObjects.get("repeatUntil2"), "targets");
} else {
	if (hmList.get("repeatUntil2") != null) {
	refSelection10 = new SpecificObjectSelection(packages, model, hmList.get("repeatUntil2"), "targets");
	}
	else {
		return mutations;
	}
}
   		refs.put("targets", refSelection10);
//NAME:sources
  		//REFERENCES COMPILES	11
ObSelectionStrategy refSelection11 = null;
if (hmObjects.get("repeatUntil2") != null) {
refSelection11 = new SpecificObjectSelection(packages, model, hmObjects.get("repeatUntil2"), "sources");
} else {
	if (hmList.get("repeatUntil2") != null) {
	refSelection11 = new SpecificObjectSelection(packages, model, hmList.get("repeatUntil2"), "sources");
	}
	else {
		return mutations;
	}
}
   		refs.put("sources", refSelection11);
//NAME:condition
  		//REFERENCES COMPILES	12
ObSelectionStrategy refSelection12 = null;
if (hmObjects.get("repeatUntil2") != null) {
refSelection12 = new SpecificObjectSelection(packages, model, hmObjects.get("repeatUntil2"), "condition");
} else {
	if (hmList.get("repeatUntil2") != null) {
	refSelection12 = new SpecificObjectSelection(packages, model, hmList.get("repeatUntil2"), "condition");
	}
	else {
		return mutations;
	}
}
   		refs.put("condition", refSelection12);
//NAME:activity
  		//REFERENCES COMPILES	13
ObSelectionStrategy refSelection13 = null;
if (hmObjects.get("repeatUntil2") != null) {
refSelection13 = new SpecificObjectSelection(packages, model, hmObjects.get("repeatUntil2"), "activity");
} else {
	if (hmList.get("repeatUntil2") != null) {
	refSelection13 = new SpecificObjectSelection(packages, model, hmList.get("repeatUntil2"), "activity");
	}
	else {
		return mutations;
	}
}
   		refs.put("activity", refSelection13);
//NAME:eExtensibilityElements
  		//REFERENCES COMPILES	14
ObSelectionStrategy refSelection14 = null;
if (hmObjects.get("repeatUntil2") != null) {
refSelection14 = new SpecificObjectSelection(packages, model, hmObjects.get("repeatUntil2"), "eExtensibilityElements");
} else {
	if (hmList.get("repeatUntil2") != null) {
	refSelection14 = new SpecificObjectSelection(packages, model, hmList.get("repeatUntil2"), "eExtensibilityElements");
	}
	else {
		return mutations;
	}
}
   		refs.put("eExtensibilityElements", refSelection14);
//NAME:documentation
  		//REFERENCES COMPILES	15
ObSelectionStrategy refSelection15 = null;
if (hmObjects.get("repeatUntil2") != null) {
refSelection15 = new SpecificObjectSelection(packages, model, hmObjects.get("repeatUntil2"), "documentation");
} else {
	if (hmList.get("repeatUntil2") != null) {
	refSelection15 = new SpecificObjectSelection(packages, model, hmList.get("repeatUntil2"), "documentation");
	}
	else {
		return mutations;
	}
}
   		refs.put("documentation", refSelection15);
CreateObjectMutator mut = new CreateObjectMutator(model, packages, referenceSelection, containerSelection, atts, refs, "While");
//INC COUNTER: 1
if (mut != null) {
	mut.setId("m2");
	mutations.add(mut);
...
//METHOD NAME:mutation3
	...
	ObSelectionStrategy objectSelection = null;
	if (hmObjects.get("while2") != null) {
		objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("while2"));
	} else {
		if (hmList.get("while2") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmList.get("while2"));
		}
		else {
			return mutations;
		}
...
if (objectSelection != null && objectSelection.getObject() != null) {
	if (hmObjects.get("repeatUntil2") != null) {
			   					...
			   					atts.add(new CopyAttributeConfigurationStrategy(objectSelection.getObject(), hmObjects.get("repeatUntil2"), "name", "name"));
...
if (objectSelection != null && objectSelection.getObject() != null) {
	if (hmObjects.get("repeatUntil2") != null) {
			   					...
			   					atts.add(new CopyAttributeConfigurationStrategy(objectSelection.getObject(), hmObjects.get("repeatUntil2"), "element", "element"));
...
if (objectSelection != null && objectSelection.getObject() != null) {
	if (hmObjects.get("repeatUntil2") != null) {
			   					...
			   					atts.add(new CopyAttributeConfigurationStrategy(objectSelection.getObject(), hmObjects.get("repeatUntil2"), "documentationElement", "documentationElement"));
...
if (objectSelection != null && objectSelection.getObject() != null) {
	if (hmObjects.get("repeatUntil2") != null) {
			   					...
			   					atts.add(new CopyAttributeConfigurationStrategy(objectSelection.getObject(), hmObjects.get("repeatUntil2"), "suppressJoinFailure", "suppressJoinFailure"));
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@19b867c6 (name: name) (ordered: true, unique: true, lowerBound: 0, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@11662cac (name: element) (ordered: true, unique: true, lowerBound: 0, upperBound: 1) (changeable: true, volatile: false, transient: true, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@5919559c (name: documentationElement) (ordered: true, unique: true, lowerBound: 0, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@6a46b570 (name: suppressJoinFailure) (ordered: true, unique: true, lowerBound: 0, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: true, derived: false) (iD: false)
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/awr2/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/awr2/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/awr2/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/awr2/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/awr2/data/out/awr2.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrepeatUntil251 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lrepeatUntil251 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrepeatUntil251) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("repeatUntil2", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> lwhile252 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lwhile252 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lwhile252) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("while2", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> l53 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/awr2/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/awr2/data/out/", "C:/eclipse/runtime-EclipseApplication/awr2/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/awr2/data/model/", "awr2", "C:/eclipse/runtime-EclipseApplication/awr2", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/awr2/data/out/", "C:/eclipse/runtime-EclipseApplication/awr2/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/awr2/data/model/", "awr2", "C:/eclipse/runtime-EclipseApplication/awr2", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
