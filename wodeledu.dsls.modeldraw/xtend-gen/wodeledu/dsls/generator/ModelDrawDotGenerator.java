      ...
      if (_tripleNotEquals) {
        {
          ...
          if (_greaterThan) {
            _builder.append("\t");
            _builder.append("private static void generateNodes(List<EPackage> packages, Resource model, Map<EObject, LabelStyle> dotnodes, Map<String, List<Map<String, String>>> dotrels) {");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t");
              ...
              for(final Node node : _nodes_1) {
                ...
                _builder.newLine();
                {
                  ...
                  if (_tripleNotEquals_1) {
                    ...
                    String _name_2 = node.getAttName().getName();
                    _builder.append(_name_2, "\t\t\t\t");
                    _builder.append("\")) {");
                    _builder.newLineIfNotEmpty();
                  } else {
                      ...
                      if (_equals) {
                      ...
                      } else {
                        {
                          ...
                          for(final ValuedFeature feat : _feature_1) {
                            ...
                            String _name_3 = feat.getFeat().getName();
                            _builder.append(_name_3, "\t\t\t\t");
                            _builder.append("\")) {");
                            _builder.newLineIfNotEmpty();
                            _builder.append("\t");
                                  ...
                                  if ((_feat_1 instanceof EReference)) {
                                    ...
                                    }
                                    {
                                      ...
                                      if (_tripleNotEquals_3) {
                                        ...
                                        _builder.append("\t");
                                        _builder.append("if (refFeature.getName().equals(\"");
                                        String _name_5 = feat.getRefFeature().getName();
                                              ...
                                              if (_greaterThan_2) {
                                                ...
                                                _builder.newLineIfNotEmpty();
                                                {
                                                  ...
                                                  for(final Content content : _contents_1) {
                                                    ...
                                                    _builder.append("\t\t\t\t");
                                                    _builder.append("if (obj.eClass().getName().equals(\"");
                                                    String _name_9 = content.getName().getName();
      ...
      if (_tripleNotEquals_6) {
        {
          ...
          if (_greaterThan_3) {
            _builder.append("\t");
            _builder.append("private static void generateRelations(Resource model, Map<String, List<Map<String, String>>> dotrels, Map<String, List<String>> dottext) {");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t");
            _builder.append("// COUNTER: ");
              ...
              for(final Relation rel : _relations_1) {
                {
                  if ((rel instanceof Edge)) {
                    ...
                    _builder.append(" = ModelManager.getObjectsOfType(\"");
                    String _name_10 = edge.getName().getName();
                      ...
                      if (_tripleNotEquals_7) {
                        ...
                        _builder.newLine();
                        {
                          ...
                          for(final ValuedFeature feat_1 : _feature_3) {
                            ...
                            _builder.append("\t");
                            _builder.append("if (feat.getName().equals(\"");
                            String _name_11 = feat_1.getFeat().getName();
                            ...
                            }
                            {
                              ...
                              if (_tripleNotEquals_8) {
                                ...
                                _builder.append("\t\t");
                                _builder.append("if (refFeature.getName().equals(\"");
                                String _name_12 = feat_1.getRefFeature().getName();
                      ...
                      if (_tripleEquals_2) {
                        ...
                        _builder.newLine();
                        {
                          ...
                          if (_tripleNotEquals_9) {
                            ...
                            _builder.append("\t");
                            _builder.append("if (ref.getName().equals(\"");
                            String _name_13 = edge.getSource().getName();
                            ...
                            _builder.newLine();
                            {
                              ...
                              if (_tripleNotEquals_10) {
                                ...
                                _builder.append("\t\t");
                                _builder.append("if (att.getName().equals(\"");
                                String _name_14 = edge.getAttName().getName();
                        ...
                        }
                        {
                          ...
                          if (_tripleNotEquals_11) {
                            ...
                            _builder.append("\t");
                            _builder.append("if (ref.getName().equals(\"");
                            String _name_15 = edge.getTarget().getName();
                            ...
                            _builder.newLine();
                            {
                              ...
                              if (_tripleNotEquals_12) {
                                ...
                                _builder.append("\t\t");
                                _builder.append("if (att.getName().equals(\"");
                                String _name_16 = edge.getAttName().getName();
                    ...
                    }
                    {
                      ...
                      if (_tripleNotEquals_13) {
                        ...
                        String _name_17 = edge.getTargetNode().getName();
                          ...
                          if (_tripleNotEquals_14) {
                            ...
                            _builder.newLine();
                            {
                              ...
                              for(final ValuedFeature feat_2 : _targetFeature_1) {
                                ...
                                _builder.append("\t\t");
                                _builder.append("if (feat.getName().equals(\"");
                                String _name_18 = feat_2.getFeat().getName();
                                ...
                                }
                                {
                                  ...
                                  if (_tripleNotEquals_15) {
                                    ...
                                    _builder.append("\t\t");
                                    _builder.append("if (refFeature.getName().equals(\"");
                                    String _name_19 = feat_2.getRefFeature().getName();
                        ...
                        _builder.newLine();
                        {
                          ...
                          if (_tripleNotEquals_17) {
                            _builder.append("\t\t");
                            _builder.append("if (att.getName().equals(\"");
                            String _name_21 = edge.getAttName().getName();
                                  ...
                                  for(final EReference reference : _reference_3) {
                                      ...
                                      if (((edge.getLabel() != null) && (edge.getLabel().size() > i))) {
                                        ...
                                        }
                                        {
                                          if ((found == false)) {
                                            ...
                                            _builder.append("    \t\t    ");
                                            _builder.append("if (att.getName().equals(\"");
                                            String _name_24 = edge.getLabel().get(i).getName();
                                    ...
                                    }
                                    {
                                      ...
                                      if (_tripleNotEquals_19) {
                                        ...
                                        _builder.append("\t\t");
                                        _builder.append("if (att.getName().equals(\"");
                                        String _name_25 = edge.getSrc_label().getName();
                                    ...
                                    }
                                    {
                                      ...
                                      if (_tripleNotEquals_20) {
                                        ...
                                        _builder.append("\t\t");
                                        _builder.append("if (att.getName().equals(\"");
                                        String _name_26 = edge.getTar_label().getName();
                          ...
                          if ((((edge.getLabel() != null) || (edge.getSrc_label() != null)) || (edge.getTar_label() != null))) {
                            ...
                            }
                            {
                              ...
                              if (_tripleNotEquals_21) {
                                ...
                                _builder.append("\t");
                                _builder.append("if (att.getName().equals(\"");
                                String _name_28 = edge.getSrc_label().getName();
                            ...
                            }
                            {
                              ...
                              if (_tripleNotEquals_22) {
                                ...
                                _builder.append("\t");
                                _builder.append("if (att.getName().equals(\"");
                                String _name_29 = edge.getTar_label().getName();
                ...
                }
                {
                  if ((rel instanceof Level)) {
                    ...
                    _builder.append(counter_1, "\t\t");
                    _builder.append(" = ModelManager.getObjectsOfType(\"");
                    String _name_30 = level.getName().getName();
                    ...
                    _builder.newLine();
                    {
                      ...
                      if (_tripleNotEquals_23) {
                        ...
                        _builder.append("\t\t");
                        _builder.append("if (att.getName().equals(\"");
                        String _name_31 = level.getAttName().getName();
                    ...
                    _builder.newLine();
                    {
                      ...
                      if (_tripleNotEquals_24) {
                        ...
                        _builder.append("\t\t");
                        _builder.append("if (ref.getName().equals(\"");
                        String _name_32 = level.getUpper().getName();
                        ...
                        _builder.newLine();
                        {
                          ...
                          if (_tripleNotEquals_26) {
                            ...
                            _builder.append("\t\t\t");
                            _builder.append("if (att.getName().equals(\"");
                            String _name_34 = level.getAttName().getName();
