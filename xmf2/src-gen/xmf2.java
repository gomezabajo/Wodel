...
public class xmf2 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation1
	...
	//REFERENCE: 
	((ReferenceEvaluation) exp0.first).name = "catch";
...
//SELECT OBJECT mutation2
	...
	SpecificReferenceSelection referenceSelection = null;
	//
	if (hmObjects.get("fh2") != null) {
		containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("fh2"));
		   			} else {
		   				if (hmList.get("fh2") != null) {
		   					containerSelection = new SpecificObjectSelection(packages, model, hmList.get("fh2"));
		   				}
		   				else {
			return mutations;
		}
	...
	if (hmObjects.get("fh2") != null) {
		referenceSelection = new SpecificReferenceSelection(packages, model, "catch", hmObjects.get("fh2"));
			   			} else {
			   				return mutations;
	}
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Catch", referenceSelection, containerSelection);
...
//METHOD NAME:mutation3
	...
	// REMOVE OBJECT mutation3
		...
		//
		ObSelectionStrategy objectSelection = null;
		if (hmObjects.get("c2") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("c2"));
	   			} else {
			return mutations;
		}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/xmf2/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/xmf2/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/xmf2/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/xmf2/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/xmf2/data/out/xmf2.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lfh285 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lfh285 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lfh285) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("fh2", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> lc286 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lc286 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lc286) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("c2", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> l87 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/xmf2/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/xmf2/data/out/", "C:/eclipse/runtime-EclipseApplication/xmf2/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/xmf2/data/model/", "xmf2", "C:/eclipse/runtime-EclipseApplication/xmf2", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/xmf2/data/out/", "C:/eclipse/runtime-EclipseApplication/xmf2/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/xmf2/data/model/", "xmf2", "C:/eclipse/runtime-EclipseApplication/xmf2", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
