                        ...
                        if (_not) {
                          {
                            ...
                            if (_tripleNotEquals_1) {
                              ...
                              {
                                List<EduTestSuperGenerator.TestOption> _get_8 = this.options.get(exercise).get(test_2);
                ...
                for(final Test test_3 : _tests_3) {
                  {
                    if (((this.options.get(exercise) != null) && (this.options.get(exercise).get(test_3) != null))) {
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        List<EduTestSuperGenerator.TestOption> _get_13 = this.options.get(exercise).get(test_3);
