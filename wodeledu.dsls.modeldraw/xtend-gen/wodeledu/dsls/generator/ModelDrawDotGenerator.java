                      ...
                      if (_equals) {
                      ...
                      } else {
                        {
                          ...
                          for(final ValuedFeature feat : _feature_1) {
                            ...
                            String _name_4 = feat.getFeat().getName();
                            _builder.append(_name_4, "\t\t\t\t");
                            _builder.append("\")) {");
                            _builder.newLineIfNotEmpty();
                            _builder.append("\t");
                                  ...
                                  if ((_feat_1 instanceof EReference)) {
                                    ...
                                    }
                                    {
                                      ...
                                      if (_tripleNotEquals_3) {
                                        ...
                                        _builder.append("\t");
                                        _builder.append("if (refFeature.getName().equals(\"");
                                        String _name_6 = feat.getRefFeature().getName();
                                              ...
                                              if (_greaterThan_2) {
                                                ...
                                                _builder.newLineIfNotEmpty();
                                                {
                                                  ...
                                                  for(final Content content : _contents_1) {
                                                    ...
                                                    _builder.append("\t\t\t\t");
                                                    _builder.append("if (obj.eClass().getName().equals(\"");
                                                    String _name_10 = content.getName().getName();
              ...
              for(final Relation rel : _relations_1) {
                {
                  if ((rel instanceof Edge)) {
                    ...
                    _builder.append(" = ModelManager.getObjectsOfType(\"");
                    String _name_11 = edge.getName().getName();
                      ...
                      if (_tripleNotEquals_7) {
                        ...
                        _builder.newLine();
                        {
                          ...
                          for(final ValuedFeature feat_1 : _feature_3) {
                            ...
                            _builder.append("\t");
                            _builder.append("if (feat.getName().equals(\"");
                            String _name_12 = feat_1.getFeat().getName();
                            ...
                            }
                            {
                              ...
                              if (_tripleNotEquals_8) {
                                ...
                                _builder.append("\t\t");
                                _builder.append("if (refFeature.getName().equals(\"");
                                String _name_13 = feat_1.getRefFeature().getName();
                      ...
                      if (_tripleEquals_2) {
                        ...
                        _builder.newLine();
                        {
                          ...
                          if (_tripleNotEquals_9) {
                            ...
                            _builder.append("\t");
                            _builder.append("if (ref.getName().equals(\"");
                            String _name_14 = edge.getSource().getName();
                        ...
                        }
                        {
                          ...
                          if (_tripleNotEquals_11) {
                            ...
                            _builder.append("\t");
                            _builder.append("if (ref.getName().equals(\"");
                            String _name_16 = edge.getTarget().getName();
                            ...
                            _builder.newLine();
                            {
                              ...
                              if (_tripleNotEquals_12) {
                                ...
                                _builder.append("\t\t");
                                _builder.append("if (att.getName().equals(\"");
                                String _name_17 = edge.getAttName().getName();
                    ...
                    }
                    {
                      ...
                      if (_tripleNotEquals_13) {
                        ...
                        String _name_18 = edge.getTargetNode().getName();
                          ...
                          if (_tripleNotEquals_14) {
                            ...
                            _builder.newLine();
                            {
                              ...
                              for(final ValuedFeature feat_2 : _targetFeature_1) {
                                ...
                                _builder.append("\t\t");
                                _builder.append("if (feat.getName().equals(\"");
                                String _name_19 = feat_2.getFeat().getName();
                                ...
                                }
                                {
                                  ...
                                  if (_tripleNotEquals_15) {
                                    ...
                                    _builder.append("\t\t");
                                    _builder.append("if (refFeature.getName().equals(\"");
                                    String _name_20 = feat_2.getRefFeature().getName();
                        ...
                        _builder.newLine();
                        {
                          ...
                          if (_tripleNotEquals_17) {
                            _builder.append("\t\t");
                            _builder.append("if (att.getName().equals(\"");
                            String _name_22 = edge.getAttName().getName();
                              ...
                              if (_greaterThan_4) {
                                ...
                                _builder.newLineIfNotEmpty();
                                {
                                  ...
                                  for(final EReference reference : _reference_3) {
                                    ...
                                    _builder.append("\t");
                                    _builder.append("if (ref.getName().equals(\"");
                                    String _name_23 = reference.getName();
                                      ...
                                      if (((edge.getLabel() != null) && (edge.getLabel().size() > i))) {
                                        ...
                                        }
                                        {
                                          if ((found == false)) {
                                            ...
                                            _builder.append("    \t\t    ");
                                            _builder.append("if (att.getName().equals(\"");
                                            String _name_25 = edge.getLabel().get(i).getName();
                                    ...
                                    }
                                    {
                                      ...
                                      if (_tripleNotEquals_19) {
                                        ...
                                        _builder.append("\t\t");
                                        _builder.append("if (att.getName().equals(\"");
                                        String _name_26 = edge.getSrc_label().getName();
                                    ...
                                    }
                                    {
                                      ...
                                      if (_tripleNotEquals_20) {
                                        ...
                                        _builder.append("\t\t");
                                        _builder.append("if (att.getName().equals(\"");
                                        String _name_27 = edge.getTar_label().getName();
                          ...
                          if ((((edge.getLabel() != null) || (edge.getSrc_label() != null)) || (edge.getTar_label() != null))) {
                            ...
                            }
                            {
                              ...
                              if (_tripleNotEquals_21) {
                                ...
                                _builder.append("\t");
                                _builder.append("if (att.getName().equals(\"");
                                String _name_29 = edge.getSrc_label().getName();
                            ...
                            }
                            {
                              ...
                              if (_tripleNotEquals_22) {
                                ...
                                _builder.append("\t");
                                _builder.append("if (att.getName().equals(\"");
                                String _name_30 = edge.getTar_label().getName();
                ...
                }
                {
                  if ((rel instanceof Level)) {
                    ...
                    _builder.append(counter_1, "\t\t");
                    _builder.append(" = ModelManager.getObjectsOfType(\"");
                    String _name_31 = level.getName().getName();
                    ...
                    _builder.newLine();
                    {
                      ...
                      if (_tripleNotEquals_24) {
                        ...
                        _builder.append("\t\t");
                        _builder.append("if (ref.getName().equals(\"");
                        String _name_33 = level.getUpper().getName();
                        ...
                        _builder.newLine();
                        {
                          ...
                          if (_tripleNotEquals_26) {
                            ...
                            _builder.append("\t\t\t");
                            _builder.append("if (att.getName().equals(\"");
                            String _name_35 = level.getAttName().getName();
