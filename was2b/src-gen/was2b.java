...
public class was2b extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//NAME:src
  		//REFERENCES COMPILES	319
ObSelectionStrategy refSelection319 = null;
if (hmObjects.get("ag") != null) {
refSelection319 = new SpecificObjectSelection(packages, model, hmObjects.get("ag"), "src");
} else {
	if (hmList.get("ag") != null) {
	refSelection319 = new SpecificObjectSelection(packages, model, hmList.get("ag"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection319);
//NAME:tar
  		//REFERENCES COMPILES	320
ObSelectionStrategy refSelection320 = null;
if (hmObjects.get("ag") != null) {
refSelection320 = new SpecificObjectSelection(packages, model, hmObjects.get("ag"), "tar");
} else {
	if (hmList.get("ag") != null) {
	refSelection320 = new SpecificObjectSelection(packages, model, hmList.get("ag"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection320);
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@77acd3fa (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/was2b/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/was2b/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/was2b/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/was2b/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/was2b/data/out/was2b.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lag1045 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lag1045 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lag1045) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel1046 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel1046 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel1046) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1047 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l1047 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1047) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l1048 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l1048 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l1048) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/was2b/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2b/data/out/", "C:/eclipse/runtime-EclipseApplication/was2b/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2b/data/model/", "was2b", "C:/eclipse/runtime-EclipseApplication/was2b", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2b/data/out/", "C:/eclipse/runtime-EclipseApplication/was2b/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2b/data/model/", "was2b", "C:/eclipse/runtime-EclipseApplication/was2b", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
