...
public class ctr extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection refRts10 = new RandomTypeSelection(packages, model, "Symbol");
		EObject refObject10 = refRts10.getObject();
		ObSelectionStrategy refSelection10 = null;
		if (refObject10 != null) {
			refSelection10 = new SpecificObjectSelection(packages, model, refObject10);
		}
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/ctr/data/out/ctr.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/ctr/data/out/",
					"C:/eclipse/workspace/ctr/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/ctr/data/model/",
					"ctr.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/ctr/data/out/",
					"C:/eclipse/workspace/ctr/data/model/DFAAutomaton.ecore", "C:/eclipse/workspace/ctr/data/model/",
					"ctr.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
