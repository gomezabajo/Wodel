...
public class apa2 extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation2
	...
	SpecificReferenceSelection referenceSelection = null;
	//
	if (hmObjects.get("ev1") != null) {
		containerSelection = new SpecificObjectSelection(packages, model, hmObjects.get("ev1"));
		   			} else {
		   				if (hmList.get("ev1") != null) {
		   					containerSelection = new SpecificObjectSelection(packages, model, hmList.get("ev1"));
		   				}
		   				else {
			return mutations;
		}
	...
	if (hmObjects.get("ev1") != null) {
		referenceSelection = new SpecificReferenceSelection(packages, model, "alarm", hmObjects.get("ev1"));
			   			} else {
			   				return mutations;
	}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/apa2/data/model/bpel.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/apa2/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/apa2/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/apa2/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/apa2/data/out/apa2.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lev177 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lev177 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lev177) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("ev1", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> la378 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (la378 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : la378) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l79 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/apa2/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/apa2/data/out/", "C:/eclipse/runtime-EclipseApplication/apa2/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/apa2/data/model/", "apa2", "C:/eclipse/runtime-EclipseApplication/apa2", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/apa2/data/out/", "C:/eclipse/runtime-EclipseApplication/apa2/data/model/bpel.ecore", "C:/eclipse/runtime-EclipseApplication/apa2/data/model/", "apa2", "C:/eclipse/runtime-EclipseApplication/apa2", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
