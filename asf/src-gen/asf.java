...
public class asf extends manager.MutatorUtils implements manager.IMutatorExecutor {
	private ArrayList<Mutator> mutation1(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		if (objectSelection != null && objectSelection.getObject() != null) {
			mut = new RetypeObjectMutator(model, packages, objectSelection.getObject(), referenceSelection,
					containerSelection, atts, refs, "Flow");
		}
		if (mut != null) {
			mut.setId("m1");
			mutations.add(mut);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/asf/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/asf/data/model/";
		String modelsURI = "C:/eclipse/workspace/asf/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/asf/data/out/asf.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/asf/data/out/",
					"C:/eclipse/workspace/asf/data/model/bpel.ecore", "C:/eclipse/workspace/asf/data/model/",
					"asf.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/asf/data/out/",
					"C:/eclipse/workspace/asf/data/model/bpel.ecore", "C:/eclipse/workspace/asf/data/model/",
					"asf.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
