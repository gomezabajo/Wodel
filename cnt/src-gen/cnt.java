...
public class cnt extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation3(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		ObSelectionStrategy objectSelection = null;
		atts.put("probability", new RandomDoubleConfigurationStrategy(0.0,
				ModelManager.getDoubleAttribute("probability", hmObjects.get("t0")), false));
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/cnt/data/model/PFSM.ecore";
		String modelURI = "C:/eclipse/workspace/cnt/data/model/";
		String modelsURI = "C:/eclipse/workspace/cnt/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/cnt/data/out/cnt.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lt067 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lt067 != null) {
							int k = 0;
							for (Mutator mut : lt067) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lt168 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (lt168 != null) {
							int k = 0;
							for (Mutator mut : lt168) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lt269 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (lt269 != null) {
							int k = 0;
							for (Mutator mut : lt269) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l70 = mutation4(packages, model, hashmapEObject, hashmapList);
						if (l70 != null) {
							int k = 0;
							for (Mutator mut : l70) {
								if (mut != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/cnt/data/out/",
					"C:/eclipse/workspace/cnt/data/model/PFSM.ecore", "C:/eclipse/workspace/cnt/data/model/",
					"cnt.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/cnt/data/out/",
					"C:/eclipse/workspace/cnt/data/model/PFSM.ecore", "C:/eclipse/workspace/cnt/data/model/",
					"cnt.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
