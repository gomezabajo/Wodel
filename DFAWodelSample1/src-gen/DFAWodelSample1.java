...
public class DFAWodelSample1 extends manager.MutatorUtils implements manager.IMutatorExecutor {
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/model/DFAAutomaton.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/resources/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/out/DFAWodelSample1.model").toFileString());
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/out/", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/model/DFAAutomaton.ecore", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/model/", "DFAWodelSample1", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/out/", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/model/DFAAutomaton.ecore", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1/data/model/", "DFAWodelSample1", "C:/eclipse/runtime-EclipseApplication/DFAWodelSample1", hashmapMutVersions);   			
   		}
   	}
}
