...
public class NodeImpl extends NamedItemImpl implements Node {
	...
	protected EClass eStaticClass() {
		return ModelgraphPackage.Literals.NODE;
	}
	...
	public void setType(NodeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgraphPackage.NODE__TYPE, oldType, type));
	}
	...
	public void setShape(NodeShape newShape) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgraphPackage.NODE__SHAPE, oldShape, shape));
	}
