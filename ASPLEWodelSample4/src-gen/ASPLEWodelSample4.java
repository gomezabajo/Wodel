...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/model/Asple.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/out/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/out/ASPLEWodelSample4.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> l12 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/out/", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/model/Asple.ecore", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/model/", "ASPLEWodelSample4", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/out/", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/model/Asple.ecore", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4/data/model/", "ASPLEWodelSample4", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample4", hashmapMutVersions);   			
   		}
   	}
}
