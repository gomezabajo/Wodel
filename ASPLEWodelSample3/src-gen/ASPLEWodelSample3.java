...
//METHOD NAME:mutation1
	...
	// REMOVE OBJECT mutation1
		...
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Statement");
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/model/Asple.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/out/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/out/ASPLEWodelSample3.model").toFileString());
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/out/", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/model/Asple.ecore", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/model/", "ASPLEWodelSample3", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/out/", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/model/Asple.ecore", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3/data/model/", "ASPLEWodelSample3", "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample3", hashmapMutVersions);   			
   		}
   	}
}
