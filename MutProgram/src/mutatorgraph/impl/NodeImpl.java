...
public class NodeImpl extends ItemImpl implements Node {
	...
	protected EClass eStaticClass() {
		return MutatorgraphPackage.Literals.NODE;
	}
	...
	public EAttribute getAttribute() {
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MutatorgraphPackage.NODE__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(EAttribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorgraphPackage.NODE__ATTRIBUTE, oldAttribute, attribute));
	}
	...
	public void setType(NodeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorgraphPackage.NODE__TYPE, oldType, type));
	}
	...
	public void setShape(NodeShape newShape) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorgraphPackage.NODE__SHAPE, oldShape, shape));
	}
