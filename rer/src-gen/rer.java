...
public class rer extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/workspace/rer/data/model/SecurityPolicy.ecore";
	    
	    String modelURI = "C:/eclipse/workspace/rer/data/model/";
	    String modelsURI = "C:/eclipse/workspace/rer/data/out/";
	    //String resourcesURI = "C:/eclipse/workspace/rer/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/workspace/rer/data/out/rer.model").toFileString());
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/workspace/rer/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/workspace/rer/data/out/", "C:/eclipse/workspace/rer/data/model/SecurityPolicy.ecore", "C:/eclipse/workspace/rer/data/model/", "rer", "C:/eclipse/workspace/rer", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/workspace/rer/data/out/", "C:/eclipse/workspace/rer/data/model/SecurityPolicy.ecore", "C:/eclipse/workspace/rer/data/model/", "rer", "C:/eclipse/workspace/rer", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
