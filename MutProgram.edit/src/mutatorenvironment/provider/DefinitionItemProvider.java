...
/**
 * This is the item provider adapter for a {@link mutatorenvironment.Definition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DefinitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Definition_metamodel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Definition_metamodel_feature", "_UI_Definition_type"),
				 MutatorenvironmentPackage.Literals.DEFINITION__METAMODEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Definition)object).getMetamodel();
