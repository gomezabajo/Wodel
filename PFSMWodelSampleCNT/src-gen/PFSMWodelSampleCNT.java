...
public class PFSMWodelSampleCNT extends manager.MutatorUtils implements manager.IMutatorExecutor {
...
ObSelectionStrategy objectSelection = null;
//NAME:probability
atts.put("probability", //
new RandomDoubleConfigurationStrategy(0.0, ModelManager.getDoubleAttribute("probability", hmObjects.get("t0")), false)
);
...
refSelection6 = new SpecificObjectSelection(packages, model, hmObjects.get("t0"), "src");
} else {
	if (hmList.get("t0") != null) {
	refSelection6 = new SpecificObjectSelection(packages, model, hmList.get("t0"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection6);
...
//
Object value = ModelManager.getAttribute("probability", hmObjects.get("t2"));
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/model/PFSM.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/resources/";
	    ...
	    //2
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/out/PFSMWodelSampleCNT.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt040 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lt040 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lt040) {
	   	   	   					if (mut != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt141 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lt141 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lt141) {
	   	   	   					if (mut != null) {
	   	   	   						EObject mutated = (EObject) mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> lt242 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (lt242 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lt242) {
	   	   	   					if (mut != null) {
	   	   	   						EObject mutated = (EObject) mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/out/", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/model/PFSM.ecore", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/model/", "PFSMWodelSampleCNT", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT", hashmapMutVersions);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/out/", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/model/PFSM.ecore", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT/data/model/", "PFSMWodelSampleCNT", "C:/eclipse/runtime-EclipseApplication/PFSMWodelSampleCNT", hashmapMutVersions);   			
   		}
   	}
}
