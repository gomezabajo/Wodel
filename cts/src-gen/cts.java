...
public class cts extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/cts/data/out/cts.model").toFileString());
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/cts/data/out/",
					"C:/eclipse/workspace/cts/data/model/PFSM.ecore", "C:/eclipse/workspace/cts/data/model/",
					"cts.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/cts/data/out/",
					"C:/eclipse/workspace/cts/data/model/PFSM.ecore", "C:/eclipse/workspace/cts/data/model/",
					"cts.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
