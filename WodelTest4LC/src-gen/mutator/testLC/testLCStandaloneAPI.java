...
import mutator.testLCStandalone.testLCStandalone;
import org.eclipse.core.runtime.NullProgressMonitor;
import wodel.utils.manager.MutatorStandaloneAPI;
import wodel.utils.manager.MutatorUtils;

public class testLCStandaloneAPI extends MutatorStandaloneAPI {
	public static void createMutants(String[] mutationOperators)
		...
		try {
			packages = ModelManager.loadMetaModel(ecoreURI, testLCStandaloneAPI.class);
		} catch (Exception e) {
		}
		...
		MutatorUtils muttestLC = new testLCStandalone();
		muttestLC.execute(maxAttempts, numMutants, registry, metrics, debugMetrics, packages, registeredPackages,
		...
		System.out.println("testLC Mutant generation process finished.");
	}
}
