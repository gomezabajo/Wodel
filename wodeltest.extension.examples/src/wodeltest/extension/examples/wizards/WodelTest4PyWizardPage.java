...
public class WodelTest4PyWizardPage extends WizardPage {
	...
	protected WodelTest4PyWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("Wodel-Test for Python Example");
		setDescription("This wizard creates a new Wodel-Test for Python example project.");
	...
	private void initialize() {
		...
		this.projectText.setText("WodelTest4Py");
		this.fileText.setText("WodelTest4Py.mutator");
