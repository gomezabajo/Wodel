...
public class ASPLEWodelSample1 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	//NAME:operator
	atts.put("operator", new ListStringConfigurationStrategy((String) ModelManager.getAttribute("operator", objectSelection.getObject()), "[less, equals, greater, distinct]", "operator")
	);
	}
	...
	public void execute(int maxAttempts, int numMutants, boolean registry) throws ReferenceNonExistingException, WrongAttributeTypeException, 
		...
		if (maxAttempts <= 0) {
		    ...
		    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/model/Asple.ecore";
		    
		    String modelURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/model/";
		    String modelsURI = "C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/out/";
		    ...
		    //2
		   	...
		   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/ASPLEWodelSample1/out/ASPLEWodelSample1.model").toFileString());
		   	...
		   	HashMap<String, EObject> hmMutator = getMutators(ModelManager.getObjects(mutatormodel));
		   			...
		   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
		   	   				...
		   	   				//RESET COUNTER: 0
		   	   	   			...
		   	   	   			ArrayList<Mutator> l52 = mutation1(packages, model, hashmapEObject, hashmapList);
		   	   	   			//COUNTER: 1
