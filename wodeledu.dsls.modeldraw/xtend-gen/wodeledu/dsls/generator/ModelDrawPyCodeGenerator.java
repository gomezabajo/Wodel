...
public class ModelDrawPyCodeGenerator extends AbstractGenerator {
  ...
  public CharSequence compile(final MutatorDraw draw) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("generatePyCode(fileBlock, file.getName(), packages, exercise, monitor);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("public void generatePyCode(File file, String folder, List<EPackage> packages, File exercise, IProgressMonitor monitor) throws MetaModelNotFoundException, ModelNotFoundException, FileNotFoundException {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("if (file.isFile()) {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("generatePyCode(fileBlock, folder + file.getName(), packages, exercise, monitor);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
