...
public class xmf1 extends manager.MutatorUtils implements manager.IMutatorExecutor {
	...
	private ArrayList<Mutator> mutation2(List<EPackage> packages, Resource model, HashMap<String, EObject> hmObjects,
		...
		RandomTypeSelection rts = new RandomTypeSelection(packages, model, "CatchAll", referenceSelection,
				containerSelection);
	...
	public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics,
		...
		String ecoreURI = "C:/eclipse/workspace/xmf1/data/model/bpel.ecore";
		String modelURI = "C:/eclipse/workspace/xmf1/data/model/";
		String modelsURI = "C:/eclipse/workspace/xmf1/data/out/";
		...
		for (String modelFilename : modelFilenames) {
			...
			Resource mutatormodel = ModelManager.loadModel(mutatorpackages,
					URI.createURI("file:/C:/eclipse/workspace/xmf1/data/out/xmf1.model").toFileString());
			...
			for (int i = 0; i < numMutants; i++) {
				...
				while ((isRepeated == true) && (attempts < maxAttempts)) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lfh1604 = mutation1(packages, model, hashmapEObject, hashmapList);
						if (lfh1604 != null) {
							int k = 0;
							for (Mutator mut : lfh1604) {
								if (mut != null) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> lc1605 = mutation2(packages, model, hashmapEObject, hashmapList);
						if (lc1605 != null) {
							int k = 0;
							for (Mutator mut : lc1605) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
										if (mutated instanceof EObject) {
					...
					max = 1;
					for (int j = 0; j < max; j++) {
						ArrayList<Mutator> l606 = mutation3(packages, model, hashmapEObject, hashmapList);
						if (l606 != null) {
							int k = 0;
							for (Mutator mut : l606) {
								if (mut != null) {
									Object mutated = mut.mutate();
									if (mutated != null) {
		...
		if (metrics == true) {
			...
			metricsGenerator = new NetMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xmf1/data/out/",
					"C:/eclipse/workspace/xmf1/data/model/bpel.ecore", "C:/eclipse/workspace/xmf1/data/model/",
					"xmf1.java", hashmapMutVersions);
		...
		if (debugMetrics == true) {
			...
			metricsGenerator = new DebugMutatorMetricsGenerator(metricspackages, "C:/eclipse/workspace/xmf1/data/out/",
					"C:/eclipse/workspace/xmf1/data/model/bpel.ecore", "C:/eclipse/workspace/xmf1/data/model/",
					"xmf1.java", hashmapMutVersions);
			metricsGenerator.run();
			monitor.worked(1);
