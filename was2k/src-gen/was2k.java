...
public class was2k extends mutator.MutatorUtils implements manager.IMutatorExecutor {
...
//SELECT OBJECT mutation1
	...
	//
	//true
	RandomTypeSelection rts = new RandomTypeSelection(packages, model, "Composition");
...
ArrayList<EObject> containers = ModelManager.getParentObjects(packages, model, "Dependency");
...
//NAME:src
  		//REFERENCES COMPILES	710
ObSelectionStrategy refSelection710 = null;
if (hmObjects.get("comp") != null) {
refSelection710 = new SpecificObjectSelection(packages, model, hmObjects.get("comp"), "src");
} else {
	if (hmList.get("comp") != null) {
	refSelection710 = new SpecificObjectSelection(packages, model, hmList.get("comp"), "src");
	}
	else {
		return mutations;
	}
}
   		refs.put("src", refSelection710);
//NAME:tar
  		//REFERENCES COMPILES	711
ObSelectionStrategy refSelection711 = null;
if (hmObjects.get("comp") != null) {
refSelection711 = new SpecificObjectSelection(packages, model, hmObjects.get("comp"), "tar");
} else {
	if (hmList.get("comp") != null) {
	refSelection711 = new SpecificObjectSelection(packages, model, hmList.get("comp"), "tar");
	}
	else {
		return mutations;
	}
}
   		refs.put("tar", refSelection711);
CreateObjectMutator mut = new CreateObjectMutator(model, packages, referenceSelection, containerSelection, atts, refs, "Dependency");
//INC COUNTER: 1
if (mut != null) {
	mut.setId("m2");
	mutations.add(mut);
...
if (objectSelection != null && objectSelection.getObject() != null) {
	if (hmObjects.get("comp") != null) {
			   					...
			   					atts.add(new CopyAttributeConfigurationStrategy(objectSelection.getObject(), hmObjects.get("comp"), "name", "name"));
...
//
//
//org.eclipse.emf.ecore.impl.EAttributeImpl@a9cbef (name: name) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (iD: false)
...
//METHOD NAME:mutation4
	...
	// REMOVE OBJECT mutation4
		...
		ObSelectionStrategy objectSelection = null;
		if (hmObjects.get("comp") != null) {
			objectSelection = new SpecificObjectSelection(packages, model, hmObjects.get("comp"));
	   			} else {
			return mutations;
		}
...
public void execute(int maxAttempts, int numMutants, boolean registry, boolean metrics, boolean debugMetrics, IProgressMonitor monitor) throws ReferenceNonExistingException, WrongAttributeTypeException, 
	...
	HashMap<String, List<String>> hashmapMutVersions = new HashMap<String, List<String>>();
	    ...
	    String ecoreURI = "C:/eclipse/runtime-EclipseApplication/was2k/data/model/UMLClassDiagram.ecore";
	    
	    String modelURI = "C:/eclipse/runtime-EclipseApplication/was2k/data/model/";
	    String modelsURI = "C:/eclipse/runtime-EclipseApplication/was2k/data/out/";
	    //String resourcesURI = "C:/eclipse/runtime-EclipseApplication/was2k/resources/";
	    ...
	    for (String modelFilename : modelFilenames) {
	   	...
	   	Resource mutatormodel = ModelManager.loadModel(mutatorpackages, URI.createURI("file:/C:/eclipse/runtime-EclipseApplication/was2k/data/out/was2k.model").toFileString());
	   		...
	   		HashMap<String, List<EObject>> hashmapList = new HashMap<String, List<EObject>>();
	   			...
	   			Mutations muts = AppliedMutationsFactory.eINSTANCE.createMutations();
	   	   				...
	   	   				//RESET COUNTER: 0
	   	   	   			...
	   	   	   			ArrayList<Mutator> lcomp2268 = mutation1(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 1
	   	   	   			//REGISTRY METHOD NAME:registry1
	   	   	   			
	   	   	   			if (lcomp2268 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lcomp2268) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   							hashmapEObject.put("comp", mut.getObject());
	   	   	   							}
	   	   	   			...
	   	   	   			ArrayList<Mutator> lrel2269 = mutation2(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 2
	   	   	   			//REGISTRY METHOD NAME:registry2
	   	   	   			
	   	   	   			if (lrel2269 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : lrel2269) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   							if (mutated instanceof EObject) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2270 = mutation3(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 3
	   	   	   			//REGISTRY METHOD NAME:registry3
	   	   	   			
	   	   	   			if (l2270 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2270) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	   	   	   			...
	   	   	   			ArrayList<Mutator> l2271 = mutation4(packages, model, hashmapEObject, hashmapList);
	   	   	   			//COUNTER: 4
	   	   	   			//REGISTRY METHOD NAME:registry4
	   	   	   			
	   	   	   			if (l2271 != null) {
	   	   	   				int k = 0;
	   	   	   				for (Mutator mut : l2271) {
	   	   	   					if (mut != null) {
	   	   	   						Object mutated = mut.mutate();
	   	   	   						if (mutated != null) {
	...
	Bundle bundle = Platform.getBundle("wodel.models");
   	...
   	String metricsecore = FileLocator.resolve(fileURL).getFile();
   		//String metricsecore = "C:/eclipse/runtime-EclipseApplication/was2k/resources/MutatorMetrics.ecore";
   		
   		if (metrics == true) {
   			ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic net metrics");
   			MutatorMetrics.generateMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2k/data/out/", "C:/eclipse/runtime-EclipseApplication/was2k/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2k/data/model/", "was2k", "C:/eclipse/runtime-EclipseApplication/was2k", hashmapMutVersions);
   			monitor.worked(1);
   		}
   		if (debugMetrics == true) {
		ArrayList<EPackage> metricspackages = ModelManager.loadMetaModel(metricsecore);
   			monitor.subTask("Generating dynamic debug metrics");
   			MutatorMetrics.generateDebugMetrics(metricspackages, "C:/eclipse/runtime-EclipseApplication/was2k/data/out/", "C:/eclipse/runtime-EclipseApplication/was2k/data/model/UMLClassDiagram.ecore", "C:/eclipse/runtime-EclipseApplication/was2k/data/model/", "was2k", "C:/eclipse/runtime-EclipseApplication/was2k", hashmapMutVersions);
   			monitor.worked(1);   			
   		}
   	}
}
